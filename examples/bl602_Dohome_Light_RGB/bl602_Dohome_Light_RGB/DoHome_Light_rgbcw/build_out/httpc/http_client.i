# 1 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/httpc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
# 48 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
# 1 "/b-l/bl_iot_sdk/components/network/httpc/include/http_client.h" 1
# 41 "/b-l/bl_iot_sdk/components/network/httpc/include/http_client.h"
...
# 42 "/b-l/bl_iot_sdk/components/network/httpc/include/http_client.h" 2
...
# 43 "/b-l/bl_iot_sdk/components/network/httpc/include/http_client.h" 2
...
# 44 "/b-l/bl_iot_sdk/components/network/httpc/include/http_client.h" 2
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/altcp.h" 1
# 144 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/altcp.h"
...
# 145 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/altcp.h" 2
...
err_t httpc_get_file_dns(const char* server_name, u16_t port, const char* uri, const httpc_connection_t *settings,
                     tcp_recv_fn recv_fn, void* callback_arg, httpc_state_t **connection);
# 49 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2

# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/altcp_tcp.h" 1
# 51 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 52 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2


# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/altcp_tls.h" 1
# 55 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2
...
void lwip_init(void);
# 56 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2
...
# 60 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 2
# 127 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
...
httpc_free_state(httpc_state_t* req)
{
  ...
  if (req->request != 
# 161 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                     ((void *)0)
# 161 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                         ) {
    pbuf_free(req->request);
    req->request = 
# 163 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                  ((void *)0)
# 163 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                      ;
  }
  if (req->rx_hdrs != 
# 165 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                     ((void *)0)
# 165 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                         ) {
    pbuf_free(req->rx_hdrs);
    req->rx_hdrs = 
# 167 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                  ((void *)0)
# 167 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                      ;
  }
  ...
  mem_free(req);
  req = 
# 172 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
       ((void *)0)
# 172 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
           ;

  if (tpcb != 
# 174 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
             ((void *)0)
# 174 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                 ) {
    err_t r;
    tcp_arg(tpcb, 
# 176 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                   ((void *)0)
# 176 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                       );
    tcp_recv(tpcb, 
# 177 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                    ((void *)0)
# 177 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                        );
    tcp_err(tpcb, 
# 178 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                   ((void *)0)
# 178 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                       );
    tcp_poll(tpcb, 
# 179 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                    ((void *)0)
# 179 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                        , 0);
    tcp_sent(tpcb, 
# 180 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                    ((void *)0)
# 180 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                        );
    r = tcp_close(tpcb);
    if (r != ERR_OK) {
      tcp_abort(tpcb);
...
{
  if (req != 
# 194 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
            ((void *)0)
# 194 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                ) {
    if (req->conn_settings != 
# 195 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                             ((void *)0)
# 195 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                                 ) {
      if (req->conn_settings->result_fn != 
# 196 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                                          ((void *)0)
# 196 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                                              ) {
...
httpc_tcp_recv(void *arg, struct tcp_pcb *pcb, struct pbuf *p, err_t r)
{
  ...
  if (p == 
# 287 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
          ((void *)0)
# 287 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
              ) {
  ...
  if (req->parse_state != HTTPC_PARSE_RX_DATA) {
    if (req->rx_hdrs == 
# 303 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                       ((void *)0)
# 303 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                           ) {
      req->rx_hdrs = p;
    } else {
    ...
    if (req->parse_state == HTTPC_PARSE_WAIT_HEADERS) {
      ...
      if (err == ERR_OK) {
        ...
        p = q;
        req->rx_hdrs = 
# 334 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                      ((void *)0)
# 334 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                          ;
  ...
  if ((p != 
# 340 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
           ((void *)0)
# 340 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
               ) && (req->parse_state == HTTPC_PARSE_RX_DATA)) {
    req->rx_content_len += p->tot_len;
    if (req->recv_fn != 
# 342 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                       ((void *)0)
# 342 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                           ) {
...
httpc_tcp_err(void *arg, err_t err)
{
  httpc_state_t* req = (httpc_state_t*)arg;
  if (req != 
# 358 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
            ((void *)0)
# 358 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                ) {

    req->pcb = 
# 360 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
              ((void *)0)
# 360 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                  ;
...
httpc_tcp_poll(void *arg, struct tcp_pcb *pcb)
{
  ...
  (void)pcb;
  if (req != 
# 372 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
            ((void *)0)
# 372 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                ) {
...
httpc_tcp_connected(void *arg, struct tcp_pcb *pcb, err_t err)
{
  ...
  pbuf_free(req->request);
  req->request = 
# 411 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                ((void *)0)
# 411 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                    ;
...
httpc_get_internal_addr(httpc_state_t* req, const ip_addr_t *ipaddr)
{
  err_t err;
  do { if (!(req != 
# 422 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 422 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
 )) { ; }} while(0);
...
httpc_dns_found(const char* hostname, const ip_addr_t *ipaddr, void *arg)
{
  ...
  if (ipaddr != 
# 450 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
               ((void *)0)
# 450 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                   ) {
...
httpc_get_internal_dns(httpc_state_t* req, const char* server_name)
{
  err_t err;
  do { if (!(req != 
# 471 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 471 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
 )) { ; }} while(0);
                            ...
                            int use_host, char *buffer, size_t buffer_size)
{
  if (settings->use_proxy) {
    do { if (!(server_name != 
# 493 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
   ((void *)0)
# 493 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
   )) { ; }} while(0);
    ...
    do { if (!(server_name != 
# 500 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
   ((void *)0)
# 500 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
   )) { ; }} while(0);
                      ...
                      u16_t server_port, const char* uri, tcp_recv_fn recv_fn, void* callback_arg, int use_host)
{
  ...
  do { if (!(uri != 
# 520 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 520 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
 )) { ; }} while(0);


  req_len = httpc_create_request_string(settings, server_name, server_port, uri, use_host, 
# 523 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                                                                                          ((void *)0)
# 523 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                                                                                              , 0);
  ...
  if(req == 
# 540 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
           ((void *)0)
# 540 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
               ) {
    return ERR_MEM;
  }
  ...
  if (req->request == 
# 546 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                     ((void *)0)
# 546 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                         ) {
    httpc_free_state(req);
    return ERR_MEM;
  }
  if (req->request->next != 
# 550 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                           ((void *)0)
# 550 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                               ) {
...
# 564 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
  req->pcb = tcp_new();
  if(req->pcb == 
# 565 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                ((void *)0)
# 565 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                    ) {
    httpc_free_state(req);
    return ERR_MEM;
  }
                           ...
                           tcp_recv_fn recv_fn, void* callback_arg)
{
  ...
  if (server_addr_str == 
# 612 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                        ((void *)0)
# 612 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                            ) {
    return ERR_VAL;
  }
...
# 633 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
err_t
               ...
               tcp_recv_fn recv_fn, void* callback_arg, httpc_state_t **connection)
{
  ...
  do { if (!((server_addr != 
# 640 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 640 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
 ) && (uri != 
# 640 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 640 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
...
# 640 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
  ...
  if (connection != 
# 658 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                   ((void *)0)
# 658 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                       ) {
    *connection = req;
  }
  return ERR_OK;
}
# 678 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
err_t
                   ...
                   tcp_recv_fn recv_fn, void* callback_arg, httpc_state_t **connection)
{
  ...
  do { if (!((server_name != 
# 685 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 685 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
 ) && (uri != 
# 685 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
 ((void *)0)
# 685 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
...
# 685 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
  ...
  if (connection != 
# 702 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c" 3 4
                   ((void *)0)
# 702 "/b-l/bl_iot_sdk/components/network/httpc/http_client.c"
                       ) {
    *connection = req;
  }
  return ERR_OK;
