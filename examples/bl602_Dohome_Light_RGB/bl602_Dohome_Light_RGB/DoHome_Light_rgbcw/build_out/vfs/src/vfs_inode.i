# 1 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
...
# 6 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 7 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 8 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 10 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 11 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
int inode_alloc()
{
    ...
    return -
# 32 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
           12
# 32 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                 ;
}
...
int inode_del(inode_t *node)
{
    if (node->refs > 0) {
        return -
# 38 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               16
# 38 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                    ;
    }

    if (node->refs == 0) {
        if (node->i_name != 
# 42 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 42 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            vPortFree(node->i_name);
        }

        node->i_name = 
# 46 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                      ((void *)0)
# 46 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                          ;
        node->i_arg = 
# 47 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                     ((void *)0)
# 47 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                         ;
        node->i_flags = 0;
...
inode_t *inode_open(const char *path)
{
    ...
    for (e = 0; e < 30; e++) {
        ...
        if (node->i_name == 
# 63 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 63 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        }
    ...
    return 
# 77 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
          ((void *)0)
# 77 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
              ;
}
...
int inode_forearch_name(int (*cb)(void *arg, inode_t *node), void *arg)
{
    ...
    for (e = 0; e < 30; e++) {
        node = &g_vfs_dev_nodes[e];
        if (node->i_name == 
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        } else {
            count++;
...
int inode_ptr_get(int fd, inode_t **node)
{
    if (fd < 0 || fd >= 30) {
        return -
# 103 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               22
# 103 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
static int inode_set_name(const char *path, inode_t **inode)
{
    ...
    if (!mem) {
        return -
# 150 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               12
# 150 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_reserve(const char *path, inode_t **inode)
{
    int ret;
    inode_t *node = 
# 163 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                   ((void *)0)
# 163 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                       ;

    do { if (!(path != 
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   && inode != 
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
   22
# 165 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    *inode = 
# 166 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
            ((void *)0)
# 166 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                ;
    ...
    if (path[0] == '\0' || path[0] != '/') {
        ...
        return -
# 174 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               22
# 174 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_release(const char *path)
{
    ...
    do { if (!(path != 
# 198 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 198 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 198 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
   22
# 198 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    ...
    if (node == 
# 201 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
               ((void *)0)
# 201 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                   ) {
        return -
# 202 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               19
# 202 "/b-l/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
