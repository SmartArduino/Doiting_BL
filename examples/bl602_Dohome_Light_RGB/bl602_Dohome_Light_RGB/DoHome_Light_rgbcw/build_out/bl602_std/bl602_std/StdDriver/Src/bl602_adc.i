# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 37 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 2
...
# 42 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 2
...
# 38 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
# 66 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
static intCallback_Type * adcIntCbfArra[ADC_INT_ALL]={
# 66 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 3 4
                                                     ((void *)0)
# 66 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
                                                         };
# 100 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Reset(void)
{
    uint32_t regCmd;
...
# 119 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Enable(void)
{
    uint32_t tmpVal;
...
# 136 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Disable(void)
{
    uint32_t tmpVal;
...
# 154 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Init(ADC_CFG_Type* cfg)
{
    uint32_t regCfg1;
    uint32_t regCfg2;
...
# 228 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Channel_Config(ADC_Chan_Type posCh,ADC_Chan_Type negCh,BL_Fun_Type contEn)
{
    uint32_t regCmd;
    uint32_t regCfg1;
...
# 261 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Scan_Channel_Config(ADC_Chan_Type posChList[],ADC_Chan_Type negChList[],uint8_t scanLength,BL_Fun_Type contEn)
{
    uint32_t tmpVal,i;
    uint32_t dealLen;
...
# 322 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Start(void)
{
    uint32_t regCmd;
...
# 348 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Stop(void)
{
    uint32_t regCmd;
...
# 366 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_FIFO_Cfg(ADC_FIFO_Cfg_Type *fifoCfg)
{
    uint32_t tmpVal;
...
# 401 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint8_t ADC_Get_FIFO_Count(void)
{
    uint32_t tmpVal;
...
# 418 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Full(void)
{
    uint32_t tmpVal;
...
# 439 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Empty(void)
{
    uint32_t tmpVal;
...
# 460 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint32_t ADC_Read_FIFO(void)
{
    uint32_t tmpVal;
...
# 479 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Parse_Result(uint32_t *orgVal,uint32_t len,ADC_Result_Type *result)
{
    uint8_t neg=0;
...
# 548 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntMask(ADC_INT_Type intType, BL_Mask_Type intMask)
{
    uint32_t tmpVal;
...
# 653 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntClr(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 782 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_GetIntStatus(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 830 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Int_Callback_Install(ADC_INT_Type intType,intCallback_Type* cbFun)
{
...
# 893 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Enable(void)
{
    uint32_t tmpVal;
...
# 910 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Disable(void)
{
    uint32_t tmpVal;
...
# 927 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Tsen_Init(ADC_TSEN_MOD_Type tsenMod)
{
    uint32_t tmpVal;
...
# 983 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
...
# 1008 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_LOW(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1024 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_HIGH(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1040 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
float TSEN_Get_Temp(uint32_t tsen_offset)
{
    uint32_t v0 = 0, v1 = 0;
    float temp = 0;
...
# 1098 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Err_Type ADC_Mic_Init(ADC_MIC_Type * adc_mic_config)
{
    uint32_t tmpVal1=0,tmpVal2=0;
...
# 1145 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Enable(void)
{
    uint32_t tmpVal;
...
# 1163 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Disable(void)
{
    uint32_t tmpVal;
