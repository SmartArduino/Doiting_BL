# 1 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/blfdt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
# 30 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
...
# 31 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 2

# 1 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt_internal.h" 1
# 87 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt_internal.h"
...
# 36 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 2
...
fail:
    if (lenp)
        *lenp = err;
    return 
# 109 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
          ((void *)0)
# 109 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
              ;
}
...
# 114 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                         ((void *)0)
# 114 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                             );
}
...
# 131 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                        ((void *)0)
# 131 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                            );;
         offset = fdt_next_node(fdt, offset, 
# 132 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                            ((void *)0)
# 132 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                )) {
        uint32_t phandle;
...
static const struct fdt_reserve_entry *fdt_mem_rsv(const void *fdt, int n)
{
    ...
    if (absoffset < ((fdt32_ld(&((const struct fdt_header *)(fdt))->off_mem_rsvmap))))
        return 
# 158 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 158 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    if (absoffset > ((fdt32_ld(&((const struct fdt_header *)(fdt))->totalsize))) - sizeof(struct fdt_reserve_entry))
        return 
# 160 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 160 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
...
# 183 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                             ((void *)0)
# 183 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                 ; i++) {
...
const char *fdt_get_name(const void *fdt, int nodeoffset, int *len)
{
    ...
    if (((fdt32_ld(&((const struct fdt_header *)(fdt))->version))) < 0x10) {
        ...
        if (leaf == 
# 309 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                   ((void *)0)
# 309 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                       ) {
            err = -11;
            goto fail;
        }
 ...
 fail:
    if (len)
        *len = err;
    return 
# 324 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
          ((void *)0)
# 324 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
              ;
}
                                      ...
                                      int *lenp)
{
    ...
    if ((err = fdt_check_prop_offset_(fdt, offset)) < 0) {
        if (lenp)
            *lenp = err;
        return 
# 355 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 355 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    }
                              ...
                              int *lenp)
{
    ...
    if (((fdt32_ld(&((const struct fdt_header *)(fdt))->version))) < 0x10) {
        if (lenp)
            *lenp = -10;
        return 
# 376 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 376 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    }
                                ...
                                int *poffset)
{
    ...
    if (lenp)
        *lenp = offset;
    return 
# 408 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
          ((void *)0)
# 408 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
              ;
}
                            ...
                            int namelen, int *lenp)
{
    ...
    if (((fdt32_ld(&((const struct fdt_header *)(fdt))->version))) < 0x10) {
        if (lenp)
            *lenp = -10;
        return 
# 422 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 422 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    }

    return fdt_get_property_namelen_(fdt, offset, name, namelen, lenp,
                     
# 426 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                    ((void *)0)
# 426 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                        );
}
                ...
                const char *name, int namelen, int *lenp)
{
    ...
    if (!prop)
        return 
# 447 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 447 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
                  ...
                  const char **namep, int *lenp)
{
    ...
    if (!prop)
        return 
# 463 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 463 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    if (namep) {
        const char *name;
        int namelen;
        ...
        if (!name) {
            if (lenp)
                *lenp = namelen;
            return 
# 472 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                  ((void *)0)
# 472 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                      ;
        }
        *namep = name;
    }
                  ...
                  const char *name, int namelen)
{
    ...
    if (aliasoffset < 0)
        return 
# 514 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 514 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;

    return fdt_getprop_namelen(fdt, aliasoffset, name, namelen, 
# 516 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                                               ((void *)0)
# 516 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                                   );
}
...
int fdt_parent_offset(const void *fdt, int nodeoffset)
{
    ...
    return fdt_supernode_atdepth_offset(fdt, nodeoffset,
                        nodedepth - 1, 
# 630 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                      ((void *)0)
# 630 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                          );
}
...
# 648 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                                 ((void *)0)
# 648 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                     );
         offset >= 0;
         offset = fdt_next_node(fdt, offset, 
# 650 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                            ((void *)0)
# 650 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                )) {
...
int fdt_node_offset_by_phandle(const void *fdt, uint32_t phandle)
{
    ...
    for (offset = fdt_next_node(fdt, -1, 
# 675 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                        ((void *)0)
# 675 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                            );
         offset >= 0;
         offset = fdt_next_node(fdt, offset, 
# 677 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                            ((void *)0)
# 677 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                )) {
                   ...
                   int *lenp)
{
    ...
    if (!list) {
        ...
        return 
# 769 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
              ((void *)0)
# 769 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                  ;
    }
    ...
    while (list < end) {
        ...
        if (list + length > end) {
            ...
            return 
# 782 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                  ((void *)0)
# 782 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                      ;
        }
    ...
    return 
# 799 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
          ((void *)0)
# 799 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
              ;
}
                  ...
                  const char *compatible)
{
    ...
    for (offset = fdt_next_node(fdt, startoffset, 
# 827 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                                 ((void *)0)
# 827 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                     );
         offset >= 0;
         offset = fdt_next_node(fdt, offset, 
# 829 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c" 3 4
                                            ((void *)0)
# 829 "/b-l/bl_iot_sdk/components/stage/blfdt/src/fdt_ro.c"
                                                )) {
