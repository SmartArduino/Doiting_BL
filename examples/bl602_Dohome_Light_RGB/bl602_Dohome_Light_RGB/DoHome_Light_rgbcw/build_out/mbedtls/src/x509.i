# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
# 33 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
...
# 34 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 27 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/x509.h"
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/config.h" 1
# 28 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/x509.h" 2
...
# 41 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/asn1.h" 1
# 42 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 43 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 44 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 47 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 50 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
...
# 54 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 2
# 95 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
int mbedtls_x509_get_serial( unsigned char **p, const unsigned char *end,
                     mbedtls_x509_buf *serial )
{
    int ret;
...
# 363 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                                     ...
                                     mbedtls_x509_name *cur )
{
    ...
    *p += val->len;
    ...
    cur->next = 
# 409 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
               ((void *)0)
# 409 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                   ;

    return( 0 );
}
# 437 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
int mbedtls_x509_get_name( unsigned char **p, const unsigned char *end,
                   mbedtls_x509_name *cur )
{
    int ret;
    ...
    while( 1 )
    {
        ...
        while( 1 )
        {
            ...
            if( cur->next == 
# 469 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                            ((void *)0) 
# 469 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                                 )
                return( -0x2880 );
        ...
        if( cur->next == 
# 483 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                        ((void *)0) 
# 483 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                             )
            return( -0x2880 );
                      ...
                      void **sig_opts )
{
    ...
    if( *sig_opts != 
# 667 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                    ((void *)0) 
# 667 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                         )
        return( -0x2800 );
# 703 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
    if( ( ret = mbedtls_oid_get_sig_alg( sig_oid, md_alg, pk_alg ) ) != 0 ) {
        return( -0x2600 + ret );
    }
# 731 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
    {
...
# 771 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
    if( ( ret = mbedtls_asn1_get_tag( p, end, &len,
            0x20 | 0x10 ) ) != 0 )
        return( -0x2500 + ret );
...
# 793 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                            ((void *)0)
# 793 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                                ;
    char s[256], *p;
    ...
    while( name != 
# 802 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                  ((void *)0) 
# 802 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                       )
    {
        if( !name->oid.p )
        {
                       ...
                       const void *sig_opts )
{
    ...
    size_t n = size;
    const char *desc = 
# 892 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c" 3 4
                      ((void *)0)
# 892 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
                          ;
    ...
    do { if( ret < 0 || (size_t) ret >= n ) return( -0x2980 ); n -= (size_t) ret; p += (size_t) ret; } while( 0 );
# 919 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
    ((void) pk_alg);
    ((void) md_alg);
    ((void) sig_opts);
...
# 1063 "/b-l/bl_iot_sdk/components/security/mbedtls/src/x509.c"
