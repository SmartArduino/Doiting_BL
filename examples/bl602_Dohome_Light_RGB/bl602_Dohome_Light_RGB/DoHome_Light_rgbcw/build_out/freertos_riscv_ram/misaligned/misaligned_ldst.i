# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
...
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h" 1





# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/encoding.h" 1
# 7 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/bits.h" 1
# 8 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h" 2
...
# 9 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h" 2


# 10 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h"
...
# 4 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/fp_emulation.h" 1
# 5 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h" 1
...
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/encoding.h" 1
# 7 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h" 2
# 39 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h"
...
# 6 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 2
# 17 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
union byte_array {
  uint8_t bytes[8];
  uintptr_t intx;
  uint64_t int64;
...
# 56 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
    ...
    len = 4, shift = 8*(sizeof(uintptr_t) - len);
# 82 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
...
void misaligned_store_trap(uintptr_t* regs, uintptr_t mcause, uintptr_t mepc)
{
  ...
  if ((insn & 0x707f) == 0x2023)
    len = 4;
# 134 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
...
# 158 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
