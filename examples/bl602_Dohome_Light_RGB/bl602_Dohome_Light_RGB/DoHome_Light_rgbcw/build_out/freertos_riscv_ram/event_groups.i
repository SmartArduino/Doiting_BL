# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/freertos_riscv_ram//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
# 29 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
...
# 30 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 41 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 2
# 63 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
...
# 87 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits, const EventBits_t uxBitsToWaitFor, const BaseType_t xWaitForAllBits ) ;
 ...
 EventGroup_t *pxEventBits;
  ...
  if( pxEventBits != 
# 113 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 113 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
 ...
 {
 EventGroup_t *pxEventBits;
# 162 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
  pxEventBits = ( EventGroup_t * ) pvPortMalloc( sizeof( EventGroup_t ) );

  if( pxEventBits != 
# 164 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 164 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
   pxEventBits->uxEventBits = 0;
   vListInitialise( &( pxEventBits->xTasksWaitingForBits ) );
...
# 495 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 3 4
                                                                                                                            ((void *)0) 
# 495 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
                                                                                                                                 );
...
# 637 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
  {
...
BaseType_t xWaitConditionMet = ( ( BaseType_t ) 0 );
 ...
 EventGroup_t const *pxEventBits = ( EventGroup_t * ) xEventGroup;
  ...
  if( xEventGroup == 
# 728 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 728 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
   xReturn = 0;
  }
