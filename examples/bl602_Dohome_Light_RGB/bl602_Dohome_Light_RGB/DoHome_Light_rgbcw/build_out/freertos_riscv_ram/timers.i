# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/freertos_riscv_ram//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
# 29 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
# 30 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 2
# 73 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
# 135 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
# 141 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                                  ((void *)0)
# 141 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                                      ;
 static TaskHandle_t xTimerTaskHandle = 
# 142 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                                      ((void *)0)
# 142 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                                          ;
# 154 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
BaseType_t xReturn = ( ( ( BaseType_t ) 0 ) );
 ...
 if( xTimerQueue != 
# 237 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                   ((void *)0) 
# 237 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                        )
 {

  {
   StaticTask_t *pxTimerTaskTCBBuffer = 
# 241 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                       ((void *)0)
# 241 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                           ;
   StackType_t *pxTimerTaskStackBuffer = 
# 242 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                        ((void *)0)
# 242 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                            ;
...
# 249 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
            ((void *)0)
# 249 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                ,
   ...
   if( xTimerTaskHandle != 
# 254 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                          ((void *)0) 
# 254 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                               )
   {
    xReturn = ( ( ( BaseType_t ) 1 ) );
   }
  }
# 269 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
 }
 else
 {
  ;
 ...
 Timer_t *pxNewTimer;
  ...
  if( pxNewTimer != 
# 292 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                   ((void *)0) 
# 292 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                        )
  {
 ...
 Timer_t *pxNewTimer;
  ...
  if( pxNewTimer != 
# 333 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                   ((void *)0) 
# 333 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                        )
  {
         ...
         Timer_t *pxNewTimer )
{
 ...
 if( pxNewTimer != 
# 359 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                  ((void *)0) 
# 359 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                       )
 {
...
DaemonTaskMessage_t xMessage;
 ...
 if( xTimerQueue != 
# 390 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                   ((void *)0) 
# 390 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                        )
 {
...
TaskHandle_t xTimerGetTimerDaemonTaskHandle( void )
{
 ...
 if( ( ( xTimerTaskHandle != 
# 428 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
((void *)0) 
# 428 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
) ) == 0 ) vAssertCalled();
...
# 503 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                                                                         ((void *)0)
# 503 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                                                                             , ( TickType_t ) 0U );
...
BaseType_t xListWasEmpty;
 ...
 ( void ) pvParameters;
# 543 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
 for( ;; )
 {
...
{
TickType_t xNextExpireTime;
# 630 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
# 748 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
      ((void *)0) 
# 748 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
...
# 786 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                                                                                                                                      ((void *)0)
# 786 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                                                                                                                                          , ( TickType_t ) 0U );
       if( ( xResult ) == 0 ) vAssertCalled();
       ( void ) xResult;
      }
...
# 846 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
     break;
...
BaseType_t xResult;
 ...
 while( ( ( ( pxCurrentTimerList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
 {
  ...
  if( ( pxTimer->ucStatus & ( ( uint8_t ) 0x04 ) ) != 0 )
  {
   ...
   {
    xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, 
# 899 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                                                                                          ((void *)0)
# 899 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                                                                                              , ( TickType_t ) 0U );
    if( ( xResult ) == 0 ) vAssertCalled();
    ( void ) xResult;
   }
...
static void prvCheckForValidListAndQueue( void )
{
 ...
 {
  if( xTimerQueue == 
# 923 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                    ((void *)0) 
# 923 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                         )
  {
   ...
   {
    if( xTimerQueue != 
# 947 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c" 3 4
                      ((void *)0) 
# 947 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/timers.c"
                           )
    {
