# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c"
...
# 2 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 3 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 4 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic.h"
int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs);
# 5 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2

int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs) __attribute__ ((weak, alias ("backtrace_riscv")));
# 101 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c"
