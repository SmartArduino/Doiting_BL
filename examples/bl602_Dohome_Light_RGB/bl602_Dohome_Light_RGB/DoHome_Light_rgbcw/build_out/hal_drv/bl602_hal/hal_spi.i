# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h" 1
# 12 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
...
# 10 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_inode.h" 2
...
# 13 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h" 2
# 41 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
...
# 66 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
int vfs_spi_open(inode_t *inode, file_t *fp);
# 75 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
int vfs_spi_close(file_t *fp);
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
ssize_t vfs_spi_read(file_t *fp, void *buf, size_t nbytes);
# 99 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_spi.h"
ssize_t vfs_spi_write(file_t *fp, const void *buf, size_t nbytes);

int vfs_spi_ioctl(file_t *fp, int cmd, unsigned long arg);
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_register.h" 1
# 14 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_register.h"
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_gpio.h" 1
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_gpio.h"
...
# 40 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/spi_reg.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/spi_reg.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/spi_reg.h" 2
# 350 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/spi_reg.h"
struct spi_reg {
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h" 2
...
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h" 2
# 57 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h"
typedef enum {
    SPI_ID_0,
    SPI_ID_MAX,
}SPI_ID_Type;
...
# 268 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_spi.h"
...
# 41 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 42 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 293 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sf_ctrl.h"
...
# 396 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h"
...
# 43 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 44 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 45 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 48 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 49 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 50 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 51 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 87 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt_env.h" 2
...
# 85 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt.h" 2
...
# 53 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 54 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
...
# 55 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 2
# 66 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
# 85 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                            ((void *)0)
# 85 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                                ;
...
static int lli_list_init(DMA_LLI_Ctrl_Type **pptxlli, DMA_LLI_Ctrl_Type **pprxlli, uint8_t *ptx_data, uint8_t *prx_data, uint32_t length)
{
    ...
    *pptxlli = pvPortMalloc(sizeof(DMA_LLI_Ctrl_Type) * count);
    if (*pptxlli == 
# 138 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                   ((void *)0)
# 138 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                       ) {
    ...
    *pprxlli = pvPortMalloc(sizeof(DMA_LLI_Ctrl_Type) * count);
    if (*pprxlli == 
# 145 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                   ((void *)0)
# 145 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                       ) {
...
# 212 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
# 271 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                                      ((void *)0)
# 271 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                                                                          , 
# 271 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                                            ((void *)0)
# 271 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
# 272 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                                      ((void *)0)
# 272 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                                                                          , 
# 272 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                                            ((void *)0)
# 272 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
int32_t hal_spi_init(spi_dev_t *spi)
{
    ...
    if (data == 
# 352 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
               ((void *)0)
# 352 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                   ) {
        return -1;
    }
...
int hal_spi_transfer(spi_dev_t *spi_dev, void *xfer, uint8_t size)
{
    ...
    if (priv_data == 
# 476 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                    ((void *)0)
# 476 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                        ) {
...
# 490 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
    for (i = 0; i < size; i++) {
                            ...
                            uint8_t pin_clk, uint8_t pin_cs, uint8_t pin_mosi, uint8_t pin_miso)
{
    ...
    if (len + 1 > 32) {
        ...
        return -
# 514 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3
               22
# 514 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                     ;
    }


    if (
# 518 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
       ((void *)0) 
# 518 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
            == g_hal_buf) {
        g_hal_buf = (spi_priv_data_t*)aos_malloc(sizeof(spi_priv_data_t));
        if (
# 520 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
           ((void *)0) 
# 520 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                == g_hal_buf) {
            ...
            return -
# 522 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3
                   12
# 522 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                         ;
        }
 ...
 529
# 528 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
    , port, (uint32_t)g_hal_buf->hwspi[port].spi_dma_event_group); }} while(0==1);}
                                                             ;
    if (
# 530 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
       ((void *)0) 
# 530 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
            == g_hal_buf->hwspi[port].spi_dma_event_group) {
        aos_free(g_hal_buf);
        return -
# 532 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3
               12
# 532 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                     ;
    }

    spi = (spi_dev_t*)aos_malloc(sizeof(spi_dev_t));
    if (
# 536 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
       ((void *)0) 
# 536 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
            == spi) {
        ...
        aos_free(g_hal_buf);
        return -
# 540 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3
               12
# 540 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                     ;
    }
 ...
 560
# 559 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
...
int spi_arg_set_fdt2(const void * fdt, uint32_t dtb_spi_offset)
{
    ...
    uint8_t pin_miso;
    char *path = 
# 590 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                ((void *)0)
# 590 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                    ;
    ...
    for (i = 0; i < 1; i++) {
        ...
        if (addr_prop == 
# 646 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 646 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 658 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 658 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 666 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 666 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 680 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 680 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 688 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 688 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 696 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 696 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 704 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 704 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 718 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 718 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
        ...
        if (addr_prop == 
# 726 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                        ((void *)0)
# 726 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                            ) {
...
void bl_spi0_dma_int_handler_tx(void)
{
    ...
    if (
# 754 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
       ((void *)0) 
# 754 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
            != g_hal_buf) {
        bl_dma_int_clear(g_hal_buf->hwspi[0].tx_dma_ch);

        if (g_hal_buf->hwspi[0].spi_dma_event_group != 
# 757 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                      ((void *)0)
# 757 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                                                          ) {
...
void bl_spi0_dma_int_handler_rx(void)
{
    ...
    if (
# 778 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
       ((void *)0) 
# 778 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
            != g_hal_buf) {
        bl_dma_int_clear(g_hal_buf->hwspi[0].rx_dma_ch);

        if (g_hal_buf->hwspi[0].spi_dma_event_group != 
# 781 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c" 3 4
                                                      ((void *)0)
# 781 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_spi.c"
                                                          ) {
            xResult = xEventGroupSetBitsFromISR(g_hal_buf->hwspi[0].spi_dma_event_group,
                                                (1<<1),
                                                &xHigherPriorityTaskWoken);
