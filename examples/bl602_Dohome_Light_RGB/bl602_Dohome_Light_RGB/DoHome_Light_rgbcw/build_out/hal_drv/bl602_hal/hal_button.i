# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 86 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt_env.h" 2
...
# 88 "/b-l/bl_iot_sdk/components/stage/blfdt/inc/libfdt_env.h" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 41 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 45 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 46 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
...
# 47 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.h"
void fdt_button_module_init(const void *fdt, int button_offset);
# 48 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hbn.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hbn.h"
int hal_hbn_init(uint8_t *pinbuf, uint8_t pinbuf_size);
int hal_hbn_enter(uint32_t time);
# 49 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 2
# 57 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
...
static int accumulate_time(button_ctx_t *pstnode)
{
    ...
    if (
# 85 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
       ((void *)0) 
# 85 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
            == pstnode) {
...
# 118 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
       ((void *)0)
# 118 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
       , ( 0 ) ) != ( ( ( BaseType_t ) 1 ) )) {
...
# 145 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
               ((void *)0)
# 145 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) )) {
...
static int hal_button_register_handler_with_dts(gpio_ctx_t *pstgpio)
{
    ...
    if (
# 276 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
       ((void *)0) 
# 276 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
            == pstgpio) {
...
void fdt_button_module_init(const void *fdt, int button_offset)
{
    ...
    for (i = 0; i < 5; i++) {
        ...
        if (addr_prop == 
# 382 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 382 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        if (addr_prop == 
# 401 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 401 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        if (addr_prop == 
# 415 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 415 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        if (addr_prop == 
# 422 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 422 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        if (addr_prop == 
# 429 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 429 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        addr_prop = fdt_getprop(fdt, offset3, "start", &lentmp);
        if (addr_prop == 
# 441 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 441 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        addr_prop = fdt_getprop(fdt, offset3, "end", &lentmp);
        if (addr_prop == 
# 448 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 448 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        addr_prop = fdt_getprop(fdt, offset3, "kevent", &lentmp);
        if (addr_prop == 
# 455 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 455 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        addr_prop = fdt_getprop(fdt, offset3, "start", &lentmp);
        if (addr_prop == 
# 467 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 467 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
        ...
        addr_prop = fdt_getprop(fdt, offset3, "kevent", &lentmp);
        if (addr_prop == 
# 474 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 474 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_button.c"
                            ) {
