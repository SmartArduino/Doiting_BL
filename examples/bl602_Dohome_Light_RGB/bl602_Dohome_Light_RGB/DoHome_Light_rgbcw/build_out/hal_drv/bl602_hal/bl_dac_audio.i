# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h"
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.h" 2
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2

# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_common.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h" 1
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h"
...
# 43 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_aon.h"
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h" 1
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.h" 1
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 2

static bl_audio_dac_dev_t *gp_audio_dac_dev = 
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
                                             ((void *)0)
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
                                                 ;
...
static void __dma_irq_handler(void)
{
    ...
    if ( 
# 164 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
        ((void *)0) 
# 164 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
             == gp_audio_dac_dev) {
        return;
    }
...
{
    if (
# 208 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
       ((void *)0) 
# 208 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
            == p_dev) {
        return -1;
    }
    p_dev->usr_cb = cb;
...
int bl_audio_dac_tx_buffer_config (bl_audio_dac_dev_t *p_dev, void **ptr_mem, uint32_t bufsize)
{
    ...
    if (
# 228 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
       ((void *)0) 
# 228 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
            == p_dev->lli_tx_buffer) {
        p_dev->lli_tx_buffer = pvPortMalloc(bufsize);
    }

    if (
# 232 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
       ((void *)0) 
# 232 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
            == p_dev->lli_tx_buffer) {
        return -1;
    }
...
{
    if (
# 255 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
       ((void *)0) 
# 255 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
            == p_dev) {
        return -1;
    }
...
{
    if (
# 293 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
       ((void *)0) 
# 293 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
            == p_dev) {
        return -1;
    }
...
int bl_audio_dac_deinit (bl_audio_dac_dev_t *p_dev)
{
    ...
    p_dev->lli_tx_buffer = 
# 311 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c" 3 4
                           ((void *)0)
# 311 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dac_audio.c"
                               ;
