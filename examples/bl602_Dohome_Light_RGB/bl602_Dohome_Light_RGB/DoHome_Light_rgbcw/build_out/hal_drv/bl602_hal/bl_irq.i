# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic.h" 1



int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs);
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
void bl_irq_register_with_ctx(int irqnum, void *handler, void *ctx)
{
 ...
 126
# 123 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
    ...
    if (handler == 
# 129 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                  ((void *)0)
# 129 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                      ) {
    ...
    if (
# 134 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
       ((void *)0) 
# 134 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
            == ctx) {
        handler_list[0][irqnum] = handler;
        handler_list[1][irqnum] = 
# 136 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                                 ((void *)0)
# 136 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                                     ;
    }
    else {
        handler_list[0][irqnum] = handler;
...
# 157 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                                             ((void *)0)
# 157 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                                                 );
}
...
void bl_irq_unregister(int irqnum, void *handler)
{
 ...
 168
# 164 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
...
{
    void *handler = 
# 175 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                   ((void *)0)
# 175 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                       ;
    mcause &= 0x7FFFFFF;
...
# 316 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
