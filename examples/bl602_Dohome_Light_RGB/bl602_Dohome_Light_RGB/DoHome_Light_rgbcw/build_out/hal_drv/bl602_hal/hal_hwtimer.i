# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/timer_reg.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/timer_reg.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/timer_reg.h" 2
# 445 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/timer_reg.h"
struct timer_reg {
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h" 2
...
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h" 2
# 57 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h"
typedef enum {
    TIMER_CH0,
    TIMER_CH1,
    TIMER_CH_MAX,
...
# 211 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_timer.h"
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.h" 1
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.h"
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 41 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
static void hwtimer_process(void *ctx)
{
    hw_timer_t *node;
    void (*handler)(void) = 
# 54 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                           ((void *)0)
# 54 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                               ;
    hw_timer_t tmpnode;
...
int hal_hwtimer_init(void)
{
    ...
    if (pstctx == 
# 100 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                 ((void *)0)
# 100 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                     ) {
    ...
    if (pstctx->pstqueue == 
# 106 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                           ((void *)0)
# 106 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                               ) {
        vPortFree(pstctx);
...
# 114 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                              ((void *)0)
# 114 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                                  ) {
...
hw_timer_t *hal_hwtimer_create(uint32_t period, hw_t handler, int repeat)
{
    ...
    if (period <= 0 || handler == 
# 140 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                                 ((void *)0) 
# 140 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                                      || (repeat != 0 && repeat != 1)) {
        ...
        return 
# 143 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
              ((void *)0)
# 143 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                  ;
    }
...
# 160 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 160 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
...
int hal_hwtimer_delete(hw_timer_t *pstnode)
{
    ...
    TIMER_IntMask(TIMER_CH0, TIMER_INT_COMP_0, UNMASK);
    xQueueGenericSend( ( QueueHandle_t ) ( pstctx->hwtimer_mux ), 
# 193 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 193 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return ret;
}
...
int hal_hwtimer_change_period(hw_timer_t *pstnode, uint32_t period)
{
    ...
    TIMER_IntMask(TIMER_CH0, TIMER_INT_COMP_0, UNMASK);
    xQueueGenericSend( ( QueueHandle_t ) ( pstctx->hwtimer_mux ), 
# 231 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 231 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return ret;
}
