# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 2
# 47 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
...
static int _get_gpio_max(const void* fdt, uint32_t dtb_offset)
{
    ...
    if (
# 70 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 70 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
            == addr_prop) {
        return -1;
    }
...
static int _get_gpio_config(const void* fdt, uint32_t dtb_offset, const char *name, struct gpio_feature_config *gpio_config)
{
    ...
    const uint32_t *addr_prop = 0;
    const char *result = 0;
# 95 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
    ...
    if (addr_prop == 
# 111 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 111 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
                        ) {
    ...
    if (addr_prop == 
# 146 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 146 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
                        ) {
...
static void _dump_gpio_conf(struct gpio_feature_config *config)
{
 ...
 166
# 160 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
...
# 202 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
                                 ((void *)0)
# 202 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
                                     ;
int hal_gpio_register_handler(void *func, int gpioPin, int intCtrlMod, int intTrgMod, void *arg)
{
    if (
# 205 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 205 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
    ...
    if (!pstgpio_head) {
        ...
        pstnode->next = 
# 226 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c" 3 4
                       ((void *)0)
# 226 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_gpio.c"
                           ;
    }
    else {
