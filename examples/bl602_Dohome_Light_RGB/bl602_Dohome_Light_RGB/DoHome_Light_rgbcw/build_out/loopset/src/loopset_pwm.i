# 1 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/loopset//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c"
# 30 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c"
...
# 31 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2

# 1 "/b-l/bl_iot_sdk/components/utils/include/utils_debug.h" 1
# 36 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 41 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 42 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
static int _pwm_bloop_evt(struct loop_ctx *loop, const struct loop_evt_handler *handler, uint32_t *bitmap_evt, uint32_t *evt_type_map)
{
    ...
    if (trigger == 
# 58 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 3 4
                  ((void *)0)
# 58 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c"
                      ) {
        return -1;
    }
    if (map & (1U << 1)) {
...
int loopset_pwm_hook_on_looprt(void)
{
    static const struct loop_evt_handler _pwm_bloop_handler_holder = {
        ...
        .evt = _pwm_bloop_evt,
        .handle = 
# 74 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c" 3 4
                 ((void *)0)
# 74 "/b-l/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_pwm.c"
                     ,
    };
