# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
# 42 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
...
# 43 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2



# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 1
# 41 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h"
...
# 42 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 43 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 44 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 47 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 48 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 49 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 53 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
# 68 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"

# 68 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 79 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
void
  ...
  switch (type) {
    ...
    case 8:
      ...
      if (pbuf_add_header(p, hlen + (14 + 0) + 128u)) {
        ...
        if (r == 
# 169 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                ((void *)0)
# 169 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                    ) {
          ;
          goto icmperr;
        }
...
# 235 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
        (iphdr)->_ttl = (u8_t)(255);
        (iphdr)->_chksum = (0);
...
# 250 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                                   ((void *)0)
# 250 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                                                  ,
                            255, 0, 1, inp);
        if (ret != ERR_OK) {
          ;
...
# 307 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
void
...
# 339 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 355 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 355 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
              ) {
    ;
    ;
    return;
  ...
  if (netif != 
# 390 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 390 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                  ) {
    ...
    ++lwip_stats.icmp.xmit;
    ip4_output_if(q, 
# 399 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 399 "/b-l/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
