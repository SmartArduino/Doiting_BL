# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c"
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2

# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/md5.h" 1
# 27 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/md5.h"
...
# 28 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/md5.h" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/include/app_config.h" 1
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c" 2
# 23 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_device_info.c"
char dev_id[64];
char dev_key[33];
...
static char gen_key()
{
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "key md5: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "device_info", dev_key); } while(0);
    return 1;
}
...
static void sta_mac_init(void)
{
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "device_mac: %02x%02x%02x%02x%02x%02x" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "device_info", station_mac[0],station_mac[1],station_mac[2],station_mac[3],station_mac[4],station_mac[5]); } while(0)
                                                                                                                  ;
}
...
uint32_t device_get_broadcast_ip()
{
    ...
    uint8_t ip[4];
    memcpy(ip, &bsip, 4);
    do { bl_printk("\x1b[32m[%10u][%s] " "broadcast_ip: %d.%d.%d.%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "device_info", ip[0], ip[1], ip[2], ip[3]); } while(0);
    return bsip;
}
...
static void dev_id_init(void)
{
    ...
    doit_strcat(dev_id, "_DT-WYRGB");
    doit_strcat(dev_id, "_ESP32");
    do { bl_printk("\x1b[32m[%10u][%s] " "dev_id: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "device_info", dev_id); } while(0);
}
