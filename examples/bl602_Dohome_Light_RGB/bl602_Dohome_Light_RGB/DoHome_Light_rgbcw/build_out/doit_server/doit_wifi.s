...
event_cb_wifi_event:
.LFB5:
	.file 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_wifi.c"
	.loc 1 32 1
	.cfi_startproc
.LVL0:
	.loc 1 33 5
...
.LBE15:
	...
	beq	a5,zero,.L10
	.loc 1 47 108 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL1:
.L11:
	.loc 1 62 1 discriminator 4
	lw	ra,12(sp)
	.cfi_remember_state
	.cfi_restore 1
...
.LBE17:
	...
	lw	a5,%lo(TrapNetCounter)(a5)
	beq	a5,zero,.L6
	.loc 1 36 111 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL3:
.L7:
	.loc 1 36 18 discriminator 4
	mv	a1,a0
	lui	a2,%hi(.LC0)
	lui	a0,%hi(.LC1)
	addi	a2,a2,%lo(.LC0)
	...
	call	bl_printk
.LVL4:
	.loc 1 37 13 is_stmt 1 discriminator 4
	.loc 1 37 43 is_stmt 0 discriminator 4
	lui	a5,%hi(.LANCHOR0)
	addi	a5,a5,%lo(.LANCHOR0)
	.loc 1 37 15 discriminator 4
	lbu	a4,0(a5)
	beq	a4,zero,.L1
	.loc 1 38 17 is_stmt 1
	.loc 1 38 44 is_stmt 0
	sb	zero,0(a5)
	.loc 1 39 17 is_stmt 1
...
.L6:
	.cfi_restore_state
	.loc 1 36 140 discriminator 2
	call	xTaskGetTickCount
.LVL6:
	j	.L7
.LVL7:
.L10:
	.loc 1 47 137 discriminator 2
	call	xTaskGetTickCount
.LVL8:
	j	.L11
.LVL9:
...
.LBE19:
	...
	lw	a5,%lo(TrapNetCounter)(a5)
	beq	a5,zero,.L12
	.loc 1 52 107 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL10:
.L13:
	.loc 1 52 18 discriminator 4
	mv	a1,a0
	lui	a2,%hi(.LC0)
	lui	a0,%hi(.LC3)
	addi	a2,a2,%lo(.LC0)
	...
	call	bl_printk
.LVL11:
	.loc 1 53 13 is_stmt 1 discriminator 4
	.loc 1 53 43 is_stmt 0 discriminator 4
	lui	a5,%hi(.LANCHOR0)
	addi	a5,a5,%lo(.LANCHOR0)
	.loc 1 53 15 discriminator 4
	lbu	a3,0(a5)
	li	a4,1
	beq	a3,a4,.L1
...
.LFE7:
	...
	.section	.text.wifi_setup_ap,"ax",@progbits
	.align	1
	.globl	wifi_setup_ap
	.type	wifi_setup_ap, @function
wifi_setup_ap:
.LFB8:
...
.LBE27:
	...
	.loc 1 80 10
	beq	a4,zero,.L24
	.loc 1 80 101 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL14:
.L25:
	.loc 1 80 10 discriminator 4
	mv	a1,a0
	lui	s0,%hi(.LC0)
	lui	a0,%hi(.LC4)
	addi	a2,s0,%lo(.LC0)
...
.LVL17:
	...
	call	memset
.LVL18:
	.loc 1 87 5 discriminator 4
.LBB29:
.LBB30:
	.loc 1 66 5 discriminator 4
	.loc 1 68 5 is_stmt 0 discriminator 4
	addi	a0,sp,4
	.loc 1 66 13 discriminator 4
	sw	zero,4(sp)
	sh	zero,8(sp)
	.loc 1 68 5 is_stmt 1 discriminator 4
	call	device_get_sta_mac
.LVL19:
...
.LVL21:
	...
	.loc 1 70 10 discriminator 4
.LBB31:
.LBB32:
	.loc 2 151 5 discriminator 4
.LBE32:
.LBE31:
	.loc 1 70 10 is_stmt 0 discriminator 4
...
.LBE34:
	.cfi_endproc
.LFE8:
	.size	wifi_setup_ap, .-wifi_setup_ap
	.section	.text.wifi_get_config,"ax",@progbits
	.align	1
	.globl	wifi_get_config
	.type	wifi_get_config, @function
wifi_get_config:
.LFB9:
	.loc 1 96 38 is_stmt 1
	.cfi_startproc
.LVL33:
	.loc 1 98 5
	.loc 1 96 38 is_stmt 0
	addi	sp,sp,-32
...
.LBB35:
	...
	call	flash_get_user_ssid_config_bak
.LVL37:
	sw	a0,12(sp)
.LVL38:
...
.LVL45:
	...
	.cfi_endproc
.LFE9:
	.size	wifi_get_config, .-wifi_get_config
...
.LVL47:
	...
	.loc 1 124 5 discriminator 4
	.loc 1 124 15 is_stmt 0 discriminator 4
	addi	a0,sp,12
	call	wifi_get_config
.LVL48:
	.loc 1 125 5 is_stmt 1 discriminator 4
	.loc 1 125 7 is_stmt 0 discriminator 4
	beq	a0,zero,.L35
.LBB38:
...
.LC3:
	...
	.section	.rodata.wifi_setup_ap.str1.4,"aMS",@progbits,1
	.align	2
.LC4:
	.string	"\033[32m[%10u][%s] wifi_setup_ap\033[0m\r\n"
.LC6:
	.string	"DoHome_"
.LC7:
	.string	"%s%02x%02x"
	.zero	1
.LC8:
	.string	"\033[32m[%10u][%s] AP_SSID: %s\033[0m\r\n"
	.zero	2
.LC9:
	.string	"192.168.4.1"
...
static_wifi_connect_status:
	...
	.text
.Letext0:
	.file 3 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_wifi.h"
	.file 4 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdint-gcc.h"
	.file 5 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/yloop.h"
	...
	.file 22 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/include/wifi_mgmr_ext.h"
	.file 23 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_flash.h"
	.file 24 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_device_info.h"
	.file 25 "/b-l/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/task.h"
	.file 26 "/b-l/bl_iot_sdk/components/utils/include/utils_log.h"
	.file 27 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/string.h"
	.file 28 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/stdio.h"
	.file 29 "<built-in>"
	.file 30 "/b-l/bl_iot_sdk/components/network/lwip_dhcpd/dhcp_server.h"
...
.LASF13:
	.string	"uint8_t"
.LASF254:
	.string	"wifi_get_config"
.LASF249:
	.string	"static_wifi_connect_status"
.LASF3:
	.string	"unsigned char"
.LASF291:
	.string	"sofap_mac_bin"
.LASF186:
	.string	"lenerr"
.LASF92:
...
.LASF135:
	.string	"_nmalloc"
.LASF284:
	.string	"/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_wifi.c"
.LASF119:
