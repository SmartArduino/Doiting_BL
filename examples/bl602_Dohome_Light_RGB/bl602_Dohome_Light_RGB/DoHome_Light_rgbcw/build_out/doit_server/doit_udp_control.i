# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/doit_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_udp_control.h" 1




void doit_udp_control_init(void);
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/sockets.h" 1
# 42 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/sockets.h"
...
# 43 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/sockets.h" 2
...
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 12 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 14 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_device_info.h" 1
...
# 15 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_dohome_protocol.h" 1



# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/include/app_config.h" 1
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_dohome_protocol.h" 2
# 67 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_dohome_protocol.h"
typedef enum {
 INVALID_CMD = 0,
 GET_WIFI_SCAN_RES,
 MODIFY_SSID,
 ...
 GET_DEV_TIME,
 SYNC_DEV_TIME = 10,
 SET_POWERUP_LED_STATUS,
 REMEMBER_SHUTDOWN_LED_STATUS,
 SET_SHUTDOWN_TIMER,
 SET_POWERUP_TIMER,
...
# 16 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
...
# 18 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 2
# 32 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
static char ping_ret_data[512];
static 
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
      _Bool 
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
           send_discovery_flag = 
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                 1
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
...
static void ping_ret_data_init(void)
{
 ...
 device_get_sta_ip(station_ip);
   ...
   "Light_",
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "ping_ret_data: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", ping_ret_data); } while(0);
}
...
static char udp_send_msg(struct udp_pcb *pcb, ip_addr_t *addr, u16_t port, char *content, int len)
{
 ...
 if (buf == 
# 64 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
           ((void *)0)
# 64 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
               ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "not enough memory\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", "doit_udp_control.c", 65); } while(0);
  return 0;
 }
...
static void parse_udp_package(struct udp_pcb *pcb, ip_addr_t *addr, u16_t port, char *buff, int len)
{
 ...
 if(
# 80 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
   ((void *)0) 
# 80 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
        != data_rchr){
  *(data_rchr+1) = 0;
 }

 do { bl_printk("\x1b[32m[%10u][%s] " "udp_package: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", buff); } while(0);

 if (strstr(buff, "cmd=ping") != 
# 86 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                ((void *)0)
# 86 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                                    ) {
  do { bl_printk("\x1b[32m[%10u][%s] " "udp_recv: cmd=ping" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control"); } while(0);

  udp_send_msg(pcb, addr, port, ping_ret_data, strlen(ping_ret_data));

 } else if (strstr(buff, "cmd=ctrl") != 
# 91 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                       ((void *)0)
# 91 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                                           ) {
  ...
  if ( (strstr(buff, id) != 
# 98 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                           ((void *)0)
# 98 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                               ) && (strstr(buff, id) < strstr(buff, "op="))) {
   ...
   if (pstart != 
# 105 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                ((void *)0)
# 105 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                    ) {
    char *buf = malloc(256);

    if (buf == 
# 108 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
              ((void *)0) 
# 108 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                   ) {
     do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "buf Application memory failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", "doit_udp_control.c", 109); } while(0);
     return;
    }
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "udp_ctrl_ret: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", buf); } while(0);
    udp_send_msg(pcb, addr, port, buf, strlen(buf));

    free(buf);
   }
  }
 }else if (strstr(buff, "cmd=bin_slot") != 
# 122 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                          ((void *)0)
# 122 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                                              ) {
  int slot = 1;
  char *buf = malloc(16);
  if (buf == 
# 125 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
            ((void *)0) 
# 125 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                 ) {
   do { bl_printk("\x1b[32m[%10u][%s] " "buf Application memory failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control"); } while(0);
   return;
  }
  ...
  do { bl_printk("\x1b[32m[%10u][%s] " "unknown command!!\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control"); } while(0);
 }
}
...
static void udpecho_raw_recv(void *arg, struct udp_pcb *pcb, struct pbuf *p, const ip_addr_t *addr, short unsigned int port)
{
 (void)arg;
 if (p == 
# 141 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
         ((void *)0)
# 141 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
             ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "p == NULL\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", "doit_udp_control.c", 142); } while(0);
  return;
 }
...
static char create_udp_server() {
 ...
 do { bl_printk("\x1b[32m[%10u][%s] " "Create Udp Server succeed port : %d \n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", 6091); } while(0);

 struct udp_pcb *pcb;
 pcb = (struct udp_pcb *)udp_new();
 udp_bind(pcb, (&ip_addr_any), 6091);
...
static void udp_send_discovery_data(void *pvParameters)
{
 ...
 do { bl_printk("\x1b[32m[%10u][%s] " "Now Let us create udp client ... " "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control"); } while(0);

 uint32_t bsip = device_get_broadcast_ip();
 uint8_t *bsip8 = (uint8_t *)&bsip;

 do { bl_printk("\x1b[32m[%10u][%s] " "connecting to %d.%d.%d.%d:%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", bsip8[0], bsip8[1], bsip8[2], bsip8[3], 6095); } while(0)
                                                                              ;

 int socket_fd = lwip_socket(2,2,0);

 if (socket_fd < 0) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "client create socket error , stop !!!" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", "doit_udp_control.c", 182); } while(0);
  lwip_close(socket_fd);
 } else {
  do { bl_printk("\x1b[32m[%10u][%s] " "client create socket Succeed  !!!" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control"); } while(0);
 }


 remote_addr.sin_family = 2;
 remote_addr.sin_port = lwip_htons(6095);
 remote_addr.sin_addr.s_addr = bsip;

 while (1) {
  if(send_discovery_flag){
   do { bl_printk("\x1b[32m[%10u][%s] " "udp send_discovery_count: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", send_discovery_count); } while(0);
   lwip_sendto(socket_fd,ping_ret_data,strlen(ping_ret_data),0,(struct sockaddr *) &remote_addr,sizeof(remote_addr))
                                                            ;
   ...
   if (send_discovery_count >= 60) {
    ...
    send_discovery_flag = 
# 202 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                         0
# 202 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                              ;
   }
 ...
 lwip_close(socket_fd);
 vTaskDelete(
# 210 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
            ((void *)0)
# 210 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                );
}
...
# 215 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                    ((void *)0)
# 215 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                                        ;
...
void doit_udp_control_init(void)
{
 ...
 ping_ret_data_init();
 send_discovery_flag = 
# 221 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                      1
# 221 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                          ;
 send_discovery_count = 0;
 ...
 if(!discovery_task_handle){
  ...
  if (xTaskCreate(udp_send_discovery_data, "discovery_task", 512, 
# 227 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c" 3 4
                                                                                 ((void *)0)
# 227 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_udp_control.c"
                                                                                     , 5, &discovery_task_handle) != ( ( ( BaseType_t ) 1 ) )) {
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "create discovery_task error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "udp_control", "doit_udp_control.c", 228); } while(0);
  }
 }
}
