# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 3 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 2
# 26 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
...
{
 if (buff == 
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 3 4
            ((void *)0)
# 33 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
                ) {
  do { bl_printk("\x1b[32m[%10u][%s] " "parse error buff" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "dohome_protocol"); } while(0);
  return 0;
 }

 if (len < 0) {
  do { bl_printk("\x1b[32m[%10u][%s] " "parse error len" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "dohome_protocol"); } while(0);
  return 1;
 }
 ...
 if (root == 
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 3 4
            ((void *)0)
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
                ) {
  do { bl_printk("\x1b[32m[%10u][%s] " "json parse failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "dohome_protocol"); } while(0);
  return 2;
 } else {
  do { bl_printk("\x1b[32m[%10u][%s] " "json parse successfully" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "dohome_protocol"); } while(0);
 ...
 if (pcmd == 
# 56 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 3 4
            ((void *)0)
# 56 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
                ) {
  do { bl_printk("\x1b[32m[%10u][%s] " "get cmd failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "dohome_protocol"); } while(0);
 ...
 case SET_SHUTDOWN_TIMER: {
  err_no = setup_shutdown_timer_to_json(root);
  break;
 }
 case SET_POWERUP_TIMER: {
 ...
 case GET_DEV_TIMER: {
  get_timer_info(
# 118 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c" 3 4
                ((void *)0)
# 118 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_dohome_protocol.c"
                    , ret_buf);
  cJSON_Delete(root);
  return 0;
 }
