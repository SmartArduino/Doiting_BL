# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/netdb.h" 1
# 37 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/netdb.h"
...
# 38 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/netdb.h" 2




# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/inet.h" 1
# 44 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/inet.h"
...
# 47 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/sockets.h"
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 12 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 14 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
...
# 16 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 2
# 31 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
static long old_ext_ts = 0;
static 
# 32 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
      _Bool 
# 32 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
           config_write_flag = 
# 32 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                               0
# 32 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
...
void upload_reset_ext(void){
    old_ext_ts = 0;
    config_write_flag = 
# 36 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                       1
# 36 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                           ;
}

void upload_delay_ext(void){
    long timestamp = time_get_curr_sec();
    old_ext_ts = timestamp-(60) + 1;
    config_write_flag = 
# 42 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                       1
# 42 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                           ;
}

static 
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
      _Bool 
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
           post_status = 
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                         0
# 45 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
...
static void http_upload_status_cb(char *response_body, int http_status, char *response_headers, int body_size)
{
 ...
 if (http_status == 200) {
  do { bl_printk("\x1b[32m[%10u][%s] " "http_upload_status ok" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "upload"); } while(0);
        post_status = 
# 51 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                     1
# 51 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                         ;
 }else{
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "http_upload_status fail" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "upload", "doit_upload.c", 53); } while(0);
        post_status = 
# 54 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                     0
# 54 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                          ;
    }
}


# 58 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
_Bool 
# 58 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
    dohome_http_post(char *msg)
{
    post_status = 
# 60 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                 0
# 60 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                      ;

 request_args request;
 request.method = "POST";
 request.hostname = "dohome.doit.am";
 request.port = 8008;
 request.path = "/";
...
static void upload_ext_stat(void){
 ...
 sprintf(add_info, "\"tz\":%d,\"ver\":\"%s\",\"dev_id\":\"%s\",\"remote\":%d,\"repeater\":%d,%s\"chip\":\"%s\",\"year\":%d,\"mon\":%d,\"day\":%d,\"hour\":%d,\"min\":%d,\"sec\":%d",
         pcfg->timezone_offset, "1.1.0", dev_id, pcfg->remote_ctrl, 0, ext_buf, "_ESP32" + 1, year, mon, day, hour, min, sec);
...
static void info_upload_task(void *param)
{
    while (1) {
        ...
        if(wifi_get_connect_status()){
            if(timestamp - old_ext_ts > (60)){
                old_ext_ts = timestamp;
                if(config_write_flag == 
# 113 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                                       1
# 113 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                                           ){
                    config_write_flag = 
# 114 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                                       0
# 114 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                                            ;
                    flash_user_config_write();
                    flash_user_config_to_bak_write();
                }
                do { bl_printk("\x1b[32m[%10u][%s] " "upload_ext_stat" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "upload"); } while(0);
                upload_ext_stat();
            }
        }
    ...
    vTaskDelete(
# 124 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
               ((void *)0)
# 124 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                   );
}


TaskHandle_t upload_task_handle = 
# 128 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                                 ((void *)0)
# 128 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                                     ;
void doit_status_upload_init(void){

    upload_reset_ext();
    if(!upload_task_handle){
        if (xTaskCreate(info_upload_task, "upload_task", 1024, 
# 133 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c" 3 4
                                                                          ((void *)0)
# 133 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_upload.c"
                                                                              , 2, &upload_task_handle) != ( ( ( BaseType_t ) 1 ) )) {
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "xTaskCreate(upload_task) failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "upload", "doit_upload.c", 134); } while(0);
        }
    }
}
