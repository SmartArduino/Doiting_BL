# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/product//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product_upload.h" 1



# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdbool.h" 1 3 4
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product_upload.h" 2
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/include/app_config.h" 1
# 14 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
...
void light_init();
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product.h" 2
...
# 16 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 2
# 29 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
static time_t old_upload_ts = 0;
static 
# 30 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
      _Bool 
# 30 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
...
void product_upload_status(int server){
    ...
    product_status_is_write = 
# 36 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                             1
# 36 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                 ;
    do { bl_printk("\x1b[32m[%10u][%s] " "set_upload_server: %02x" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product_upload", upload_server); } while(0);
}

void product_delay_upload_status(int server){
    time_t timestamp = time_get_curr_sec();
    old_upload_ts = timestamp-(50) + 1;
    product_status_is_write = 
# 43 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                             1
# 43 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                 ;
    upload_server |= server;
    do { bl_printk("\x1b[32m[%10u][%s] " "set_delay_upload_server: %02x" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product_upload", upload_server); } while(0);
}

static void dohome_upload_status(void){
    if(!product_dohomoe_update_status()){
        long timestamp = time_get_curr_sec();
        old_upload_ts = timestamp-(50) + 3;
    }
}
...
static void product_upload_task(void *param)
{
    while (1) {
        ...
        if(wifi_get_connect_status()){
            if(timestamp - old_upload_ts > (50)){
                old_upload_ts = timestamp;
                if(product_status_is_write == 
# 63 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                                             1
# 63 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                                 ){
                    product_status_is_write = 
# 64 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                                             0
# 64 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                                  ;
                    product_save_status();

                    if(upload_server & (1<<0)){
                        do { bl_printk("\x1b[32m[%10u][%s] " "dohome_upload_status" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product_upload"); } while(0);
                        upload_server &= (~(1<<0));
                        dohome_upload_status();
                    }
                }else{
                    do { bl_printk("\x1b[32m[%10u][%s] " "product_upload_status" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product_upload"); } while(0);
                    dohome_upload_status();
                }
            }
        }else{
    ...
    vTaskDelete(
# 82 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
               ((void *)0)
# 82 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                   );
}
...
void product_status_upload_init(void){
    ...
    if (xTaskCreate(product_upload_task, "produc_upload_task", 4*1024, 
# 88 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                                                                                        ((void *)0)
# 88 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                                                                            , 2, 
# 88 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c" 3 4
                                                                                                 ((void *)0)
# 88 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product_upload.c"
                                                                                                     ) != ( ( ( BaseType_t ) 1 ) )) {
        do { bl_printk("\x1b[32m[%10u][%s] " "xTaskCreate(produc_upload_task) failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product_upload"); } while(0);
    }
}
