# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product.h" 2
...
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product.h" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product.h" 2
# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdbool.h" 1 3 4
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/include/product.h" 2
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 12 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 15 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
...
# 17 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 2
# 29 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
...
void product_status_factory(product_mode_t *status){
 if(status == 
# 49 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
             ((void *)0)
# 49 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                 ){
...
static char app_product_status_check(product_mode_t status){
 if((status.color.red > 0
  ...
  || status.color.yellow > 0)
  &&(status.color.red <= 1000
  && status.color.green <= 1000
  && status.color.green <= 1000
  && status.color.white <= 1000
  && status.color.yellow <= 1000)){
   return 1;
 }else{
  return 0;
 }
...
static int get_color_pulsewidth(product_mode_t *product_status, rgb_pixel_t *pwm){
 ...
 pwm->red = map(product_status->color.red, 0, 5000, 0, 1000);
 pwm->green = map(product_status->color.green, 0, 5000, 0, 1000);
 pwm->blue = map(product_status->color.blue, 0, 5000, 0, 1000);





 pwm->white = map(product_status->color.white, 0, 5000, 0, 1000);
 pwm->yellow = map(product_status->color.yellow, 0, 5000, 0, 1000);
    return 1;
}
...
static int get_product_status_to_json(cJSON *root, product_mode_t *status)
{
 ...
 if (pred == 
# 123 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
            ((void *)0)
# 123 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get red failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 124); } while(0);
  return 10;
 }
 status->color.red = pred->valueint;
 cJSON *pblue = cJSON_GetObjectItem(root, "b");
 if (pblue == 
# 129 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
             ((void *)0)
# 129 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                 ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get blue failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 130); } while(0);
  return 11;
 }
 status->color.blue = pblue->valueint;
 cJSON *pgreen = cJSON_GetObjectItem(root, "g");
 if (pgreen == 
# 135 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
              ((void *)0)
# 135 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                  ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get green failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 136); } while(0);
  return 12;
 }
 ...
 if (pwhite == 
# 146 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
              ((void *)0)
# 146 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                  ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get white failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 147); } while(0);
  return 13;
 }
 status->color.white = pwhite->valueint;
 cJSON *pm = cJSON_GetObjectItem(root, "m");
 if (pm == 
# 152 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
          ((void *)0)
# 152 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
              ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get m failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 153); } while(0);
  return 14;
 }
...
void product_doit_get_status_str(char *status_str){
 ...
 red = map(product_status.color.red, 0, 1000, 0, 5000);
 green = map(product_status.color.green, 0, 1000, 0, 5000);
 blue = map(product_status.color.blue, 0, 1000, 0, 5000);





 white = map(product_status.color.white, 0, 1000, 0, 5000);
 yellow = map(product_status.color.yellow, 0, 1000, 0, 5000);
...
int product_doit_set_status(cJSON *root)
{
 ...
 if (pon == 
# 192 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
           ((void *)0)
# 192 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
               ) {
 ...
 cJSON *psmooth = cJSON_GetObjectItem(root, "smooth");
 int smoothen = 1;
 if (psmooth != 
# 205 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
               ((void *)0)
# 205 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                   ) {
 ...
 cJSON *p_t= cJSON_GetObjectItem(root, "t");
 int t = 0;
 if (p_t != 
# 214 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
           ((void *)0)
# 214 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
               ) {
  t= p_t->valueint;
 }

 if(smoothen){
  do { bl_printk("\x1b[32m[%10u][%s] " "\n--------r: %d    g: %d    b: %d    w: %d     y: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", color_pwm.red, color_pwm.green, color_pwm.blue, color_pwm.white, color_pwm.yellow); } while(0);
...
# 231 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
_Bool 
# 231 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
    product_dohomoe_update_status(void){
...
int set_preset_mode(cJSON *root){
 ...
 if (pindex == 
# 242 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c" 3 4
              ((void *)0)
# 242 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/product/product.c"
                  ) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "get offset failed\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 243); } while(0);
  return 101;
 }
 int index = pindex->valueint;
 set_light_work_mode(3);
...
int dohome_product_run_cmd(int cmd, cJSON *root, char* ret_buf){
 ...
 default:
  do { bl_printk("\x1b[32m[%10u][%s] " "unknown command!" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product"); } while(0);
  err_no = 26;
  break;
 }
 return err_no;
...
void dohome_status_post(void){
 ...
 product_upload_status((1<<0));
}

void dohome_status_delay_post(void){
 product_set_control_way(PRODUCT_CONTROL_DOHOME);
 product_delay_upload_status((1<<0));
}
