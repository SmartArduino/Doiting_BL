# 1 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c"
# 30 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c"
...
# 31 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c" 2
# 62 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c"
int utils_getopt_init(getopt_env_t *env, int opterr)
{
    if (!env) {
        return -1;
    ...
    env->optarg = 
# 67 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c" 3 4
                 ((void *)0)
# 67 "/b-l/bl_iot_sdk/components/utils/src/utils_getopt.c"
                     ;
    env->optind = 1;
    env->opterr = opterr;
    env->optopt = 0;
