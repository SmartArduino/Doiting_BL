# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 2
...
static void _bl_cks_test_case2()
{
 ...
 97
# 94 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
 ...
 115
# 112 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
    , cks, (uint16_t)~checksum); }} while(0==1);}
...
static void _bl_cks_test_case3()
{
 ...
 145
# 142 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
    , cks, (uint16_t)~checksum); }} while(0==1);}
 ...
 163
# 160 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
    , cks, (uint16_t)~checksum); }} while(0==1);}
...
static void _bl_cks_test_case4()
{
 ...
 196
# 193 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
    , cks, (uint16_t)~checksum); }} while(0==1);}
 ...
 216
# 213 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
    , cks, (uint16_t)~checksum); }} while(0==1);}
...
static void _cb_cmd(void *arg)
{
    ...
    first->arg = 
# 230 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 230 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
                    ;
}
...
static void _bl_cks_test_case5()
{
    ...
    second.cb = 
# 277 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 3 4
               ((void *)0)
# 277 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
                   ;
    second.arg = 
# 278 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 278 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
                    ;
    ...
    last.cb = 
# 292 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 3 4
             ((void *)0)
# 292 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
                 ;
    last.arg = 
# 293 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c" 3 4
              ((void *)0)
# 293 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_cks.c"
                  ;
