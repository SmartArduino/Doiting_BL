# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/uart_reg.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/uart_reg.h" 2
...
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h" 2
...
# 276 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h"
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.h" 1
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2

# 1 "/b-l/bl_iot_sdk/components/stage/blog/blog.h" 1
# 38 "/b-l/bl_iot_sdk/components/stage/blog/blog.h"
...
# 39 "/b-l/bl_iot_sdk/components/stage/blog/blog.h" 2
...
# 40 "/b-l/bl_iot_sdk/components/stage/blog/blog.h" 2
...
# 42 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 48 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                              ((void *)0)
# 48 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                  ;
static uart_dev_t *dev_uart1 = 
# 49 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                              ((void *)0)
# 49 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                  ;
...
static int uart_dev_malloc(uart_dev_t **pdev)
{
    ...
    *pdev = pvPortMalloc(sizeof(uart_dev_t));
    ...
    (*pdev)->priv = 
# 66 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                   ((void *)0)
# 66 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                       ;
    (*pdev)->priv = pvPortMalloc(sizeof(uart_priv_data_t));
    if ((*pdev)->priv == 
# 68 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 68 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
...
{
    if (*pdev == 
# 79 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                ((void *)0)
# 79 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                    ) {
...
{
    uart_dev_t **pdev = 
# 97 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                       ((void *)0)
# 97 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                           ;
    int ret;
...
static void fdt_uart_module_init(const void *fdt, int uart_offset)
{
    ...
    uint8_t id;
    char *path = 
# 226 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                ((void *)0)
# 226 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                    ;
    uint32_t baudrate;
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (addr_prop == 
# 294 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 294 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
        ...
        if (addr_prop == 
# 302 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 302 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
        ...
        for (j = 0; j < 4; j++) {
            ...
            if (addr_prop == 
# 332 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                            ((void *)0)
# 332 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                ) {
 ...
 344
# 338 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
