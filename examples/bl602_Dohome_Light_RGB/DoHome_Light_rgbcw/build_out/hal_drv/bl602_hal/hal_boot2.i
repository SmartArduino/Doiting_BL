# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2

# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h"
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sflash.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sflash.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sflash.h" 2
...
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sf_ctrl_reg.h"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/bl602.h" 1
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sf_ctrl_reg.h" 2
...
BL_Err_Type SFlash_Write_Reg_With_Cmd(SPI_Flash_Cfg_Type *flashCfg,uint8_t writeRegCmd,uint8_t *regValue,
                                      uint8_t regLen);
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_xip_sflash.h" 1
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_xip_sflash.h"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sflash.h" 1
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_xip_sflash.h" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h" 2
# 52 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h"
typedef enum {
    PT_ERROR_SUCCESS,
...
# 157 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_boot2.h"
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 2
# 51 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
static struct {
...
# 70 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3 4
                              ((void *)0)
# 70 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
...
int hal_boot2_partition_bus_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 119 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               5
# 119 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 129 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               2
# 129 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                     ;
    }
    ...
    *size1 = boot2_partition_table.table.ptEntries[i].maxLen[1];
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 144 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               140
# 144 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                        ;
    }
    ...
    if ( (addr0_t && (addr0_t < boot2_partition_table.table.ptEntries[i].Address[0])) ||
        ...
        return -
# 151 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               22
# 151 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                     ;
    }
    if ((0 != boot2_partition_table.table.ptEntries[i].activeIndex) &&
        (1 != boot2_partition_table.table.ptEntries[i].activeIndex)) {
        return -
# 155 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               14
# 155 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_partition_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 198 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               5
# 198 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 208 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c" 3
               2
# 208 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_init(void)
{
 ...
 276
# 273 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_boot2.c"
