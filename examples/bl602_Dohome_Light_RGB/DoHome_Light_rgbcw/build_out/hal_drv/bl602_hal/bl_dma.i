# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 36 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 42 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
# 54 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
struct dma_ctx {
...
void bl_dma_IRQHandler(void)
{
    ...
    if (
# 156 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
       ((void *)0) 
# 156 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
            == first) {
...
void *bl_dma_mem_malloc(uint32_t size)
{
    ...
    if (p_heap_addr == 
# 185 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                      ((void *)0)
# 185 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                          ) {
        return 
# 186 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 186 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                  ;
    }

    ptr = 
# 189 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
         ((void *)0)
# 189 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
             ;
    counts = 0;
    while (1) {
        ...
        if (ptr == 
# 194 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 194 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                      ) {
            goto __exit;
        }
...
static void bl_dma_int_process(void)
{
    ...
    void (*handler)(void) = 
# 229 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 229 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                               ;
    ...
    for (ch = 0; ch < DMA_CH_MAX; ch++) {
        ...
        if((tc_flag != 0) || (interr_flag != 0)) {
            ...
            for (node = ((struct dma_node *) ((char *) ((pstctx->pstqueue)->next) - ((size_t)&(((struct dma_node *)0)->dlist_item)))); &node->dlist_item != (pstctx->pstqueue); node = ((struct dma_node *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct dma_node *)0)->dlist_item))))) {
                if (ch == node->channel) {
                    if (node->tc_handler != 
# 260 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                           ((void *)0) 
# 260 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                && tc_flag != 0) {
...
# 265 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                               ((void *)0) 
# 265 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                    && interr_flag != 0) {
...
# 283 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                              ((void *)0)
# 283 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                                  ) {
    ...
    if (pstnode == 
# 297 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 297 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                      ) {
...
void *bl_dma_find_node_by_channel(int channel)
{
    ...
    if (&(node->dlist_item) == pstctx->pstqueue) {
        ...
        return 
# 324 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 324 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                  ;
    }
...
void bl_dma_init(void)
{
    ...
    if (pstctx == 
# 383 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                 ((void *)0)
# 383 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                     ) {
    ...
    if (pstctx->pstqueue == 
# 390 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 390 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                               ) {
...
# 403 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                                    ((void *)0)
# 403 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                                        , 
# 403 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                                          ((void *)0)
# 403 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
...
static void _cb_cmd(void *arg)
{
    ...
    first->arg = 
# 413 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                ((void *)0)
# 413 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                    ;
}
...
static void _dma_test_case1(void)
{
 ...
 431
# 427 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
