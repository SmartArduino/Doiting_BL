# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
# 30 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
...
# 31 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2

# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.h"
...
# 37 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
# 1 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_ir.h" 1
# 33 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/bl_ir.h"
...
# 38 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/pds_reg.h" 1
# 39 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/pds_reg.h"
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/pds_reg.h" 2
...
# 40 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h" 2
...
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h" 2
...
# 42 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_aon.h" 2
...
BL_Err_Type AON_Set_LDO11_SOC_Sstart_Delay(uint8_t delay);
              ;
# 42 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h" 2
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h" 1
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h"
...
# 43 "/b-l/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h" 2
...
BL_Err_Type PDS_Power_Off_PLL(void);
              ;
# 40 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 2
...
int hal_ir_init_from_dts(uint32_t fdt_input, uint32_t dtb_offset)
{
    ...
    uint8_t pin = 0;
    uint16_t interval = 
# 63 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 3 4
                       ((void *)0)
# 63 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
                           ;

    addr_prop = fdt_getprop(fdt, dtb_offset, "ctrltype", &lentmp);
    if (addr_prop == 
# 66 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 3 4
                    ((void *)0)
# 66 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
                        ) {
    ...
    if (0 >= offset1) {
        ...
        if (countindex != 1) {
            ...
            if ((lentmp != 4) || (memcmp("okay", result, 4) != 0)) {
                ...
                if (addr_prop == 
# 87 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 3 4
                                ((void *)0)
# 87 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
                                    ) {
                    ...
                    if (addr_prop == 
# 93 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 3 4
                                    ((void *)0)
# 93 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
                                        ) {
...
int hal_irled_send_data(int data_num, uint32_t *buf)
{
    ...
    if (data_num <=0 || buf == 
# 132 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c" 3 4
                              ((void *)0)
# 132 "/b-l/bl_iot_sdk/components/hal_drv/bl602_hal/hal_ir.c"
                                  ) {
