# 1 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/blfdt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
# 34 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdbool.h" 1 3 4
# 35 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 36 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 39 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 41 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 43 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
...
# 45 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 2
# 56 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 79 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3 4
_Bool 
# 79 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
    util_is_printable_string(const void *data, int len)
{
    ...
    while (s < se) {
        ss = s;
        while (s < se && *s && 
# 98 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                              ((((_ctype_)+sizeof(""[
# 98 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                              (unsigned char)*s
# 98 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                              ]))[(int)(
# 98 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 153 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3 4
                                 _Bool 
# 153 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                      debug)
{
    ...
    printf("/dts-v1/;\r\n");
    printf("// magic:\t\t0x%"
# 176 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                            "l" 
# 176 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                            "x""\r\n", fdt32_to_cpu(bph->magic));
    printf("// totalsize:\t\t0x%"
# 177 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                "l" 
# 177 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                "x"" (%"
# 177 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                           "l" 
# 177 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 179 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                  "l" 
# 179 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                  "x""\r\n", off_dt);
    printf("// off_dt_strings:\t0x%"
# 180 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                   "l" 
# 180 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                   "x""\r\n", off_str);
    printf("// off_mem_rsvmap:\t0x%"
# 181 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                   "l" 
# 181 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                   "x""\r\n", off_mem_rsvmap);
    printf("// version:\t\t%"
# 182 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                            "l" 
# 182 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                            "u""\r\n", version);
    printf("// last_comp_version:\t%"
# 183 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                    "l" 
# 183 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                    "u""\r\n",
           fdt32_to_cpu(bph->last_comp_version));
    if (version >= 2) {
        printf("// boot_cpuid_phys:\t0x%"
# 186 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                        "l" 
# 186 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                        "x""\r\n",
...
# 191 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                        "l" 
# 191 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                        "x""\r\n",
...
# 196 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                       "l" 
# 196 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                       "x""\r\n",
    ...
    for (i = 0; ; i++) {
        ...
        printf("/memreserve/ %#"
# 208 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                               "ll" 
# 208 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                               "x"" %#"
# 208 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
                                          "ll" 
# 208 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 218 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
       "l" 
# 218 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 247 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3
           "l" 
# 247 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
static 
# 267 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3 4
      _Bool 
# 267 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
...
# 753 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3 4
                                                    1
# 753 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
                                                        , 
# 753 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c" 3 4
                                                          1
# 753 "/b-l/bl_iot_sdk/components/stage/blfdt/test/tc_blfdt_dump.c"
