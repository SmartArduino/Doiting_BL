# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/doit_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"

# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_http.h" 1
# 16 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_http.h"
...
# 3 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2

# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/err.h" 1
# 39 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/err.h"
...
# 40 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/err.h" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/include/app_config.h" 1
# 14 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 2
# 27 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                              ...
                              char *userheader, int data_len)
{
    ...
    char *header = (char *) http_malloc(strlen("POST ") + strlen(resource) +
                                        ...
                                        strlen("\r\n\r\n") + 1);
    if (userheader == 
# 62 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                     ((void *)0)
# 62 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                         ) {
...
static char *http_get_header(char *host, char *resource, char *userheader)
{
    ...
    if (userheader == 
# 75 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                     ((void *)0)
# 75 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                         ) {
...
void http_raw_request(request_args *request)
{
    ...
    if (sockfd < 0) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "[ERROR] Create socket failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 98); } while(0);
        return;
    }

    do { bl_printk("\x1b[32m[%10u][%s] " "sockfd: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", sockfd); } while(0);

    memset(&server_addr, 0, sizeof(server_addr));
    server_addr.sin_family = 2;
    server_addr.sin_port = lwip_htons(request->port);

    while(1)
    {
        server = lwip_gethostbyname(request->hostname);
        if(server == 
# 111 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                    ((void *)0)
# 111 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                        ){
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "gethostbyname cnt: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 112, cnt+1); } while(0);
            cnt++;
            if(cnt > 3){
                cnt = 0;
                do { bl_printk("\x1b[32m[%10u][%s] " "use default ip\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
                char ip[4] = {115,28,78,23};
                if(str2ip("115.28.78.23", ip)){
                    memcpy(&server_addr.sin_addr.s_addr, ip, 4);
                    break;
                }else{
                    do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "default ip error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 122); } while(0);
                    lwip_close(sockfd);
                    return;
                }
            }
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "connectting server:%s(%d.%d.%d.%d)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", request->hostname, sip[0], sip[1], sip[2], sip[3]); } while(0);


    unsigned long mode = 1;
    int result = lwip_ioctl(sockfd,((long)(0x80000000UL|((sizeof(unsigned long)&0x7fU)<<16)|(('f')<<8)|(126))),&mode);
    if (result != 0)
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "ioctlsocket failed with error: %ld" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 143, result); } while(0);
    ...
    if (-1 != lwip_connect(sockfd,(struct sockaddr *)&server_addr,sizeof(server_addr))) {

        do { bl_printk("\x1b[32m[%10u][%s] " "connection is successful" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
    }else
    {
        
# 156 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3
       _types_fd_set 
# 156 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
              set;
        
# 157 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3
       (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 157 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
       &set
# 157 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3
...
# 158 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3
       ((
# 158 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
       &set
# 158 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3
       )->fds_bits[(
# 158 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
...
# 158 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
        ...
        if (lwip_select(sockfd+1,
# 160 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
           ((void *)0)
# 160 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
           ,&set,
# 160 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
           ((void *)0)
# 160 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
           ,&tm) <= 0)
        {
            ...
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "select error or timeout" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 163); } while(0);
            lwip_close(sockfd);
            return;
        ...
        }else
        {
            ...
            lwip_getsockopt(sockfd,0xfff,0x1007,(char*)&error,&optLen);

            if (0 != error){

                do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "connection error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 175); } while(0);
                lwip_close(sockfd);
                return;
            }
            else{

                do { bl_printk("\x1b[32m[%10u][%s] " "connection successful" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
            }
        }
    }
    ...
    mode = 0;
    result = lwip_ioctl(sockfd,((long)(0x80000000UL|((sizeof(unsigned long)&0x7fU)<<16)|(('f')<<8)|(126))),&mode);
    if (result != 0){
        do { bl_printk("\x1b[32m[%10u][%s] " "ioctlsocket failed with error: %ld" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", result); } while(0);
    }


    if (request->method == 
# 194 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                          ((void *)0)
# 194 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                              ) {
        lwip_close(sockfd);
        return;
    }
    ...
    lwip_setsockopt(sockfd,0xfff,0x1005,&timeout,sizeof(timeout));
    lwip_setsockopt(sockfd,0xfff,0x1006,&timeout,sizeof(timeout));
    ...
    int bytes = 0;
    char *http_header = 
# 209 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                       ((void *)0)
# 209 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                           ;
    if (strcmp(request->method, "GET") == 0) {


        http_header = http_get_header(request->hostname, request->path, 
# 213 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                                                                       ((void *)0)
# 213 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                                                                           );
        sprintf( message, "%s", http_header);


        int bytes = lwip_write(sockfd,message,strlen(message));
        if (bytes < 0){
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "http get write message failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 219); } while(0);
            http_free(message);
        ...
        http_header = http_post_header(request->hostname, request->path, request->content_type, 
# 228 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                                                                                               ((void *)0)
# 228 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                                                                                                   , request->buffer_size);
        sprintf( message, "%s", http_header);


        bytes = lwip_write(sockfd,message,strlen(message));
        if (bytes < 0){
            do { bl_printk("\x1b[32m[%10u][%s] " "http post write message failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
            http_free(message);
            http_free(http_header);
            lwip_close(sockfd);
            return;
        }else{
            do { bl_printk("\x1b[32m[%10u][%s] " "http post write message ok" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
        }

        bytes = lwip_write(sockfd,request->buffer,request->buffer_size);
        if (bytes < 0){
            do { bl_printk("\x1b[32m[%10u][%s] " "http post write buffer failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
            http_free(message);
            http_free(http_header);
            lwip_close(sockfd);
            return;
        }else{
            do { bl_printk("\x1b[32m[%10u][%s] " "http post write buffer ok" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http"); } while(0);
        }
    ...
    char *body = 
# 259 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                ((void *)0)
# 259 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                    ;
    int http_status = -1;
    int body_size = 0;
    ...
    if (strcmp(request->method, "GET") == 0) {
        ...
        bytes = lwip_read(sockfd,response,512-1);
        lwip_close(sockfd);

        if (bytes <= 0) {
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "receive data failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 272); } while(0);
            http_free(response);
            return;
        }
        ...
        if (strncmp(response, version10, strlen(version10)) != 0
            ...
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Invalid version response: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "http", "doit_http.c", 282, response); } while(0);
        }
        else {
...
# 299 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c" 3 4
                                 ((void *)0)
# 299 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_http.c"
                                     ) {
