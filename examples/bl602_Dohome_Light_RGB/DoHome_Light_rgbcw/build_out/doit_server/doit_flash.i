# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
...
# 6 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_flash.h" 2
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 2
# 31 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
...
void flash_user_config_read(void)
{
    ...
    flash_read_data((uint8_t *)pcfg, len, 0xF0000 + 0x0400);
}
...
void flash_user_config_write(void)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "flash_user_config_write" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
    int len = sizeof(user_config_t);
    user_config_t *pcfg = flash_get_user_config();
    flash_write_data((uint8_t *) pcfg, len, 0xF0000 + 0x0400);
    need_backup = 1;
}
...
void flash_ssid_config_read(void)
{
    ...
    flash_read_data((uint8_t *)pssid_cfg, len, 0xF0000 + 0x0600);
}
...
void flash_ssid_config_write(void)
{
    int len = sizeof(user_ssid_t);
    user_ssid_t *pssid_cfg = flash_get_user_ssid_config();
    flash_write_data((uint8_t *) pssid_cfg, len, 0xF0000 + 0x0600);
    need_backup = 1;
}
...
void flash_ssid_config_bak_write(void)
{
    ...
    int len = sizeof(user_ssid_t);
    flash_write_data((uint8_t *) pssid_cfg_bak, len, 0xF0000 + 0x0200);
}
...
{
    do { bl_printk("\x1b[32m[%10u][%s] " "Read all backup data" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
    user_ssid_t *pssid_cfg_bak = flash_get_user_ssid_config_bak();
    user_config_t *pcfg_bak = flash_get_user_config_bak();
    int len = sizeof(user_config_t);
    flash_read_data((uint8_t *)pcfg_bak, len, 0xF0000 + 0x0000);

    len = sizeof(user_ssid_t);
    flash_read_data((uint8_t *)pssid_cfg_bak, len, 0xF0000 + 0x0200);
}
...
void flash_user_config_to_bak_write(void)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "flash_user_config_to_bak_write" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
    ...
    int len = sizeof(user_config_t);
    flash_write_data((uint8_t *) pcfg_bak, len, 0xF0000 + 0x0000);
}
...
void flash_ssid_config_to_bak_write(void)
{
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "size:%d :%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", sizeof(user_config_t), sizeof(user_ssid_t)); } while(0);
...
void flash_updeta_all_backup(void)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "flash_updeta_all_backup here" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
...
void flash_reset_user_config(void)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "flash_reset_user_config" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
    ...
    memset(pcfg->saved_timers, 0xff, (sizeof(saved_timer_t) * 7));
    pcfg->restart_loc = 1;
...
char flash_get_reset_count(void)
{
    ...
    if (pssid_cfg_bak->reset_count != 0xff) {
        ...
        flash_ssid_config_write();
        do { bl_printk("\x1b[32m[%10u][%s] " "WARNING:: used backup reset_count:%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", pssid_cfg_bak->reset_count); } while(0);
...
void flash_set_reset_count_bak(uint8_t rst_count)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "set_reset_count:%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", rst_count); } while(0);
    user_ssid_t *pssid_cfg_bak = flash_get_user_ssid_config_bak();
    if (rst_count == 0xff) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "ALERT:: error reset count:%02x" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", "doit_flash.c", 290, rst_count); } while(0);
        return;
    }
    if (rst_count == pssid_cfg_bak->reset_count) {
        do { bl_printk("\x1b[32m[%10u][%s] " "WARNING:: rst_count == pssid_cfg_bak->reset_count" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
        return;
    }
...
void restart_count_check(void *arg){
    ...
    while(1){
        ...
        if (time == 1) {
            ...
            do { bl_printk("\x1b[32m[%10u][%s] " "restart_count: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash",restart_count); } while(0);
            if (restart_count >= 3 -1) {
                flash_write_reset_count();
                if(manytimes_restart_cb != 
# 362 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 3 4
                                          ((void *)0)
# 362 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
                                              ){
                ...
                flash_write_reset_count();
                if(not_manytimes_cb != 
# 367 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 3 4
                                      ((void *)0)
# 367 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
                                          ){
                    not_manytimes_cb();
                }
            }
    ...
    vTaskDelete(
# 377 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 3 4
               ((void *)0)
# 377 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
                   );
}
# 415 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
void flash_reg_manytimes_restart_cb(not_manytimes_cb_t user_not_manytimes_cb, manytimes_restart_cb_t user_manytimes_restart_cb){
    manytimes_restart_cb = user_manytimes_restart_cb;
    not_manytimes_cb = user_not_manytimes_cb;

    xTaskCreate(restart_count_check, "rst_check_task", 512, 
# 419 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 3 4
                                                                           ((void *)0)
# 419 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
                                                                               , 5, 
# 419 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c" 3 4
                                                                                                     ((void *)0)
# 419 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_flash.c"
...
void flash_storage_init(void)
{
    do { bl_printk("\x1b[32m[%10u][%s] " "flash init" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash"); } while(0);
    ...
    user_ssid_t *pssid_cfg = flash_get_user_ssid_config();
    user_ssid_t *pssid_cfg_bak = flash_get_user_ssid_config_bak();
    do { bl_printk("\x1b[32m[%10u][%s] " "saved SSID: %s, passwd: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", pssid_cfg->ssid, pssid_cfg->password); } while(0);
    do { bl_printk("\x1b[32m[%10u][%s] " "saved bak SSID: %s, passwd: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", pssid_cfg_bak->ssid, pssid_cfg_bak->password); } while(0);

    user_config_t *pcfg = flash_get_user_config();

    reset_reason = pcfg->restart_loc;
    do { bl_printk("\x1b[32m[%10u][%s] " "flash_get_reset_reason: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "flash", reset_reason); } while(0);
    pcfg->restart_loc = 0;
    flash_user_config_write();
}
