# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/doit_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
# 1 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/include/doit_tcp_config.h" 1
...
# 2 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 4 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 5 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 7 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 8 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 9 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 10 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 11 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 13 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 14 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
...
# 16 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 2
# 30 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
TaskHandle_t config_task_handle = 
# 30 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
                                 ((void *)0)
# 30 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
                                     ;
...
static void parse_tcp_recv_data(int connect_socket, char *data, int len)
{
 ...
 if (res == 0) lwip_write(connect_socket,ret_buf,strlen(ret_buf));
}
# 282 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
static void tcp_server_task(void *arg)
{
 ...
 do { bl_printk("\x1b[32m[%10u][%s] " "server socket....,port=%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", 5555); } while(0);

 memset(socket_used, 0, sizeof(socket_used));

 if ((server_fd = lwip_socket(2,1,0)) >= 0) {
  server_addr.sin_family = 2;
  server_addr.sin_port = lwip_htons(5555);
  server_addr.sin_addr.s_addr = ((u32_t)0x00000000UL);

  if (lwip_bind(server_fd,(struct sockaddr *) &server_addr,sizeof(server_addr)) != 0) {
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "bind error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", "doit_tcp_config.c", 300); } while(0);
   goto exit;
  }

  if (lwip_listen(server_fd,2) != 0) {
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "listen error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", "doit_tcp_config.c", 305); } while(0);
   goto exit;
  }
  ...
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "socket error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", "doit_tcp_config.c", 315); } while(0);
  goto exit;
 }
...
# 322 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
 _types_fd_set 
# 322 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
        read_fds;
  struct timeval timeout;

  
# 325 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
 (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 325 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
 &read_fds
# 325 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
...
# 325 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
  ...
  for (socket_fd = 0; socket_fd < 128; socket_fd ++)
   if (socket_used[socket_fd])
    
# 331 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
   ((
# 331 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
   &read_fds
# 331 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
   )->fds_bits[(
# 331 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
...
# 333 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
     ((void *)0)
# 333 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
     ,
# 333 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
     ((void *)0)
# 333 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
   ...
   for (socket_fd = 0; socket_fd < 128; socket_fd ++) {
    if (socket_used[socket_fd] && 
# 335 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
                                 ((
# 335 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
                                 &read_fds
# 335 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3
                                 )->fds_bits[(
# 335 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
...
# 335 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
     ...
     if (socket_fd == server_fd) {
      ...
      int fd = lwip_accept(server_fd,(struct sockaddr *) &client_addr,(socklen_t *)&client_addr_size);

      if (fd >= 0) {
       do { bl_printk("\x1b[32m[%10u][%s] " "accept socket fd(%d)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", fd); } while(0);
       socket_used[fd] = 1;
       ...
       do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "accept error" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", "doit_tcp_config.c", 349); } while(0);
      }
     }
     else {
      ...
      if (read_size > 0) {
       ...
       do { bl_printk("\x1b[32m[%10u][%s] " "socket fd(%d) disconnected" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server", socket_fd); } while(0);
...
exit:
 ...
 vTaskDelete(
# 378 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
            ((void *)0)
# 378 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
                );
 config_task_handle = 
# 379 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
                     ((void *)0)
# 379 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
                         ;
}
...
void start_tcp_config(void)
{
 do { bl_printk("\x1b[32m[%10u][%s] " "start_tcp_server." "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "tcp_server"); } while(0);
 if(!config_task_handle){
  xTaskCreate(tcp_server_task, "tcp_server_task", 1024, 
# 388 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c" 3 4
                                                                   ((void *)0)
# 388 "/b-l/DoHome_Light_rgbcw/DoHome_Light_rgbcw/components/doit_server/doit_tcp_config.c"
                                                                       , 5, &config_task_handle);
 }
}
