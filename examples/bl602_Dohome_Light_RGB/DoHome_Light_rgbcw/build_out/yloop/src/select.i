# 1 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
# 6 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 7 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_conf.h" 1
# 8 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 9 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 10 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 11 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 12 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 13 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 14 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 15 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
# 24 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 25 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 26 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 2
...
# 49 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
                             _types_fd_set 
# 49 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
# 67 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
                                                 _types_fd_set 
# 67 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                                                        *rfds, void *parg)
{
    int i;
    int maxfd = 0;
...
# 84 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
           ((
# 84 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
           rfds
# 84 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
           )->fds_bits[(
# 84 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
# 84 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
        ...
        if (f == 
# 91 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                ((void *)0)
# 91 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                    ) {
            return -1;
        }
...
# 96 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                                     1
# 96 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
static int post_poll(struct pollfd *fds, int nfds)
{
    ...
    for (j = 0; j < nfds; j++) {
        ...
        if (f == 
# 119 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                ((void *)0)
# 119 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                    ) {
            continue;
        }

        (f->node->ops.i_ops->poll)(f, 
# 123 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                                     0
# 123 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                                          , 
# 123 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                                            ((void *)0)
# 123 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
# 135 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
   _types_fd_set 
# 135 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
          rfds;
...
# 145 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 145 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
   &rfds
# 145 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
...
# 145 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
    ...
    if (ret >= 0) {
        ...
        for (i = 0; i < nfds; i++) {
            ...
            if (
# 160 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
               ((
# 160 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
               &rfds
# 160 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
               )->fds_bits[(
# 160 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
...
int aos_fcntl(int fd, int cmd, int val)
{
    if (fd < 0) {
        return -
# 180 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
               22
# 180 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                     ;
    }
    ...
    if (fd < 2) {
        ...
        return -
# 187 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
               2
# 187 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                     ;
...
int aos_ioctl_in_loop(int cmd, unsigned long arg)
{
    ...
    for (fd = 2;
        ...
        if (f == 
# 211 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                ((void *)0)
# 211 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                    ) {
            xQueueGenericSend( ( QueueHandle_t ) ( g_vfs_mutex ), 
# 212 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
           ((void *)0)
# 212 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
            return -
# 213 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3
                   2
# 213 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                         ;
        }

        if ((( ( BaseType_t ) 1 ) != xQueueGenericSend( ( QueueHandle_t ) ( g_vfs_mutex ), 
# 216 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                      ((void *)0)
# 216 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                      , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ))) {
            err = -1;
            return err;
        }
...
# 223 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c" 3 4
                                       ((void *)0)
# 223 "/b-l/bl_iot_sdk/components/stage/yloop/src/select.c"
                                           ) {
