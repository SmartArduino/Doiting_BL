# 1 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
...
# 6 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 7 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 8 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 10 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 11 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 12 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 14 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 2
...
static void dfl_entry(void *arg)
{
    ...
    vTaskDelete(
# 57 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
               ((void *)0)
# 57 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                   );
}
                 ...
                 int stack_size)
{
    ...
    xHandle = xTaskCreateStatic(dfl_entry, name, stack_size, targ,
                                10, stack, &task->fTask);
    if (xHandle == 
# 93 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
                  ((void *)0)
# 93 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                      ) {
        vPortFree(task);
        vPortFree(stack);
        vPortFree(targ);
...
{
    vTaskDelete(
# 109 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
               ((void *)0)
# 109 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                   );
}
...
void *aos_task_getspecific(aos_task_key_t key)
{
    ...
    if (key >= 4)
        return 
# 165 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
              ((void *)0)
# 165 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                  ;

    if (task->magic != 0x20171020)
        return 
# 168 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
              ((void *)0)
# 168 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                  ;
...
int aos_mutex_new(aos_mutex_t *mutex)
{
    ...
    mutex->hdl = mux;
    return mux != 
# 177 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
                 ((void *)0) 
# 177 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                      ? 0 : -1;
}
...
# 196 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
       ((void *)0)
# 196 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
...
{
    return mutex->hdl != 
# 203 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
                        ((void *)0)
# 203 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                            ;
}
...
{
    if (sem == 
# 215 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
              ((void *)0)
# 215 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                  ) {
        return;
    }
...
{
    if (sem == 
# 224 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
              ((void *)0)
# 224 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                  ) {
        return -1;
    }
...
void aos_sem_signal(aos_sem_t *sem)
{
    ...
    if (sem == 
# 236 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
              ((void *)0)
# 236 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                  ) {
        return;
    }
...
# 244 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
       ((void *)0)
# 244 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
}
...
{
    return sem && sem->hdl != 
# 250 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
                             ((void *)0)
# 250 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                                 ;
}
...
# 285 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
                                 ((void *)0)
# 285 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
                                     ;
}
...
{
    return 
# 290 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c" 3 4
          ((void *)0)
# 290 "/b-l/bl_iot_sdk/components/stage/yloop/src/aos_freertos.c"
              ;
}
