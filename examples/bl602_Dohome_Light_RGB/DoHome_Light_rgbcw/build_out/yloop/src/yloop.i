# 1 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
...
# 6 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdbool.h" 1 3 4
# 7 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 8 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 9 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 10 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/fcntl.h" 1 3


# 1 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_default_fcntl.h" 1 3
# 186 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_default_fcntl.h" 3
...
# 211 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_default_fcntl.h" 2 3
...
# 212 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_default_fcntl.h" 2 3
...
# 4 "/b-l/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/fcntl.h" 2 3
# 11 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 12 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 13 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 14 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
# 1 "/b-l/bl_iot_sdk/components/stage/yloop/include/logger.h" 1
...
# 4 "/b-l/bl_iot_sdk/components/stage/yloop/include/logger.h" 2
# 15 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 16 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs.h" 1
# 10 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs.h"
...
# 11 "/b-l/bl_iot_sdk/components/fs/vfs/include/vfs_inode.h"
...
# 17 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
typedef unsigned int aos_task_key_t;
# 20 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                            ((void *)0)
# 32 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                                ;
...
int aos_poll_read_fd(int sock, aos_poll_call_t cb, void *private_data)
{
    ...
    if (sock < 0) {
        return -
# 104 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
               22
# 104 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                     ;
    }
    ...
    if (new_sock == 
# 114 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                   ((void *)0) 
# 114 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                        || new_loop_pollfds == 
# 114 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                                               ((void *)0)
# 114 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
        ...
        return -
# 118 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
               12
# 118 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                     ;
    }

    int status = aos_fcntl(sock, 
# 121 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
                                3
# 121 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                                       , 0);
    aos_fcntl(sock, 
# 122 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
                   4
# 122 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                          , status | 
# 122 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
                                     0x4000
# 122 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
...
void aos_cancel_poll_read_fd(int sock, aos_poll_call_t action, void *param)
{
    yloop_ctx_t *ctx = get_context();
    if (ctx->readers == 
# 149 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                       ((void *)0) 
# 149 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                            || ctx->reader_count == 0) {
        return;
    }
...
{
    if (action == 
# 175 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                 ((void *)0)
# 175 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                     ) {
        return -
# 176 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
               22
# 176 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                     ;
    }
    ...
    if (timeout == 
# 181 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                  ((void *)0)
# 181 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                      ) {
        return -
# 182 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
               12
# 182 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                     ;
    }
...
void aos_loop_run(void)
{
    ...
    while (!ctx->terminate &&
        ...
        if (res < 0 && 
# 255 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
                      (*__errno()) 
# 255 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                            != 
# 255 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3
                               4
# 255 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
...
void aos_loop_destroy(void)
{
    ...
    if (ctx == 
# 298 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
              ((void *)0)
# 298 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                  ) {
        return;
    }
    ...
    _set_context(
# 314 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                ((void *)0)
# 314 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                    );
    if (ctx == g_main_ctx) {
        g_main_ctx = 
# 316 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c" 3 4
                    ((void *)0)
# 316 "/b-l/bl_iot_sdk/components/stage/yloop/src/yloop.c"
                        ;
    }
    vPortFree(ctx);
}
