# 1 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
...
# 6 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 7 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 8 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 9 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 10 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
# 1 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h" 1
# 12 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
...
# 13 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h" 2
# 24 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
typedef enum {
    IO_UART_PARITY_NONE,
    IO_UART_PARITY_ODD,
    IO_UART_PARITY_EVEN,
...
# 51 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
int vfs_uart_open(inode_t *inode, file_t *fp);
# 60 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
int vfs_uart_close(file_t *fp);
# 72 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
ssize_t vfs_uart_read(file_t *fp, void *buf, size_t nbytes);
# 84 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
ssize_t vfs_uart_write(file_t *fp, const void *buf, size_t nbytes);


int vfs_uart_poll(file_t *fp, 
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h" 3 4
                             _Bool 
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/include/device/vfs_uart.h"
...
# 11 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 12 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 13 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 14 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
# 15 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 2
...
int vfs_uart_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    uart_dev_t *uart_dev = 
# 31 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 31 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;


    if ((fp != 
# 34 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 34 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) && (fp->node != 
# 34 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 34 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
        ...
        ret = -
# 55 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
              22
# 55 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                    ;
    }
...
int vfs_uart_close(file_t *fp)
{
    int ret = -1;
    uart_dev_t *uart_dev = 
# 64 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 64 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;


    if ((fp != 
# 67 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 67 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) && (fp->node != 
# 67 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 67 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
        ...
        if (fp->node->refs == 1) {
            ...
            if (uart_dev != 
# 74 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                           ((void *)0)
# 74 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                               ) {
                ...
                ret = -
# 81 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
                      22
# 81 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                            ;
            }
        } else {
            ret = 0u;
        ...
        ret = -
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
              22
# 87 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                    ;
    }
...
static void uart_notify(void *arg)
{
    ...
    if (
# 99 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
       ((void *)0) 
# 99 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
            == uart_dev) {
...
ssize_t vfs_uart_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    uart_dev_t *uart_dev = 
# 111 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 111 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;
    ...
    if ((fp != 
# 117 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 117 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) && (fp->node != 
# 117 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 117 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
...
# 122 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                        ((void *)0)
# 122 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                            )) {
...
# 166 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                                ((void *)0)
# 166 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                                    );
            vTaskExitCritical();
            ...
            ret = -
# 172 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
                  22
# 172 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                        ;
        }
    } else {
        ret = -
# 175 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
              22
# 175 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                    ;
    }
...
ssize_t vfs_uart_write(file_t *fp, const void *buf, size_t nbytes)
{
    int ret = -1;
    uart_dev_t *uart_dev = 
# 185 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 185 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;
    uint8_t *buffer, idx_w, idx_r;


    if ((fp != 
# 189 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 189 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) && (fp->node != 
# 189 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 189 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
        ...
        if (uart_dev != 
# 194 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                       ((void *)0)
# 194 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                           ) {
            ...
            ret = -
# 216 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
                  22
# 216 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                        ;
        }
    } else {
        ret = -
# 219 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
              22
# 219 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                    ;
    }
...
void vfs_uart_notify(void *arg)
{
    ...
    if (uart_dev->poll_cb != 
# 230 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                            ((void *)0)
# 230 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                ) {
...
int vfs_uart_poll(file_t *fp, 
# 236 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                             _Bool 
# 236 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                  setup, poll_notify_t notify, struct pollfd *fd, void *opa)
{
    ...
    if (!setup) {
        ...
        uart_dev->poll_cb = 
# 245 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                           ((void *)0)
# 245 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                               ;
        uart_dev->poll_data = 
# 246 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                             ((void *)0)
# 246 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                 ;
...
int uart_ioctl_cmd_waimode(uart_dev_t *uart_dev, int cmd, unsigned long arg)
{
    ...
    if (
# 282 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
       ((void *)0) 
# 282 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
            == waitr_arg) {
        return -
# 283 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 283 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
    ...
    hal_uart_notify_unregister(uart_dev, 
# 345 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                        ((void *)0)
# 345 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                                            );
    vTaskExitCritical();
...
int uart_ioctl_cmd_setconfig(uart_dev_t *uart_dev, unsigned long arg)
{
    ...
    if (
# 357 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
       ((void *)0) 
# 357 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
            == config) {
        return -
# 358 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 358 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
...
int vfs_uart_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    uart_dev_t *uart_dev = 
# 377 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 377 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;


    if ((fp == 
# 380 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 380 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) || (fp->node == 
# 380 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 380 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
        ...
        return -
# 381 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 381 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
    ...
    if (uart_dev == 
# 387 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                   ((void *)0)
# 387 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                       ) {
        return -
# 388 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 388 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
    ...
    switch(cmd) {
        ...
        {
            ret = -
# 426 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
                   22
# 426 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                         ;
        }
    }
...
{
    uart_dev_t *uart_dev = 
# 437 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                          ((void *)0)
# 437 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                              ;


    if ((fp == 
# 440 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
              ((void *)0)
# 440 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                  ) || (fp->node == 
# 440 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                                    ((void *)0)
# 440 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
        ...
        return -
# 441 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 441 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
    ...
    if (uart_dev == 
# 447 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3 4
                   ((void *)0)
# 447 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                       ) {
        return -
# 448 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c" 3
               22
# 448 "/b-l/bl_iot_sdk/components/fs/vfs/device/vfs_uart.c"
                     ;
    }
