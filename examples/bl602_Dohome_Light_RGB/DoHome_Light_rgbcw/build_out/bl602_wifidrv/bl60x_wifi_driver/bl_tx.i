# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/bl602_wifidrv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
# 31 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
...
# 32 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 45 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/etharp.h"
...
# 46 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/etharp.h" 2
...
# 3 "/b-l/bl_iot_sdk/components/network/lwip/src/include/netif/etharp.h" 2
# 34 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.h" 2
...
# 38 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.h" 2
...
void bl_irq_handler();
# 36 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 45 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
                                ((void *)0)
# 45 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                                    ;
...
void bl_tx_resend()
{
    ...
    while (txhdr_pos_r != txhdr_pos_w) {
        if (
# 81 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 81 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
...
void bl_tx_try_flush()
{
    ...
    while (ipc_host_txdesc_get(bl_hw_static->ipc_env)) {
        ...
        if (
# 101 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 101 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                == txhdr) {
            break;
        }
...
# 154 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
       ((void *)0) 
# 154 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
       );
    }
...
err_t bl_output(struct bl_hw *bl_hw, struct netif *netif, struct pbuf *p, int is_sta)
{
    ...
    if (
# 172 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
       ((void *)0) 
# 172 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
    ...
    loop = 0;
    for (q = p; q != 
# 223 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
                    ((void *)0)
# 223 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                        ; q = q->next) {
        if (0 == loop) {
...
# 250 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
        }
        loop++;
    }
    if (loop > 2) {
