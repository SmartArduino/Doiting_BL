# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/bl602_wifidrv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
# 31 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
# 32 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 2

# 1 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr.h" 1
# 32 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr.h"
...
# 33 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr.h" 2
...
# 34 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 2
...
int wifi_mgmr_profile_add(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg, int index)
{
    ...
    profile = 
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 41 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    ...
    if (
# 58 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 58 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
...
int wifi_mgmr_profile_del(wifi_mgmr_t *mgmr, char *ssid, int len)
{
    ...
    profile = 
# 82 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 82 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    for (i = 0; i < sizeof(mgmr->profiles)/sizeof(mgmr->profiles[0]); i++) {
    ...
    if (
# 95 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 95 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
    memset(profile, 0, sizeof(*profile));
...
int wifi_mgmr_profile_get(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg)
{
    ...
    profile = 
# 108 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 108 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    for (i = 0; i < sizeof(mgmr->profiles)/sizeof(mgmr->profiles[0]); i++) {
        if (1 == mgmr->profiles[i].isUsed) {
            profile = &(mgmr->profiles[i]);
    ...
    if (
# 116 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 116 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
...
{
    wifi_mgmr_profile_t *profile = 
# 135 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
                                  ((void *)0)
# 135 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
                                      ;
...
int wifi_mgmr_profile_autoreconnect_is_enabled(wifi_mgmr_t *mgmr, int index)
{
# 160 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
int wifi_mgmr_profile_autoreconnect_disable(wifi_mgmr_t *mgmr, int index)
{
# 176 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
int wifi_mgmr_profile_autoreconnect_enable(wifi_mgmr_t *mgmr, int index)
{
# 195 "/b-l/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/wifi_mgmr_profile.c"
