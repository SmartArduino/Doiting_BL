# 1 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/netutils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
# 30 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
...
# 31 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 33 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 34 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 35 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 512 "/b-l/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 36 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 38 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
# 40 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 2
...
static void tcpc_entry(void* arg)
{
    ...
    if (
# 58 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 3 4
       ((void *)0) 
# 58 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
            == send_buf) {
...
failed_nothing:
    vPortFree(arg);
# 178 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
}
...
void tcpclient_cmd(char *buf, int len, int argc, char **argv)
{
    ...
    if (
# 193 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c" 3 4
       ((void *)0) 
# 193 "/b-l/bl_iot_sdk/components/network/netutils/tcpclient/tcpclient.c"
            == host) {
