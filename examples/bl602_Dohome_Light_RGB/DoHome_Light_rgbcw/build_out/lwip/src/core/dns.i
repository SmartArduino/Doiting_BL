# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
# 87 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 88 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 92 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 93 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 96 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
# 1 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/prot/dns.h" 1
# 101 "/b-l/bl_iot_sdk/components/network/lwip/src/include/lwip/prot/dns.h"
...
# 97 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 99 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 105 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t dns_txid;
# 189 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
struct dns_query {
...
# 285 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 314 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
void
dns_init(void)
{
  ...
  if (dns_pcbs[0] == 
# 333 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 333 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
    dns_pcbs[0] = udp_new_ip_type(IPADDR_TYPE_ANY);
    do { if (!(dns_pcbs[0] != 
# 335 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
   ((void *)0)
# 335 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
   )) { ; }} while(0);
...
# 344 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                                   ((void *)0)
# 344 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                       );
  }
...
# 360 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
void
dns_setserver(u8_t numdns, const ip_addr_t *dnsserver)
{
  if (numdns < 2) {
    if (dnsserver != 
# 364 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 364 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
...
# 380 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
const ip_addr_t *
...
# 601 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static err_t
dns_lookup(const char *name, ip_addr_t *addr )
{
  u8_t i;
# 617 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  for (i = 0; i < 4; ++i) {
...
# 650 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t
  ...
  do {
    ...
    if ((n & 0xc0) == 0xc0) {
      ...
      while (n > 0) {
        ...
        if (
# 674 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3
           __extension__ ({ __typeof__ (
# 674 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
           (unsigned char)((*query))
# 674 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3
           ) __x = (
# 674 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 707 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t
...
dns_send(u8_t idx)
{
  ...
  if (((dns_servers[entry->server_idx]).addr == ((u32_t)0x00000000UL))
    ...
    dns_call_found(idx, 
# 770 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                       ((void *)0)
# 770 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                           );
  ...
  p = pbuf_alloc(PBUF_TRANSPORT, (u16_t)(12 + strlen(entry->name) + 2 +
                                         4), PBUF_RAM);
  if (p != 
# 779 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
          ((void *)0)
# 779 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
              ) {
    const ip_addr_t *dst;
    u16_t dst_port;
    ...
    pcb_idx = 0;
                                                                         ...
                                                                         ;
# 846 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
    {
      dst_port = 53;
...
# 941 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static void
dns_call_found(u8_t idx, ip_addr_t *addr)
{
# 970 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  if (dns_requests[idx].found) {
    (*dns_requests[idx].found)(dns_table[idx].name, addr, dns_requests[idx].arg);
  }
  dns_requests[idx].found = 
# 973 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                           ((void *)0)
# 973 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                               ;
# 996 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
}
...
# 1046 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static void
      ...
      if (--entry->tmr == 0) {
        if (++entry->retries == 4) {
          if (dns_backupserver_available(entry)
            ...
            dns_call_found(i, 
# 1085 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                             ((void *)0)
# 1085 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                 );
...
# 1324 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
            }
...
# 1348 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
          ;
        }

        pbuf_free(p);
        dns_call_found(i, 
# 1352 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                         ((void *)0)
# 1352 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                             );
...
# 1374 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static err_t
...
# 1380 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                                 ((void *)0)
# 1380 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                     ;
  size_t namelen;
  struct dns_req_entry *req;
# 1415 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  lseq = 0;
  lseqi = 4;
  for (i = 0; i < 4; ++i) {
    entry = &dns_table[i];
...
# 1463 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  req = &dns_requests[i];
...
# 1496 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  dns_seqno++;
...
# 1525 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
err_t
...
# 1546 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
err_t
                           ...
                           void *callback_arg, u8_t dns_addrtype)
{
  ...
  if ((addr == 
# 1556 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
              ((void *)0)
# 1556 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                  ) ||
      (!hostname) || (!hostname[0])) {
    return ERR_ARG;
  }
  ...
  if (dns_pcbs[0] == 
# 1561 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 1561 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
    return ERR_ARG;
  }
...
# 1580 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 1607 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  (void)dns_addrtype;
# 1619 "/b-l/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  {
