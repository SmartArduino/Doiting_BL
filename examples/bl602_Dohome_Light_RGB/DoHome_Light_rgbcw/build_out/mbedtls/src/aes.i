# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
# 29 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
# 30 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2
...
# 37 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2

# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/aes.h" 1
# 27 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/aes.h"
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/config.h" 1
# 28 "/b-l/bl_iot_sdk/components/security/mbedtls/include/mbedtls/aes.h" 2
...
# 39 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2
# 58 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = (unsigned char*)v; while( n-- ) *p++ = 0;
}
# 360 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
# 387 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
{
    if( ctx == 
# 474 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c" 3 4
              ((void *)0) 
# 474 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
                   )
        return;
...
# 515 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    ctx->rk = RK = ctx->buf;
...
# 616 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    ctx->rk = RK = ctx->buf;
    ...
    ctx->nr = cty.nr;
# 633 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    SK = cty.rk + cty.nr * 4;
...
# 713 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
void mbedtls_aes_encrypt( mbedtls_aes_context *ctx,
                          const unsigned char input[16],
                          unsigned char output[16] )
{
...
int mbedtls_aes_crypt_ecb( mbedtls_aes_context *ctx,
                    ...
                    unsigned char output[16] )
{
# 849 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    if( mode == 1 )
                    ...
                    unsigned char *output )
{
    ...
    if( length % 16 )
        return( -0x0022 );
# 887 "/b-l/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    if( mode == 0 )
    {
        while( length > 0 )
        {
