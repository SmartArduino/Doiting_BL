# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
# 1 "/b-l/DoHome_Light_rgbcw/build_out/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
# 23 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
...
# 24 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c" 2
...
# 31 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c" 2
...
# 32 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c" 2
# 148 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
...
# 149 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c" 2

# 149 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
extern int bl_rand();
int mbedtls_platform_entropy_poll( void *data,
                           unsigned char *output, size_t len, size_t *olen )
{
...
# 187 "/b-l/bl_iot_sdk/components/security/mbedtls/src/entropy_poll.c"
    for(i = 0;i < len;i++) {
        if(0 == (i % 4)) {
            rand_buf = bl_rand();
        }
