# 1 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
# 1 "/b-l/dolphin/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
# 37 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
...
# 38 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c" 2
...
# 39 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c" 2
# 64 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
...
static intCallback_Type * uartIntCbfArra[2][UART_INT_ALL]= {
    {
# 66 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c" 3 4
    ((void *)0)
# 66 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
        },{
# 66 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c" 3 4
           ((void *)0)
# 66 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
...
# 187 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_Init(UART_ID_Type uartId,UART_CFG_Type* uartCfg)
{
...
# 289 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_DeInit(UART_ID_Type uartId)
{
    if(UART0_ID==uartId){
...
# 309 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_FifoConfig(UART_ID_Type uartId,UART_FifoCfg_Type* fifoCfg)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 352 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_IrConfig(UART_ID_Type uartId, UART_IrCfg_Type* irCfg)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 406 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_Enable(UART_ID_Type uartId,UART_Direction_Type direct)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 439 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_Disable(UART_ID_Type uartId,UART_Direction_Type direct)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 473 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetTxDataLength(UART_ID_Type uartId,uint16_t length)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 498 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetRxDataLength(UART_ID_Type uartId,uint16_t length)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 522 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetRxTimeoutValue(UART_ID_Type uartId,uint8_t time)
{
    uint32_t UARTx = uartAddr[uartId];
    uint32_t tmpVal;
...
# 547 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetDeglitchCount(UART_ID_Type uartId,uint8_t deglitchCnt)
{
    uint32_t UARTx = uartAddr[uartId];
    uint32_t tmpVal;
...
# 572 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetBaudrate(UART_ID_Type uartId,UART_AutoBaudDetection_Type autoBaudDet)
{
    uint32_t UARTx = uartAddr[uartId];
    uint16_t tmpVal;
...
# 597 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SetRtsValue(UART_ID_Type uartId)
{
    uint32_t UARTx = uartAddr[uartId];
    uint32_t tmpVal;
...
# 620 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_ClrRtsValue(UART_ID_Type uartId)
{
    uint32_t UARTx = uartAddr[uartId];
    uint32_t tmpVal;
...
# 644 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_TxFreeRun(UART_ID_Type uartId,BL_Fun_Type txFreeRun)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 672 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_AutoBaudDetection(UART_ID_Type uartId,BL_Fun_Type autoBaud)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 699 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_TxFifoClear(UART_ID_Type uartId)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 722 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_RxFifoClear(UART_ID_Type uartId)
{
    uint32_t tmpVal = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 747 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_IntMask(UART_ID_Type uartId,UART_INT_Type intType,BL_Mask_Type intMask)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
...
# 789 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_IntClear(UART_ID_Type uartId,UART_INT_Type intType)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
...
# 823 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_Int_Callback_Install(UART_ID_Type uartId,UART_INT_Type intType,intCallback_Type* cbFun)
{
...
# 844 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SendData(UART_ID_Type uartId, uint8_t* data,uint32_t len)
{
    uint32_t txLen = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 879 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Err_Type UART_SendDataBlock(UART_ID_Type uartId, uint8_t* data,uint32_t len)
{
    uint32_t txLen = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 916 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
uint32_t UART_ReceiveData(UART_ID_Type uartId,uint8_t* data,uint32_t maxLen)
{
    uint32_t rxLen = 0;
    uint32_t UARTx = uartAddr[uartId];
...
# 941 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
uint16_t UART_GetAutoBaudCount(UART_ID_Type uartId,UART_AutoBaudDetection_Type autoBaudDet)
{
    uint32_t UARTx = uartAddr[uartId];
...
# 965 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
uint8_t UART_GetTxFifoCount(UART_ID_Type uartId)
{
    uint32_t UARTx = uartAddr[uartId];
...
# 983 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
uint8_t UART_GetRxFifoCount(UART_ID_Type uartId)
{
    uint32_t UARTx = uartAddr[uartId];
...
# 1002 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Sts_Type UART_GetIntStatus(UART_ID_Type uartId,UART_INT_Type intType)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
...
# 1038 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Sts_Type UART_GetTxBusBusyStatus(UART_ID_Type uartId)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
...
# 1064 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Sts_Type UART_GetRxBusBusyStatus(UART_ID_Type uartId)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
...
# 1091 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
BL_Sts_Type UART_GetOverflowStatus(UART_ID_Type uartId,UART_Overflow_Type overflow)
{
    uint32_t tmpVal;
    uint32_t UARTx = uartAddr[uartId];
