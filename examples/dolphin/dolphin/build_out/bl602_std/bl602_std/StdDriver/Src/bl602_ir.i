# 1 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
# 1 "/b-l/dolphin/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
# 37 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
...
# 38 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 2
...
# 39 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 2
# 75 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
static intCallback_Type * irIntCbfArra[IR_INT_ALL]= {
# 75 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 3 4
                                                    ((void *)0)
# 75 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
                                                        ,
# 75 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c" 3 4
...
# 156 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxInit(IR_TxCfg_Type *irTxCfg)
{
    uint32_t tmpVal;
...
# 193 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxPulseWidthConfig(IR_TxPulseWidthCfg_Type *irTxPulseWidthCfg)
{
    uint32_t tmpVal;
...
# 236 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxSWMPulseWidthConfig(IR_TxSWMPulseWidthCfg_Type *irTxSWMPulseWidthCfg)
{
...
# 259 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_RxInit(IR_RxCfg_Type *irRxCfg)
{
    uint32_t tmpVal;
...
# 310 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_DeInit(void)
{
...
# 325 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Enable(IR_Direction_Type direct)
{
    uint32_t tmpVal;
...
# 355 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Disable(IR_Direction_Type direct)
{
    uint32_t tmpVal;
...
# 385 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_TxSWM(BL_Fun_Type txSWM)
{
    uint32_t tmpVal;
...
# 408 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_RxFIFOClear(void)
{
    uint32_t tmpVal;
...
# 428 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendData(IR_Word_Type irWord,uint32_t data)
{
...
# 453 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SWMSendData(uint16_t *data,uint8_t length)
{
    uint8_t i = 0,j = 0;
...
# 502 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendCommand(uint32_t word1,uint32_t word0)
{
...
# 547 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SWMSendCommand(uint16_t* data,uint8_t length)
{
    uint32_t timeoutCnt = (100*160*1000);
...
# 591 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_SendNEC(uint8_t address,uint8_t command)
{
...
# 609 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_IntMask(IR_INT_Type intType,BL_Mask_Type intMask)
{
    uint32_t tmpVal;
...
# 639 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_ClrIntStatus(IR_INT_Type intType)
{
    uint32_t tmpVal;
...
# 670 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_Int_Callback_Install(IR_INT_Type intType,intCallback_Type *cbFun)
{
...
# 688 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Sts_Type IR_GetIntStatus(IR_INT_Type intType)
{
    uint32_t tmpVal = 0;
...
# 721 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Sts_Type IR_GetRxFIFOStatus(IR_FifoStatus_Type fifoSts)
{
    uint32_t tmpVal;
...
# 751 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint32_t IR_ReceiveData(IR_Word_Type irWord)
{
    uint32_t tmpVal;
...
# 777 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_SWMReceiveData(uint16_t* data,uint8_t length)
{
    uint8_t rxLen = 0;
...
# 797 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_ReceiveNEC(uint8_t* address,uint8_t* command)
{
...
# 819 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_GetRxDataBitCount(void)
{
    uint32_t tmpVal;
...
# 838 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_GetRxFIFOCount(void)
{
    uint32_t tmpVal;
...
# 858 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
IR_RxMode_Type IR_LearnToInit(uint32_t* data,uint8_t* length)
{
    uint32_t tmpVal;
    uint32_t timeoutCnt = (100*160*1000);
...
# 967 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
uint8_t IR_LearnToReceive(IR_RxMode_Type mode,uint32_t* data)
{
    uint8_t length = 0;
    uint32_t timeoutCnt = (100*160*1000);
...
# 1026 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_ir.c"
BL_Err_Type IR_LearnToSend(IR_RxMode_Type mode,uint32_t* data,uint8_t length)
{
    uint32_t tmpVal;
