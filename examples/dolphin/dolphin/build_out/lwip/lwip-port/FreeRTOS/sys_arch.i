# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
# 1 "/b-l/dolphin/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
# 34 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
...
# 35 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 36 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 37 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 38 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 39 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
 ...
 *mbox = xQueueGenericCreate( ( 50 ), ( sizeof( void * ) ), ( ( ( uint8_t ) 0U ) ) );
 ...
 if (*mbox == 
# 66 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
             ((void *)0)
# 66 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
  return ERR_MEM;
...
# 145 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
u32_t sys_arch_mbox_fetch(sys_mbox_t *mbox, void **msg, u32_t timeout)
{
void *dummyptr;
TickType_t StartTime, EndTime, Elapsed;
 ...
 if ( msg == 
# 152 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0) 
# 152 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
 {
  msg = &dummyptr;
 }
 ...
 if ( timeout != 0 )
 {
  ...
  {
   *msg = 
# 168 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
         ((void *)0)
# 168 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
             ;
...
void *dummyptr;
 ...
 if ( msg == 
# 192 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0) 
# 192 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
 {
  msg = &dummyptr;
 }
...
# 225 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0) 
# 225 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
...
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
 if(*sem == 
# 226 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
           ((void *)0)
# 226 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
               )
 {
...
# 265 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
u32_t sys_arch_sem_wait(sys_sem_t *sem, u32_t timeout)
{
TickType_t StartTime, EndTime, Elapsed;
...
# 300 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0)
# 300 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
err_t sys_mutex_new(sys_mutex_t *mutex) {
  ...
  *mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
  if(*mutex == 
# 344 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
              ((void *)0)
# 344 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                  )
 {
...
# 381 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0)
# 381 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
# 393 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
sys_thread_t sys_thread_new(const char *name, lwip_thread_fn thread , void *arg, int stacksize, int prio)
{
...
int result;
   ...
   if ( s_nextthread < 6 )
   {
    ...
    {
     return 
# 412 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
           ((void *)0)
# 412 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
               ;
    }
   }
   else
   {
      return 
# 417 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0)
# 417 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                ;
   }
}
# 434 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
sys_prot_t sys_arch_protect(void)
{
 vTaskEnterCritical();
 return 1;
