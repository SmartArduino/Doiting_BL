# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
# 1 "/b-l/dolphin/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
# 44 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
...
# 45 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 49 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 50 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/altcp_tls.h" 1
# 61 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/altcp_tls.h"
...
# 51 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 52 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 53 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 55 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 2
...
# 60 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
struct altcp_pcb *
altcp_tls_new(struct altcp_tls_config *config, u8_t ip_type)
{
  ...
  if (inner_conn == 
# 67 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 3 4
                   ((void *)0)
# 67 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
                       ) {
    return 
# 68 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 3 4
          ((void *)0)
# 68 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
              ;
  }
  ret = altcp_tls_wrap(config, inner_conn);
  if (ret == 
# 71 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c" 3 4
            ((void *)0)
# 71 "/b-l/bl_iot_sdk_new/components/network/lwip/src/core/altcp_alloc.c"
                ) {
