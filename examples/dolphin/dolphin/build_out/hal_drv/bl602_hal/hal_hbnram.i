# 1 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
# 1 "/b-l/dolphin/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
# 30 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
...
# 31 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
...
# 32 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
...
# 33 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
...
# 34 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
...
# 36 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.h" 1
# 33 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.h"
...
# 37 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
...
# 39 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 2
# 67 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
...
static uint8_t *get_avaible_area(void)
{
    ...
    return 
# 156 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 156 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
              ;
}
...
static uint8_t *find_addr_by_key(uint8_t *key)
{
    ...
    return 
# 176 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 176 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
              ;
}
...
int hal_hbnram_alloc(const char *key, int len)
{
    ...
    if (paddr == 
# 262 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 262 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                    ) {
...
int hal_hbnram_buffer_set(const char *key, uint8_t *buf, int length)
{
    ...
    if (key == 
# 303 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 303 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                   || buf == 
# 303 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 303 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
    ...
    if (phead == 
# 317 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 317 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                    ) {
...
int hal_hbnram_buffer_get(const char *key, uint8_t *buf, int length)
{
    ...
    if (buf == 
# 358 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 358 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                   || key == 
# 358 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 358 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 370 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 370 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                    ) {
...
int hal_hbnram_handle_get_fromkey(const char *key, hbnram_handle_t *handle)
{
    ...
    if (key == 
# 403 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 403 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                   || handle == 
# 403 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 403 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 416 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 416 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                    ) {
        printf("invalid key \r\n");
        return -1;
    }
...
int hal_hbnram_copy_from_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 437 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 437 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                   || handle == 
# 437 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 437 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
...
int hal_hbnram_copy_to_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 506 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 506 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
                   || handle == 
# 506 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 506 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_hbnram.c"
