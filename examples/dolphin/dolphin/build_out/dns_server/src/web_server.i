# 1 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
# 1 "/b-l/dolphin/build_out/dns_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
# 9 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
...
# 10 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 18 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 21 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 22 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 36 "/b-l/bl_iot_sdk_new/components/network/lwip/lwip-port/arch/sys_arch.h"
# 1 "/b-l/bl_iot_sdk_new/components/bl602/freertos_riscv_ram/config/task.h" 1
...
# 23 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 24 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 25 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/dns_server/include/web_server.h" 1




void web_server2(void *pvParameters);
# 26 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 2
...
# 59 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
     ((void *)0)
# 59 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
     );

      if(buf[5]=='h') {
        netconn_write_partly(conn, http_index_hml, sizeof(http_index_hml)-1, 0x00, 
# 62 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
       ((void *)0)
# 62 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
       );
      }
      else if(buf[5]=='l') {
        netconn_write_partly(conn, http_index_hml, sizeof(http_index_hml)-1, 0x00, 
# 65 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
       ((void *)0)
# 65 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
       );
      }
          ...
          netconn_write_partly(conn, http_index_hml, sizeof(http_index_hml)-1, 0x00, 
# 71 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
         ((void *)0)
# 71 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
         );
      }
    }
  }
...
# 84 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
        ((void *)0)
# 84 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
        );
  netconn_bind(conn, 
# 85 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c" 3 4
                    ((void *)0)
# 85 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/web_server.c"
                        , 80);
