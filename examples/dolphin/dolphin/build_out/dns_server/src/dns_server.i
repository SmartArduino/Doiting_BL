# 1 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
...
# 2 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
...
# 3 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
...
# 4 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/pbuf.h" 1
# 41 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/pbuf.h"
...
# 42 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/pbuf.h" 2
...
# 5 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/udp.h" 1
# 46 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/udp.h"
...
# 6 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/dns_server/include/dns_server.h" 1


void dns_server_init(void);
# 7 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
...
# 8 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 2
# 27 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
...
{
    struct pbuf *rp = 
# 76 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 3 4
                     ((void *)0)
# 76 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
                         ;
    ...
    if (rp != 
# 101 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 3 4
             ((void *)0)
# 101 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
                 ) {
        memset (&hdr, 0, 12);
...
void dns_server_init(void)
{
    ...
    upcb = udp_new();
    if (
# 187 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 3 4
       ((void *)0) 
# 187 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
            == upcb) {
        goto failed_out_1;
    }
    ...
    if (
# 195 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c" 3 4
       ((void *)0) 
# 195 "/b-l/bl_iot_sdk_new/components/network/dns_server/src/dns_server.c"
            == dns_ctx) {
        goto failed_out_3;
    }
