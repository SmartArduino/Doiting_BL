# 1 "/b-l/dolphin/components/do_ble/do_ble.c"
# 1 "/b-l/dolphin/build_out/do_ble//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/dolphin/components/do_ble/do_ble.c"
...
# 5 "/b-l/dolphin/components/do_ble/include/do_ble.h" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/conn.h" 1
# 20 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/conn.h"
# 1 "/b-l/bl_iot_sdk_new/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdbool.h" 1 3 4
# 21 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/conn.h" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/bluetooth.h" 1
# 21 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/bluetooth.h"
...
# 22 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/include/bluetooth/bluetooth.h" 2
...
# 2 "/b-l/dolphin/components/do_ble/do_ble.c" 2
...
# 4 "/b-l/dolphin/components/do_ble/do_ble.c" 2
...
# 5 "/b-l/dolphin/components/do_ble/do_ble.c" 2
...
# 7 "/b-l/dolphin/components/do_ble/do_ble.c" 2
...
# 10 "/b-l/dolphin/components/do_ble/do_ble.c" 2
# 25 "/b-l/dolphin/components/do_ble/do_ble.c"
do_ble_reve_cb_t static_ble_reve_cb = 
# 25 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                                     ((void *)0)
# 25 "/b-l/dolphin/components/do_ble/do_ble.c"
                                         ;
do_ble_connet_cb_t static_ble_connet_cb = 
# 26 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                                         ((void *)0)
# 26 "/b-l/dolphin/components/do_ble/do_ble.c"
                                             ;
...
static void connected(struct bt_conn *conn, u8_t err)
{
 ...
 if (err) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Failed to connect to %s (%u)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", "do_ble.c", 37, addr, err); } while(0);
  return;
 }
...
# 43 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                              ((void *)0)
# 43 "/b-l/dolphin/components/do_ble/do_ble.c"
                                  ){
...
static void disconnected(struct bt_conn *conn, u8_t reason)
{
 ...
 do { bl_printk("\x1b[32m[%10u][%s] " "Disconnected: %s (reason %u)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", addr, reason); } while(0);
    ...
    if(static_ble_connet_cb != 
# 56 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                              ((void *)0)
# 56 "/b-l/dolphin/components/do_ble/do_ble.c"
                                  ){
...
# 111 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                                                 ((void *)0)
# 111 "/b-l/dolphin/components/do_ble/do_ble.c"
                                                     , 0);
    }

    if(err){
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Failed to start advertising (err %d)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", "do_ble.c", 115, err); } while(0);
    }else{
...
# 138 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
                            ((void *)0)
# 138 "/b-l/dolphin/components/do_ble/do_ble.c"
                                ){
...
# 146 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
((void *)0)
# 146 "/b-l/dolphin/components/do_ble/do_ble.c"
...
# 147 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 147 "/b-l/dolphin/components/do_ble/do_ble.c"
...
# 147 "/b-l/dolphin/components/do_ble/do_ble.c"
   , }
                                     ...
                                     ,
    { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .write = 
# 153 "/b-l/dolphin/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 153 "/b-l/dolphin/components/do_ble/do_ble.c"
