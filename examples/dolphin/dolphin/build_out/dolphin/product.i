# 1 "/b-l/dolphin/dolphin/product.c"
...
# 5 "/b-l/dolphin/dolphin/include/product.h" 2
...
# 2 "/b-l/dolphin/dolphin/product.c" 2
...
# 4 "/b-l/dolphin/dolphin/product.c" 2
...
# 5 "/b-l/dolphin/dolphin/product.c" 2
...
# 7 "/b-l/dolphin/dolphin/product.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_pwm.h" 1
# 34 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/hal_pwm.h"
...
# 8 "/b-l/dolphin/dolphin/product.c" 2

# 1 "/b-l/dolphin/components/do_ble/include/do_log.h" 1
...
# 37 "/b-l/bl_iot_sdk_new/components/stage/blog/blog.h" 2
...
blog_level_t _fsymf_level_dolphinproduct;
const blog_info_t _fsymf_info_dolphinproduct __attribute__((used, section(".static_blogfile_code." "dolphinproduct"))) = { (blog_level_t *)(&_fsymf_level_dolphinproduct), (char *)("dolphin.product")};
...
# 5 "/b-l/dolphin/components/do_ble/include/do_log.h" 2
# 10 "/b-l/dolphin/dolphin/product.c" 2
...
# 12 "/b-l/dolphin/dolphin/product.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_gpio.h" 1
# 13 "/b-l/dolphin/dolphin/product.c" 2
...
# 15 "/b-l/dolphin/dolphin/product.c" 2
...
# 16 "/b-l/dolphin/dolphin/product.c" 2
...
# 17 "/b-l/dolphin/dolphin/product.c" 2
# 30 "/b-l/dolphin/dolphin/product.c"
uint8_t charge_status = DISCHARGE;
static 
# 31 "/b-l/dolphin/dolphin/product.c" 3 4
      _Bool 
# 31 "/b-l/dolphin/dolphin/product.c"
           led_status_on = 
# 31 "/b-l/dolphin/dolphin/product.c" 3 4
                           1
# 31 "/b-l/dolphin/dolphin/product.c"
...
void motor_g_set_duty(uint32_t duty){
    hal_pwm_duty_set(2, duty, 0);
}

void motor_c_set_duty(uint32_t duty){
    hal_pwm_duty_set(1, duty, 0);
}

void set_led_status(uint8_t status){
    bl_gpio_output_set(0, status?1:0);
}
...
# 89 "/b-l/dolphin/dolphin/product.c" 3 4
                                       ((void *)0)
# 89 "/b-l/dolphin/dolphin/product.c"
                                           ;
static TimerHandle_t led_power_timer = 
# 90 "/b-l/dolphin/dolphin/product.c" 3 4
                                      ((void *)0)
# 90 "/b-l/dolphin/dolphin/product.c"
                                          ;
...
void led_status_timer_cb(TimerHandle_t timer){
    ...
    if(led_stasus){
        ...
        led_stasus=
# 97 "/b-l/dolphin/dolphin/product.c" 3 4
                  0
# 97 "/b-l/dolphin/dolphin/product.c"
                       ;
        bl_gpio_output_set(0, 1);
    }else{

        led_stasus=
# 101 "/b-l/dolphin/dolphin/product.c" 3 4
                  1
# 101 "/b-l/dolphin/dolphin/product.c"
                      ;
...
void led_power_timer_cb(TimerHandle_t timer){
    static 
# 107 "/b-l/dolphin/dolphin/product.c" 3 4
          _Bool 
# 107 "/b-l/dolphin/dolphin/product.c"
               led_power = 
# 107 "/b-l/dolphin/dolphin/product.c" 3 4
                           0
# 107 "/b-l/dolphin/dolphin/product.c"
    ...
    if(led_power){
        ...
        led_power=
# 110 "/b-l/dolphin/dolphin/product.c" 3 4
                 0
# 110 "/b-l/dolphin/dolphin/product.c"
                      ;
        ...
        led_power=
# 115 "/b-l/dolphin/dolphin/product.c" 3 4
                 1
# 115 "/b-l/dolphin/dolphin/product.c"
                     ;
    }
}
...
void led_status_flash(int ms){
    if(led_status_on){
        if(ms == 0){
            if( xTimerGenericCommand( ( led_status_timer ), ( ( BaseType_t ) 3 ), 0U, 
# 123 "/b-l/dolphin/dolphin/product.c" 3 4
               ((void *)0)
# 123 "/b-l/dolphin/dolphin/product.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) ) ){
                do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer xTimerStop Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 124); } while(0);

            }
            return;
        }

        if(xTimerGenericCommand( ( led_status_timer ), ( ( BaseType_t ) 4 ), ( ms / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ), 
# 130 "/b-l/dolphin/dolphin/product.c" 3 4
          ((void *)0)
# 130 "/b-l/dolphin/dolphin/product.c"
          , ( 1000 ) ) == ( ( ( BaseType_t ) 1 ) ) ){
            if( xTimerGenericCommand( ( led_status_timer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 
# 131 "/b-l/dolphin/dolphin/product.c" 3 4
               ((void *)0)
# 131 "/b-l/dolphin/dolphin/product.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) ) ){
                do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer xTimerStop Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 132); } while(0);
            }
        }else{
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer ChangePeriod Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 135); } while(0);
        }
    }
}
...
void led_power_flash(int ms){
    if(led_status_on){
        if(ms == 0){
            if( xTimerGenericCommand( ( led_power_timer ), ( ( BaseType_t ) 3 ), 0U, 
# 143 "/b-l/dolphin/dolphin/product.c" 3 4
               ((void *)0)
# 143 "/b-l/dolphin/dolphin/product.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) ) ){
                do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer xTimerStop Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 144); } while(0);
            }
            return;
        }

        if(xTimerGenericCommand( ( led_power_timer ), ( ( BaseType_t ) 4 ), ( ms / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ), 
# 149 "/b-l/dolphin/dolphin/product.c" 3 4
          ((void *)0)
# 149 "/b-l/dolphin/dolphin/product.c"
          , ( 1000 ) ) == ( ( ( BaseType_t ) 1 ) ) ){
            if( xTimerGenericCommand( ( led_power_timer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 
# 150 "/b-l/dolphin/dolphin/product.c" 3 4
               ((void *)0)
# 150 "/b-l/dolphin/dolphin/product.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) ) ){
                do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer xTimerStop Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 151); } while(0);
            }
        }else{
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "led_status_timer ChangePeriod Failure" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 154); } while(0);
        }
    }
}
...
static void led_init(void){
    ...
    bl_gpio_enable_input(1,0,0);
    bl_gpio_enable_output(20,0,0);
    bl_gpio_output_set(4, 1);

    led_status_timer = xTimerCreate(((const char*)"led_status_timer"), 500 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ), ( ( BaseType_t ) 1 ), 0, led_status_timer_cb);
 if( led_status_timer == 
# 170 "/b-l/dolphin/dolphin/product.c" 3 4
                        ((void *)0) 
# 170 "/b-l/dolphin/dolphin/product.c"
                             ) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "create led_status_timer fail" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 171); } while(0);
    }


    led_power_timer = xTimerCreate(((const char*)"led_power_timer"), 500 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ), ( ( BaseType_t ) 1 ), 0, led_power_timer_cb);
 if( led_power_timer == 
# 176 "/b-l/dolphin/dolphin/product.c" 3 4
                       ((void *)0) 
# 176 "/b-l/dolphin/dolphin/product.c"
                            ) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "create led_power_timer fail" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "product", "product.c", 177); } while(0);
    }
}
...
void product_init(void){
    ...
    hal_pwm_init(2, 2);
    hal_pwm_freq_update(2, 1000);
    hal_pwm_duty_set(2, 0, 0);
    hal_pwm_start(2);

    hal_pwm_init(1, 8);
    hal_pwm_freq_update(1, 1000);
    hal_pwm_duty_set(1, 0, 0);
    hal_pwm_start(1);
