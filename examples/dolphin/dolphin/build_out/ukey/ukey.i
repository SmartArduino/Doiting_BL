# 1 "/b-l/dolphin/components/ukey/ukey.c"
# 1 "/b-l/dolphin/build_out/ukey//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/dolphin/components/ukey/ukey.c"
...
# 5 "/b-l/dolphin/components/ukey/include/ukey.h" 2
...
# 2 "/b-l/dolphin/components/ukey/ukey.c" 2
...
# 4 "/b-l/dolphin/components/ukey/ukey.c" 2
...
# 6 "/b-l/dolphin/components/ukey/ukey.c" 2
...
# 7 "/b-l/dolphin/components/ukey/ukey.c" 2
...
# 10 "/b-l/dolphin/components/ukey/ukey.c" 2
# 23 "/b-l/dolphin/components/ukey/ukey.c"
static ukey_t *static_key_list[10];
...
static uint64_t keys_read(){
    ...
    for (i = 0; i < static_ukeys.key_num ; i++) {
        if((bl_gpio_input_get_value(static_ukeys.key_list[i]->gpio_name)==0)){
            (key_press_bit |= (1 << static_ukeys.key_list[i]->gpio_name));
...
static ukey_t *keys_get_press_key(uint64_t key_press){
    ...
    for (list_id = 0; list_id < static_ukeys.key_num ; list_id++) {
        if((key_press & (1 << static_ukeys.key_list[list_id]->gpio_name))){
            return static_ukeys.key_list[list_id];
        }
    }
    return 
# 49 "/b-l/dolphin/components/ukey/ukey.c" 3 4
          ((void *)0)
# 49 "/b-l/dolphin/components/ukey/ukey.c"
              ;
}
...
void ukey_handle(void *arg){
    ...
    static uint64_t key_prev = 0;
    static uint64_t key_press = 0;
    static ukey_status key_status = UKEY_STATUS_IDLE;

    while (1)
    {
        ukey_t *key = 
# 61 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                     ((void *)0)
# 61 "/b-l/dolphin/components/ukey/ukey.c"
                         ;
        ...
        case UKEY_STATUS_UNSTABLE:
            if (key_press == key_prev) {
                ...
                if(key && key->key_cb != 
# 76 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                        ((void *)0)
# 76 "/b-l/dolphin/components/ukey/ukey.c"
                                            ){
        ...
        case UKEY_STATUS_DOWN:
            if (key_press != key_prev){
                ...
                if(key && key->key_cb != 
# 89 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                        ((void *)0)
# 89 "/b-l/dolphin/components/ukey/ukey.c"
                                            ){
                ...
                if(time_cnt > (3000 / 30)){
                    key = keys_get_press_key(key_press);
                    if(key && key->key_cb != 
# 98 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                            ((void *)0)
# 98 "/b-l/dolphin/components/ukey/ukey.c"
                                                ){
        ...
        case UKEY_STATUS_LONG:
            if (key_press != key_prev){
                key = keys_get_press_key(key_prev);
                if(key && key->key_cb != 
# 108 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                        ((void *)0)
# 108 "/b-l/dolphin/components/ukey/ukey.c"
                                            ){
...
void ukey_init(void){
    ...
    if (xTaskCreate(ukey_handle, "ukey_handle", 512, 
# 137 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                                    ((void *)0)
# 137 "/b-l/dolphin/components/ukey/ukey.c"
                                                        , 3, 
# 137 "/b-l/dolphin/components/ukey/ukey.c" 3 4
                                                             ((void *)0)
# 137 "/b-l/dolphin/components/ukey/ukey.c"
                                                                 ) != ( ( ( BaseType_t ) 1 ) )) {
        do { bl_printk("\x1b[32m[%10u][%s] " "xTaskCreate(ukey_handle) failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ukey"); } while(0);
    }
}
