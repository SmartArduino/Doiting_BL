...
get_status:
.LFB6:
	.file 1 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
	.loc 1 248 1
	.cfi_startproc
.LVL0:
	.loc 1 249 5
...
.LVL71:
.L67:
	.loc 1 273 204 discriminator 1
	.loc 1 273 213 discriminator 1
	j	.L67
.LVL72:
.L66:
	mv	s0,a1
	.loc 1 273 216 discriminator 2
...
.LVL97:
.L76:
	.loc 1 547 160 discriminator 1
	.loc 1 547 169 discriminator 1
	j	.L76
.LVL98:
.L78:
	.loc 1 554 9
...
.LVL212:
.L157:
	.loc 1 586 195 discriminator 1
	.loc 1 586 204 discriminator 1
	j	.L157
.LVL213:
.L156:
	mv	s0,a1
...
.LVL496:
	...
	li	a2,4096
	.cfi_offset 8, -8
	lui	s0,%hi(value.2989)
	li	a3,0
	addi	a2,a2,-116
	addi	a1,s0,%lo(value.2989)
	.loc 1 874 1
	sw	ra,12(sp)
	.cfi_offset 1, -4
	.loc 1 878 21
...
.LBB239:
	.loc 1 767 36
	addi	a5,s0,%lo(value.2989)
	.loc 1 766 12
	li	a4,0
	.loc 1 767 12
	li	a2,94
	addi	s0,s0,%lo(value.2989)
.L349:
.LVL498:
	.loc 1 767 9 is_stmt 1
	.loc 1 767 36 is_stmt 0
...
.LVL509:
.L358:
	.loc 1 905 160 discriminator 1
	.loc 1 905 169 discriminator 1
	j	.L358
.LVL510:
.L357:
	.loc 1 905 172 discriminator 2
...
.LVL514:
.L360:
	.loc 1 906 172 discriminator 2
	.loc 1 906 181 discriminator 2
	j	.L360
.LVL515:
.L359:
...
.LVL584:
.L417:
	.loc 1 1569 185 discriminator 1
	.loc 1 1569 194 discriminator 1
	j	.L417
.L416:
	.loc 1 1569 197 discriminator 2
...
.LVL585:
.L419:
	.loc 1 1570 195 discriminator 2
	.loc 1 1570 204 discriminator 2
	j	.L419
.L418:
.LBB280:
.LBB281:
...
ef_env_init:
.LFB60:
	.loc 1 1839 75 is_stmt 1
	.cfi_startproc
.LVL626:
	.loc 1 1840 5
	.loc 1 1843 5
	.loc 1 1846 5
	.loc 1 1839 75 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	sw	ra,12(sp)
	sw	s0,8(sp)
	...
	.loc 1 1846 8
	bne	a0,zero,.L441
	.loc 1 1846 27 is_stmt 1 discriminator 1
	lui	a4,%hi(.LANCHOR17)
	lui	a3,%hi(.LC42)
	lui	a2,%hi(.LC1)
	lui	a0,%hi(.LC2)
...
.LVL629:
.L442:
	.loc 1 1846 177 discriminator 1
	.loc 1 1846 186 discriminator 1
	j	.L442
.LVL630:
.L441:
	.loc 1 1855 9 is_stmt 0 discriminator 2
	lui	a5,%hi(.LANCHOR10)
	.loc 1 1855 8 discriminator 2
	lbu	a4,%lo(.LANCHOR10)(a5)
	mv	a3,a0
	.loc 1 1846 189 is_stmt 1 discriminator 2
	.loc 1 1847 5 discriminator 2
	.loc 1 1847 193 discriminator 2
	.loc 1 1849 5 discriminator 2
	.loc 1 1849 232 discriminator 2
	.loc 1 1851 5 discriminator 2
	.loc 1 1851 213 discriminator 2
	.loc 1 1853 5 discriminator 2
	.loc 1 1853 246 discriminator 2
	.loc 1 1855 5 discriminator 2
	addi	s0,a5,%lo(.LANCHOR10)
	.loc 1 1856 16 is_stmt 0 discriminator 2
	li	a0,0
.LVL631:
	.loc 1 1855 8 discriminator 2
	bne	a4,zero,.L443
...
.LVL637:
.L444:
	.loc 1 1864 9 is_stmt 1 discriminator 3
	.loc 1 1864 33 is_stmt 0 discriminator 3
	sw	a2,4(a5)
	addi	a5,a5,8
	.loc 1 1863 5 discriminator 3
	bne	a5,a4,.L444
	.loc 1 1868 5 is_stmt 1
	.loc 1 1868 20 is_stmt 0
	lui	a5,%hi(.LANCHOR1)
...
.LFE60:
	...
	.section	.bss.env.3157,"aw",@nobits
	.align	2
	.set	.LANCHOR13,. + 0
	.type	env.3157, @object
	.size	env.3157, 88
env.3157:
	.zero	88
...
env_cache_table:
	.zero	128
	.section	.bss.sector.3158,"aw",@nobits
	.align	2
	.set	.LANCHOR12,. + 0
	.type	sector.3158, @object
	.size	sector.3158, 24
sector.3158:
	.zero	24
...
sector_cache_table:
	.zero	32
	.section	.bss.value.2989,"aw",@nobits
	.align	2
	.type	value.2989, @object
	.size	value.2989, 3981
value.2989:
	.zero	3981
	.section	.rodata.__FUNCTION__.2801,"a"
	.align	2
	.set	.LANCHOR4,. + 0
	.type	__FUNCTION__.2801, @object
	.size	__FUNCTION__.2801, 13
__FUNCTION__.2801:
	.string	"write_status"
	.section	.rodata.__FUNCTION__.2898,"a"
	.align	2
	.set	.LANCHOR5,. + 0
	.type	__FUNCTION__.2898, @object
	.size	__FUNCTION__.2898, 9
__FUNCTION__.2898:
	.string	"read_env"
	.section	.rodata.__FUNCTION__.2910,"a"
	.align	2
	.set	.LANCHOR7,. + 0
	.type	__FUNCTION__.2910, @object
	.size	__FUNCTION__.2910, 22
__FUNCTION__.2910:
	.string	"read_sector_meta_data"
	.section	.rodata.__FUNCTION__.2997,"a"
	.align	2
	.set	.LANCHOR11,. + 0
	.type	__FUNCTION__.2997, @object
	.size	__FUNCTION__.2997, 18
__FUNCTION__.2997:
	.string	"ef_read_env_value"
	.section	.rodata.__FUNCTION__.3011,"a"
	.align	2
	.set	.LANCHOR6,. + 0
	.type	__FUNCTION__.3011, @object
	.size	__FUNCTION__.3011, 14
__FUNCTION__.3011:
	.string	"format_sector"
	.section	.rodata.__FUNCTION__.3185,"a"
	.align	2
	.set	.LANCHOR15,. + 0
	.type	__FUNCTION__.3185, @object
	.size	__FUNCTION__.3185, 19
__FUNCTION__.3185:
	.string	"ef_env_set_default"
	.section	.rodata.__FUNCTION__.3251,"a"
	.align	2
	.set	.LANCHOR17,. + 0
	.type	__FUNCTION__.3251, @object
	.size	__FUNCTION__.3251, 12
__FUNCTION__.3251:
	.string	"ef_env_init"
...
.LC2:
	.string	"/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
	.zero	3
.LC3:
	.string	"status_table"
...
init_ok:
	.zero	1
	.section	.sbss.last_is_complete_del.3063,"aw",@nobits
	.set	.LANCHOR8,. + 0
	.type	last_is_complete_del.3063, @object
	.size	last_is_complete_del.3063, 1
last_is_complete_del.3063:
	.zero	1
	.text
.Letext0:
	...
	.file 8 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/inc/ef_def.h"
	.file 9 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/inc/easyflash.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	last_is_complete_del.3063
	.byte	0x30
	.4byte	.LASF177
	.byte	0x1
	.2byte	0x43b
