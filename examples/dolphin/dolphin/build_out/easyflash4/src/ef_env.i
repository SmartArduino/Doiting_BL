# 1 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
# 1 "/b-l/dolphin/build_out/easyflash4//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
# 29 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 30 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 2
...
# 31 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 2
...
# 32 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 2
# 135 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 165 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 165 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        check_ok;
    struct {
...
static 
# 210 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 210 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           init_ok = 
# 210 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                     0
# 210 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
static 
# 212 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 212 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           gc_request = 
# 212 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        0
# 212 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
static 
# 214 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 214 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           in_recovery_check = 
# 214 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                               0
# 214 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
static EfErrCode write_status(uint32_t addr, uint8_t status_table[], size_t status_num, size_t status_index)
{
    ...
    if (!(status_index < status_num)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 273, "(%s) has assert failed at %s.\r\n", "status_index < status_num", __FUNCTION__); while (1); };
    if (!(status_table)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 274, "(%s) has assert failed at %s.\r\n", "status_table", __FUNCTION__); while (1); };
...
{
    if (!(status_table)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 296, "(%s) has assert failed at %s.\r\n", "status_table", __FUNCTION__); while (1); };
...
static 
# 337 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 337 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           get_sector_from_cache(uint32_t sec_addr, uint32_t *empty_addr)
{
    ...
    for (i = 0; i < 4; i++) {
        if (sector_cache_table[i].addr == sec_addr) {
            ...
            return 
# 346 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  1
# 346 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                      ;
        }
    }

    return 
# 350 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 350 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
static 
# 397 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 397 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        ...
        if ((env_cache_table[i].addr != 0xFFFFFFFF) && (env_cache_table[i].name_crc == name_crc)) {
            ...
            if (!strncmp(name, saved_name, name_len)) {
                *addr = env_cache_table[i].addr;
                ...
                return 
# 414 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      1
# 414 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                          ;
            }
        }
    }
    ...
    return 
# 419 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 419 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
static EfErrCode read_env(env_node_obj_t env)
{
    ...
    if (env->len == ~0UL || env->len > (2 * (16384)) || env->len < ((unsigned long)(&((struct env_hdr_data *)0)->name_len))) {
        ...
        if (env->status != ENV_ERR_HDR) {
            ...
            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 540, "Error: The ENV @0x%08X length has an error.\r\n", env->addr.start);
            write_status(env->addr.start, env_hdr.status_table, ENV_STATUS_NUM, ENV_ERR_HDR);
        }
        env->crc_is_ok = 
# 543 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        0
# 543 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                             ;
        return EF_READ_ERR;
    } else if (env->len > (4096) - (((((sizeof(struct sector_hdr_data)) + (((1 * 8) + 7)/8) - 1) & ~((((1 * 8) + 7)/8) - 1)))) && env->len < (2 * (16384))) {

        if (!(0)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 547, "(%s) has assert failed at %s.\r\n", "0", __FUNCTION__); while (1); };
    }
    ...
    if (calc_crc32 != env_hdr.crc32) {
        env->crc_is_ok = 
# 565 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        0
# 565 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                             ;
        result = EF_READ_ERR;
    } else {
        env->crc_is_ok = 
# 568 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        1
# 568 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                            ;
...
# 581 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                _Bool 
# 581 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                                     traversal)
{
    EfErrCode result = EF_NO_ERR;
    struct sector_hdr_data sec_hdr;

    if (!(addr % (4096) == 0)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 586, "(%s) has assert failed at %s.\r\n", "addr % SECTOR_SIZE == 0", __FUNCTION__); while (1); };
    if (!(sector)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 587, "(%s) has assert failed at %s.\r\n", "sector", __FUNCTION__); while (1); };
    ...
    if (sector->magic != 0x30344645) {
        sector->check_ok = 
# 596 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                          0
# 596 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                               ;
        sector->combined = 0xFFFFFFFF;
        return EF_ENV_INIT_FAILED;
    }
    sector->check_ok = 
# 600 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      1
# 600 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                          ;
...
# 682 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
       _Bool 
# 682 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 690 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                    0
# 690 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                         ) != EF_NO_ERR) {
            continue;
        }
        if (callback == 
# 693 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                       ((void *)0)
# 693 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                           ) {
            continue;
        }
...
static 
# 711 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 711 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           find_env_cb(env_node_obj_t env, void *arg1, void *arg2)
{
    const char *key = arg1;
    
# 714 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 714 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        *find_ok = arg2;
    size_t key_len = strlen(key);

    if (key_len != env->name_len) {
        return 
# 718 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
              0
# 718 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                   ;
    }

    if (env->crc_is_ok && env->status == ENV_WRITE && !strncmp(env->name, key, key_len)) {
        *find_ok = 
# 722 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  1
# 722 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                      ;
        return 
# 723 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
              1
# 723 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                  ;
    }
    return 
# 725 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 725 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}

static 
# 728 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 728 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           find_env_no_cache(const char *key, env_node_obj_t env)
{
    
# 730 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 730 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        find_ok = 
# 730 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  0
# 730 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
static 
# 737 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 737 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           find_env(const char *key, env_node_obj_t env)
{
    
# 739 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 739 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        find_ok = 
# 739 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  0
# 739 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    if (get_env_from_cache(key, key_len, &env->addr.start)) {
        read_env(env);
        return 
# 746 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
              1
# 746 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                  ;
    }
...
static 
# 761 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 761 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           ef_is_str(uint8_t *value, size_t len)
{
    ...
    for (i = 0; i < len; i++) {
        if (!((unsigned int)((value[i]) - ' ') < 127u - ' ')) {
            return 
# 768 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  0
# 768 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                       ;
        }
    }
    return 
# 771 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          1
# 771 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
              ;
}
...
# 804 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"

# 804 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
_Bool 
# 804 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ef_get_env_obj(const char *key, env_node_obj_t env)
{
    
# 806 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 806 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        find_ok = 
# 806 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  0
# 806 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 834 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
size_t ef_get_env_blob(const char *key, void *value_buf, size_t buf_len, size_t *saved_value_len)
{
    size_t read_len = 0;
...
# 873 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
char *ef_get_env(const char *key)
{
...
# 878 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                          ((void *)0)
# 878 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                              )) > 0) {
        ...
        if (ef_is_str((uint8_t *)value, get_size)) {
            ...
            return 
# 885 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  ((void *)0)
# 885 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                      ;
        }
    }

    return 
# 889 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          ((void *)0)
# 889 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
              ;
}
# 901 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
size_t ef_read_env_value(env_node_obj_t env, uint8_t *value_buf, size_t buf_len)
{
    size_t read_len = 0;

    if (!(env)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 905, "(%s) has assert failed at %s.\r\n", "env", __FUNCTION__); while (1); };
    if (!(value_buf)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 906, "(%s) has assert failed at %s.\r\n", "value_buf", __FUNCTION__); while (1); };
...
static EfErrCode format_sector(uint32_t addr, uint32_t combined_value)
{
    ...
    if (!(addr % (4096) == 0)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 949, "(%s) has assert failed at %s.\r\n", "addr % SECTOR_SIZE == 0", __FUNCTION__); while (1); };
...
# 972 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                 _Bool 
# 972 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                                      *is_full)
{
    ...
    if (sector->status.store == SECTOR_STORE_EMPTY) {
        ...
        if (sector->remain < ((((((sizeof(struct env_hdr_data)) + (((1 * 8) + 7)/8) - 1) & ~((((1 * 8) + 7)/8) - 1)))) + (64)) || sector->remain - new_env_len < ((((((sizeof(struct env_hdr_data)) + (((1 * 8) + 7)/8) - 1) & ~((((1 * 8) + 7)/8) - 1)))) + (64))) {
            ...
            if (is_full) {
                *is_full = 
# 992 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                          1
# 992 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                              ;
            }
        } else if (is_full) {
            *is_full = 
# 995 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      0
# 995 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                           ;
        }
    }
...
# 1003 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
       _Bool 
# 1003 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1009 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                               0
# 1009 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                    );
...
static 
# 1022 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1022 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           sector_statistics_cb(sector_meta_data_t sector, void *arg1, void *arg2)
{
    ...
    return 
# 1032 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1032 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}

static 
# 1035 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1035 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           alloc_env_cb(sector_meta_data_t sector, void *arg1, void *arg2)
{
    ...
    if (sector->check_ok && sector->remain > *env_size
        ...
        *empty_env = sector->empty_env;
        return 
# 1047 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
              1
# 1047 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                  ;
    }

    return 
# 1050 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1050 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
# 1059 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                                    0
# 1059 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                                                         );
    if (using_sector > 0) {

        sector_iterator(sector, SECTOR_STORE_USING, &env_size, &empty_env, alloc_env_cb, 
# 1062 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                        1
# 1062 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                                            );
    }
...
# 1066 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                            1
# 1066 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                                                );
        } else {

            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1069, "Trigger a GC check after alloc ENV failed.\r\n");
            gc_request = 
# 1070 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        1
# 1070 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                            ;
        }
    }
...
# 1077 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                 _Bool 
# 1077 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                      complete_del) {
    EfErrCode result = EF_NO_ERR;
    uint32_t dirty_status_addr;
    static 
# 1080 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          _Bool 
# 1080 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1080 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    if (!old_env) {
        ...
        if (find_env(key, &env)) {
            ...
            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1095, "Not found '%s' in ENV.\r\n", key);
    ...
    if (!complete_del) {
        ...
        last_is_complete_del = 
# 1102 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                              1
# 1102 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                  ;
    } else {
        ...
        if (!last_is_complete_del && result == EF_NO_ERR) {
            ...
            if (key != 
# 1109 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      ((void *)0)
# 1109 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                          ) {

                update_env_cache(key, strlen(key), 0xFFFFFFFF);
            } else if (old_env != 
# 1112 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                 ((void *)0)
# 1112 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                     ) {
        ...
        last_is_complete_del = 
# 1119 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                              0
# 1119 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                   ;
    }
...
static EfErrCode move_env(env_node_obj_t env)
{
    ...
    if (env->status == ENV_WRITE) {
        del_env(
# 1144 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
               ((void *)0)
# 1144 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                   , env, 
# 1144 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                          0
# 1144 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1168 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                            ((void *)0)
# 1168 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                );
    ...
    ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1190, "Moved the ENV (%.*s) from 0x%08X to 0x%08X.\r\n", env->name_len, env->name, env->addr.start, env_addr);

__exit:
    del_env(
# 1193 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
           ((void *)0)
# 1193 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               , env, 
# 1193 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      1
# 1193 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1200 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 1200 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        already_gc = 
# 1200 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                     0
# 1200 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
__retry:
    ...
    if ((empty_env = alloc_env(sector, env_size)) == 0xFFFFFFFF && gc_request && !already_gc) {
        ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1206, "Warning: Alloc an ENV (size %d) failed when new ENV. Now will GC then retry.\r\n", env_size);
        gc_collect();
        already_gc = 
# 1208 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                    1
# 1208 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                        ;
        goto __retry;
    }
...
static 
# 1222 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1222 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           gc_check_cb(sector_meta_data_t sector, void *arg1, void *arg2)
{
    ...
    return 
# 1230 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1230 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;

}

static 
# 1234 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1234 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        ...
        while ((env.addr.start = get_next_env_addr(sector, &env)) != 0xFFFFFFFF) {
            ...
            if (env.crc_is_ok && (env.status == ENV_WRITE || env.status == ENV_PRE_DELETE)) {
                ...
                if (move_env(&env) != EF_NO_ERR) {
                    ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1249, "Error: Moved the ENV (%.*s) for GC failed.\r\n", env.name_len, env.name);
                }
            }
        }
        format_sector(sector->addr, 0xFFFFFFFF);
        ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1254, "Collect a sector @0x%08X\r\n", sector->addr);
    }

    return 
# 1257 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1257 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
# 1271 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                            ((void *)0)
# 1271 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                , gc_check_cb, 
# 1271 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                               0
# 1271 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1274, "The remain empty sector is %d, GC threshold is %d.\r\n", empty_sec, 1);
    if (empty_sec <= 1) {
        sector_iterator(&sector, SECTOR_STORE_UNUSED, 
# 1276 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                     ((void *)0)
# 1276 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                         , 
# 1276 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                           ((void *)0)
# 1276 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1276 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    gc_request = 
# 1279 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                0
# 1279 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                     ;
}
...
# 1312 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 1312 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        is_full = 
# 1312 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  0
# 1312 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    if (env_addr != 0xFFFFFFFF || (env_addr = new_env(sector, env_hdr.len)) != 0xFFFFFFFF) {
        ...
        if (result == EF_NO_ERR && is_full) {
            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1378, "Trigger a GC check after created ENV.\r\n");
            gc_request = 
# 1379 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                        1
# 1379 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                            ;
        }
    } else {
        result = EF_ENV_FULL;
...
# 1395 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_del_env(const char *key)
{
    EfErrCode result = EF_NO_ERR;
    ...
    result = del_env(key, 
# 1412 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                         ((void *)0)
# 1412 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                             , 
# 1412 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                               1
# 1412 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1430 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_del_and_save_env(const char *key)
{
...
# 1440 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 1440 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        env_is_found = 
# 1440 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                       0
# 1440 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    if (value_buf == 
# 1442 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                    ((void *)0)
# 1442 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                        ) {
        result = del_env(key, 
# 1443 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                             ((void *)0)
# 1443 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                 , 
# 1443 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                   1
# 1443 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
# 1452 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                       0
# 1452 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                            );
        }
        ...
        if (env_is_found && result == EF_NO_ERR) {
            result = del_env(key, &env, 
# 1460 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                       1
# 1460 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                           );
        }
...
# 1481 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_set_env_blob(const char *key, const void *value_buf, size_t buf_len)
{
    EfErrCode result = EF_NO_ERR;
...
# 1526 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_set_env(const char *key, const char *value)
{
    return ef_set_env_blob(key, value, strlen(value));
}
# 1542 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_set_and_save_env(const char *key, const char *value)
{
    return ef_set_env_blob(key, value, strlen(value));
}
...
EfErrCode ef_env_set_default(void)
{
    ...
    if (!(default_env_set)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1569, "(%s) has assert failed at %s.\r\n", "default_env_set", __FUNCTION__); while (1); };
    if (!(default_env_set_size)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1570, "(%s) has assert failed at %s.\r\n", "default_env_set_size", __FUNCTION__); while (1); };
...
static 
# 1604 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1604 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           print_env_cb(env_node_obj_t env, void *arg1, void *arg2)
{
    
# 1606 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
   _Bool 
# 1606 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
        value_is_str = 
# 1606 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                       1
# 1606 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
__reload:
                ...
                for (len = 0, size = 0; len < env->value_len; len += size) {
                    ...
                    if (print_value) {
                        ...
                        value_is_str = 
# 1631 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                      0
# 1631 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                           ;
                        break;
                    }
                }
                ...
                value_is_str = 
# 1636 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                              0
# 1636 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                   ;
            }
            if (value_is_str && !print_value) {
                print_value = 
# 1639 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                             1
# 1639 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                 ;
                goto __reload;
    ...
    return 
# 1648 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1648 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
# 1668 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                   ((void *)0)
# 1668 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                       , print_env_cb);
...
void ef_print_env_cb(print_env_cb_t cb)
{
    ...
    env_iterator(&env, &using_size, 
# 1692 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                   ((void *)0)
# 1692 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                       , cb);
...
# 1741 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
static 
# 1741 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1741 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           check_sec_hdr_cb(sector_meta_data_t sector, void *arg1, void *arg2)
{
    ...
    return 
# 1751 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1751 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}

static 
# 1754 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1754 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           check_and_recovery_gc_cb(sector_meta_data_t sector, void *arg1, void *arg2)
{
    if (sector->check_ok && sector->status.dirty == SECTOR_DIRTY_GC) {
        ...
        gc_request = 
# 1758 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                    1
# 1758 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                        ;
    ...
    return 
# 1763 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1763 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}

static 
# 1766 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
      _Bool 
# 1766 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
           check_and_recovery_env_cb(env_node_obj_t env, void *arg1, void *arg2)
{
    ...
    if (env->crc_is_ok && env->status == ENV_PRE_DELETE) {
        ...
        if (move_env(env) == EF_NO_ERR) {
            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1773, "Recovery the ENV successful.\r\n");
        } else {
            ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1775, "Warning: Moved an ENV (size %d) failed when recovery. Now will GC then retry.\r\n", env->len);
            return 
# 1776 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                  1
# 1776 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                      ;
        }
        ...
        return 
# 1783 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
              1
# 1783 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                  ;
    }

    return 
# 1786 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
          0
# 1786 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
               ;
}
...
EfErrCode ef_load_env(void)
{
    ...
    in_recovery_check = 
# 1801 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                       1
# 1801 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                           ;

    sector_iterator(&sector, SECTOR_STORE_UNUSED, &check_failed_count, 
# 1803 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                      ((void *)0)
# 1803 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                                          , check_sec_hdr_cb, 
# 1803 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                                                              0
# 1803 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    sector_iterator(&sector, SECTOR_STORE_UNUSED, 
# 1813 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                 ((void *)0)
# 1813 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                                                     , 
# 1813 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                                                       ((void *)0)
# 1813 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
...
__retry:
    ...
    env_iterator(&env, 
# 1817 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                      ((void *)0)
# 1817 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                          , 
# 1817 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                            ((void *)0)
# 1817 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
    ...
    in_recovery_check = 
# 1823 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                       0
# 1823 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                            ;
...
# 1839 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
EfErrCode ef_env_init(ef_env const *default_env, size_t default_env_size) {
    ...
    if (!(default_env)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1846, "(%s) has assert failed at %s.\r\n", "default_env", __FUNCTION__); while (1); };
    if (!((2 * (16384)))) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1847, "(%s) has assert failed at %s.\r\n", "ENV_AREA_SIZE", __FUNCTION__); while (1); };

    if (!((2 * (16384)) % (4096) == 0)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1849, "(%s) has assert failed at %s.\r\n", "ENV_AREA_SIZE % EF_ERASE_MIN_SIZE == 0", __FUNCTION__); while (1); };

    if (!(((2 * (16384)) / ((4096))) >= 2)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1851, "(%s) has assert failed at %s.\r\n", "SECTOR_NUM >= 2", __FUNCTION__); while (1); };

    if (!(((3980) * 8) % (1 * 8) == 0)) { ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1853, "(%s) has assert failed at %s.\r\n", "(EF_STR_ENV_VALUE_MAX_SIZE * 8) % EF_WRITE_GRAN == 0", __FUNCTION__); while (1); };
    ...
    ef_log_debug("/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c", 1872, "ENV start address is 0x%08X, size is %d bytes.\r\n", (0), (2 * (16384)));
    ...
    if (result == EF_NO_ERR) {
        init_ok = 
# 1883 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c" 3 4
                 1
# 1883 "/b-l/bl_iot_sdk_new/components/stage/easyflash4/src/ef_env.c"
                     ;
    }
