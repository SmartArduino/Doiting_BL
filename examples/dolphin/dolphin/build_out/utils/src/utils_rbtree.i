# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
# 1 "/b-l/dolphin/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
# 31 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
...
# 32 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/utils/include/utils_rbtree.h" 1
# 65 "/b-l/bl_iot_sdk_new/components/utils/include/utils_rbtree.h"
...
# 66 "/b-l/bl_iot_sdk_new/components/utils/include/utils_rbtree.h" 2

# 1 "/b-l/bl_iot_sdk_new/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stddef.h" 1 3 4
# 68 "/b-l/bl_iot_sdk_new/components/utils/include/utils_rbtree.h" 2
...
# 73 "/b-l/bl_iot_sdk_new/components/utils/include/utils_rbtree.h"
struct rb_node;
struct rb_tree;
...
# 33 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 2
...
# 45 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                       ((void *)0)
# 45 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                           ;
        self->value = value;
    }
    return self;
...
# 70 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                            ((void *)0)
# 70 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                ;
...
{
    struct rb_node *result = 
# 84 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                            ((void *)0)
# 84 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                ;
...
struct rb_tree * rb_tree_init (struct rb_tree *self, rb_tree_node_cmp_f node_cmp_cb)
{
    if (self) {
        self->root = 
# 117 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                    ((void *)0)
# 117 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                        ;
        self->size = 0;
...
void rb_tree_dealloc(struct rb_tree *self, rb_tree_node_f node_cb)
{
    if (self) {
        if (node_cb) {
            ...
            struct rb_node *save = 
# 135 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                  ((void *)0)
# 135 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                      ;
            ...
            while (node) {
                if (node->link[0] == 
# 141 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                    ((void *)0)
# 141 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                        ) {
                    ...
                    node_cb(self, node);
                    node = 
# 146 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                          ((void *)0)
# 146 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                              ;
                } else {
...
int rb_tree_test(struct rb_tree *self, struct rb_node *root)
{
    ...
    if (
# 165 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
       ((void *)0) 
# 165 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
            == root) {
        return 1;
    } else {
        ...
        if ( ( ln != 
# 183 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                    ((void *)0) 
# 183 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                         && self->cmp(self, ln, root) >= 0 )
            || ( rn != 
# 184 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                      ((void *)0) 
# 184 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
...
{
    void *result = 
# 206 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                  ((void *)0)
# 206 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                      ;
    ...
    if (self) {
        ...
        result = it ? it->value : 
# 222 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                 ((void *)0)
# 222 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                     ;
    }
    return result;
}
...
int rb_tree_insert_node (struct rb_tree *self, struct rb_node *node)
{
    if (self && node) {
        if (self->root == 
# 237 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                         ((void *)0)
# 237 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                             ) {
            self->root = node;
        } else {
            ...
            t = &head;
            g = p = 
# 247 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                   ((void *)0)
# 247 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                       ;
            ...
            while (1) {
                if (q == 
# 252 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                        ((void *)0)
# 252 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                            ) {
                ...
                if (g != 
# 285 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                        ((void *)0)
# 285 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                            ) {
                    t = g;
                }
...
{
    if (self->root != 
# 310 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                     ((void *)0)
# 310 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                         ) {
        struct rb_node head = {0};
        struct rb_node node = { .value = value };
        struct rb_node *q, *p, *g;
        struct rb_node *f = 
# 314 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                           ((void *)0)
# 314 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                               ;
        int dir = 1;
        ...
        q = &head;
        g = p = 
# 319 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
               ((void *)0)
# 319 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                   ;
        q->link[1] = self->root;
        ...
        while (q->link[dir] != 
# 324 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                              ((void *)0)
# 324 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                  ) {
            int last = dir;
...
# 375 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                                            ((void *)0)
# 375 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                                                ];
            ...
            q = 
# 380 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
               ((void *)0)
# 380 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                   ;
        }
        ...
        if (self->root != 
# 387 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                         ((void *)0)
# 387 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                             ) {
            self->root->red = 0;
        }
...
struct rb_iter * rb_iter_init (struct rb_iter *self)
{
    if (self) {
        self->tree = 
# 425 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                    ((void *)0)
# 425 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                        ;
        self->node = 
# 426 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                    ((void *)0)
# 426 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                        ;
        self->top = 0;
    }
    return self;
...
{
    void *result = 
# 448 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                  ((void *)0)
# 448 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                      ;
    ...
    if (self) {
        ...
        if (self->node != 
# 456 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                         ((void *)0)
# 456 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                             ) {
            while (self->node->link[dir] != 
# 457 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                           ((void *)0)
# 457 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                               ) {
        ...
        result = self->node == 
# 462 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                              ((void *)0) 
# 462 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                   ? 
# 462 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                     ((void *)0) 
# 462 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
...
# 471 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                ((void *)0)
# 471 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                    ) {

        self->path[self->top++] = self->node;
        self->node = self->node->link[dir];
        while ( self->node->link[!dir] != 
# 475 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                                         ((void *)0) 
# 475 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                              ) {
            self->path[self->top++] = self->node;
            self->node = self->node->link[!dir];
        }
        ...
        struct rb_node *last = 
# 481 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                              ((void *)0)
# 481 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                  ;
        do {
            if (self->top == 0) {
                self->node = 
# 484 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                            ((void *)0)
# 484 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                                ;
                break;
            }
            last = self->node;
    ...
    return self->node == 
# 491 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                        ((void *)0) 
# 491 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
                             ? 
# 491 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c" 3 4
                               ((void *)0) 
# 491 "/b-l/bl_iot_sdk_new/components/utils/src/utils_rbtree.c"
