# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
# 1 "/b-l/dolphin/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
# 33 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
...
# 34 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 2
...
# 35 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 2
...
# 36 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 2

void utils_list_init(struct utils_list *list)
{
    list->first = 
# 39 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                 ((void *)0)
# 39 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                     ;
    list->last = 
# 40 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                ((void *)0)
# 40 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                    ;
}
...
void utils_list_push_back(struct utils_list *list, struct utils_list_hdr *list_hdr)
{
    ...
    list->last = list_hdr;
    list_hdr->next = 
# 83 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                    ((void *)0)
# 83 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                        ;
}
...
struct utils_list_hdr *utils_list_pop_front(struct utils_list *list)
{
    ...
    element = list->first;
    if (element != 
# 110 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                  ((void *)0)
# 110 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                      )
    {
...
void utils_list_extract(struct utils_list *list, struct utils_list_hdr *list_hdr)
{
    ...
    if (scan_list == 
# 130 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                    ((void *)0)
# 130 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                        )
        return;
...
# 142 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                                  ((void *)0)
# 142 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
        ...
        if (scan_list->next != 
# 148 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                              ((void *)0)
# 148 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                                  )
        {
...
# 168 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                                                        ((void *)0)
# 168 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                                                            ))
    {
...
unsigned int utils_list_cnt(const struct utils_list *const list)
{
    ...
    while (elt != 
# 182 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                 ((void *)0)
# 182 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                     )
    {
        cnt++;
...
# 206 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
void utils_list_insert(struct utils_list * const list, struct utils_list_hdr * const element,
                    int (*cmp)(struct utils_list_hdr const *elementA, struct utils_list_hdr const *elementB))
{
    struct utils_list_hdr *prev = 
# 209 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                                 ((void *)0)
# 209 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                                     ;
...
void utils_list_insert_after(struct utils_list * const list, struct utils_list_hdr * const prev_element, struct utils_list_hdr * const element)
{
    ...
    if (prev_element == 
# 251 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                       ((void *)0)
# 251 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                           )
    {
    ...
    else
    {
        ...
        if (scan)
        {
            ...
            if (element->next == 
# 276 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                                ((void *)0)
# 276 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                                    )
            {
                list->last = element;
            }
...
{
    if (next_element == 
# 286 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                       ((void *)0)
# 286 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                           )
    {
...
void utils_list_concat(struct utils_list *list1, struct utils_list *list2)
{
    ...
    if (list2->first != 
# 324 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                       ((void *)0)
# 324 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                           )
    {

        if (list1->first == 
# 327 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                           ((void *)0)
# 327 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                               )
        {
        ...
        list2->first = 
# 339 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                      ((void *)0)
# 339 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                          ;
    }
}
...
void utils_list_remove(struct utils_list *list, struct utils_list_hdr *prev_element, struct utils_list_hdr *element)
{
    ...
    if (prev_element == 
# 353 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                       ((void *)0)
# 353 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                           )
    {
    ...
    element->next = 
# 364 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c" 3 4
                   ((void *)0)
# 364 "/b-l/bl_iot_sdk_new/components/utils/src/utils_list.c"
                       ;
}
