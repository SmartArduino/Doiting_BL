# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
# 1 "/b-l/dolphin/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
# 32 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
...
# 33 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 2
...
# 34 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 2
...
# 35 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 2
...
# 38 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 2
# 46 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
typedef struct {
    uint8_t _id;
    uint8_t _size;
    uint16_t _offset;
...
uint8_t find_error_locator(fec_context_t *context, blpoly_t *synd, blpoly_t *erase_loc, unsigned long erase_count)
{
    ...
    if (erase_loc != 
# 535 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 535 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
                        ) {
    ...
    {
        if (erase_loc != 
# 552 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 3 4
                        ((void *)0)
# 552 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
                            ) {
...
char decode_block(fec_context_t *context, void* src, const void* ecc, void* dst, uint8_t* erase_pos, unsigned long erase_count)
{
    ...
    if (erase_pos == 
# 774 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 774 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
                        ) {
        epos->length = 0;
    } else {
...
# 805 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c" 3 4
                                       ((void *)0)
# 805 "/b-l/bl_iot_sdk_new/components/utils/src/utils_fec.c"
                                           , epos->length);
