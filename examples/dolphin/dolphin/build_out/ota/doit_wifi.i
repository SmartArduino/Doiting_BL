# 1 "/b-l/dolphin/components/ota/doit_wifi.c"
# 1 "/b-l/dolphin/build_out/ota//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/dolphin/components/ota/doit_wifi.c"
# 1 "/b-l/dolphin/components/ota/include/doit_wifi.h" 1
...
# 2 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 4 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 5 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 7 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 8 "/b-l/dolphin/components/ota/doit_wifi.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip_dhcpd/dhcp_server.h" 1
# 19 "/b-l/bl_iot_sdk_new/components/network/lwip_dhcpd/dhcp_server.h"
void dhcpd_start(struct netif *netif);
# 9 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 11 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 34 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/bl_rtc.h"
...
# 35 "/b-l/bl_iot_sdk_new/components/hal_drv/bl602_hal/bl_rtc.h" 2
...
# 12 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 13 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 15 "/b-l/dolphin/components/ota/doit_wifi.c" 2
# 1 "/b-l/dolphin/components/ota/include/app_config.h" 1
# 16 "/b-l/dolphin/components/ota/doit_wifi.c" 2
# 1 "/b-l/dolphin/components/ota/include/doit_flash.h" 1
...
# 1 "/b-l/dolphin/components/ota/include/app_config.h" 1
# 8 "/b-l/dolphin/components/ota/include/doit_flash.h" 2
...
# 17 "/b-l/dolphin/components/ota/doit_wifi.c" 2
...
# 18 "/b-l/dolphin/components/ota/doit_wifi.c" 2
# 29 "/b-l/dolphin/components/ota/doit_wifi.c"
static char static_wifi_connect_status = 0;
static wifi_event_cb_t static_wifi_cb = 
# 30 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                                       ((void *)0)
# 30 "/b-l/dolphin/components/ota/doit_wifi.c"
                                           ;
    ...
    switch (event->code) {
        case 5:
        {
            ...
            if(static_wifi_connect_status != 0){
                ...
                if(static_wifi_cb != 
# 41 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                                    ((void *)0)
# 41 "/b-l/dolphin/components/ota/doit_wifi.c"
                                        ){
        ...
        case 7:
        {
            ...
            if(static_wifi_connect_status != 1){
                ...
                if(static_wifi_cb != 
# 57 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                                    ((void *)0)
# 57 "/b-l/dolphin/components/ota/doit_wifi.c"
                                        ){
...
# 100 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                                                                               ((void *)0)
# 100 "/b-l/dolphin/components/ota/doit_wifi.c"
                                                                                   , 
# 100 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                                                                                     ((void *)0)
# 100 "/b-l/dolphin/components/ota/doit_wifi.c"
...
void wifi_event_handler(wifi_event_indicate_t event){
    switch (event)
    {
        case WIFI_EVENT_CONNECT:
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "wifi_connect" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "wifi", "doit_wifi.c", 108); } while(0);
            doit_ota_server_init();
            break;
        case WIFI_EVENT_DISCONNECT:
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "wifi_disconnect" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "wifi", "doit_wifi.c", 112); } while(0);
            break;
        default:
            do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "wifi_event: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "wifi", "doit_wifi.c", 115,event); } while(0);
            break;
    }
}
...
void wifi_init(wifi_event_cb_t user_wifi_event_cb) {
    ...
    cmd_stack_wifi(
# 124 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                  ((void *)0)
# 124 "/b-l/dolphin/components/ota/doit_wifi.c"
                      , 0, 0, 
# 124 "/b-l/dolphin/components/ota/doit_wifi.c" 3 4
                              ((void *)0)
# 124 "/b-l/dolphin/components/ota/doit_wifi.c"
