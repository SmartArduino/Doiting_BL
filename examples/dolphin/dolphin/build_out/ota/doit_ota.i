# 1 "/b-l/dolphin/components/ota/doit_ota.c"
# 1 "/b-l/dolphin/build_out/ota//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/dolphin/components/ota/doit_ota.c"
# 1 "/b-l/dolphin/components/ota/include/doit_ota.h" 1
# 18 "/b-l/dolphin/components/ota/include/doit_ota.h"
void doit_ota_server_init(void);
# 2 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 4 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 5 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/mem.h" 1
# 40 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/mem.h"
...
# 41 "/b-l/bl_iot_sdk_new/components/network/lwip/src/include/lwip/mem.h" 2
...
# 6 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 7 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 8 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 9 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 11 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 12 "/b-l/dolphin/components/ota/doit_ota.c" 2

# 1 "/b-l/dolphin/dolphin/include/ulog.h" 1
...
# 5 "/b-l/dolphin/dolphin/include/ulog.h" 2
# 1 "/b-l/dolphin/dolphin/include/app_config.h" 1
# 6 "/b-l/dolphin/dolphin/include/ulog.h" 2
# 14 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 1 "/b-l/dolphin/components/ota/include/app_config.h" 1
# 15 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 1 "/b-l/dolphin/components/ota/include/doit_system.h" 1
...
# 16 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 18 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 19 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/utils/include/utils_sha256.h" 1
# 47 "/b-l/bl_iot_sdk_new/components/utils/include/utils_sha256.h"
typedef struct {
    uint32_t total[2];
    uint32_t state[8];
...
# 96 "/b-l/bl_iot_sdk_new/components/utils/include/utils_sha256.h"
...
# 116 "/b-l/bl_iot_sdk_new/components/utils/include/utils_sha256.h"
void utils_sha256(const uint8_t *input, uint32_t ilen, uint8_t output[32]);
# 20 "/b-l/dolphin/components/ota/doit_ota.c" 2
...
# 21 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/sys/blmtd/include/bl_mtd.h" 1
# 34 "/b-l/bl_iot_sdk_new/components/sys/blmtd/include/bl_mtd.h"
...
# 22 "/b-l/dolphin/components/ota/doit_ota.c" 2
# 39 "/b-l/dolphin/components/ota/doit_ota.c"
...
{
 do { bl_printk("\x1b[32m[%10u][%s] " "--------->ota_start" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);

 int ret;
 ret = bl_mtd_open("FW", &handle, (1 << 0));
    if (ret) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Open Default FW partition failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 137); } while(0);
        return 0;
    }

 uint8_t activeID;
 activeID = hal_boot2_get_active_partition();
 do { bl_printk("\x1b[32m[%10u][%s] " "activeID is %u" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", activeID); } while(0);


 if (hal_boot2_get_active_entries((0), &ptEntry)) {
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "PtTable_Get_Active_Entries fail" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 147); } while(0);
        bl_mtd_close(handle);
        return 0;
    }
 ...
 ota_addr = ptEntry.Address[!ptEntry.activeIndex];
    ...
    (void) part_size;
    do { bl_printk("\x1b[32m[%10u][%s] " "Starting OTA test. OTA size is %lu\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", bin_size); } while(0);
    do { bl_printk("\x1b[32m[%10u][%s] " "activeIndex is %u, use OTA address=%08x\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", ptEntry.activeIndex, (unsigned int)ota_addr); } while(0);
    do { bl_printk("\x1b[32m[%10u][%s] " "Erase flash with size %lu..." "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", bin_size); } while(0);

 utils_sha256_init(&ctx);
    utils_sha256_starts(&ctx);
 memset(sha256_result, 0, sizeof(sha256_result));

 ota_header_buffer = pvPortMalloc((512));
...
{
 do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " " OTA END" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 173); } while(0);
 int i = 0;
 int ret = 0;
 ...
 if (memcmp(sha256_img, sha256_result, sizeof(sha256_img))) {
  ...
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "SHA256 NOT Correct" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 192); } while(0);
  return 0;
 }
 ...
 do { bl_printk("\x1b[32m[%10u][%s] " "boot2_update ret: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", ret); } while(0);
 system_delay_reboot();
 return 1;
}
...
static void ota_pkg_parser(int socket, uint8_t *buff, int len)
{
 ...
 if (len < 9) {
  do { bl_printk("\x1b[32m[%10u][%s] " "error package len<9, len=%d\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", len); } while(0);
  int i = 0;
  for (i = 0; i < len; i++) { do { bl_printk("\x1b[32m[%10u][%s] " "%02x " "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", buff[i]); } while(0); }
  do { bl_printk("\x1b[32m[%10u][%s] " "\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);
  goto EXCEPTION_OCCUR;
 }

 if (buff[0] != 0xf1 || buff[1] != 0xf1) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "error package prefix, pkg[0]=%02x, pkg[1]=%02x, pkg[2]=%02x, pkg[3]=%02x, chksum=%02x, last=%02x, pkgLen=%d\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 238, buff[0], buff[1], buff[2], buff[3], buff[len - 2], buff[len - 1], len); } while(0);
  goto EXCEPTION_OCCUR;
 }

 if (buff[len - 1] != 0x7e) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "error package suffix\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 243); } while(0);
  goto EXCEPTION_OCCUR;
 }
 ...
 if (seq != sequence_num) {
  if (buff[2] != 0x03) {
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "error sequence number:%d %d, buf:%d %d %d %d, reboot!\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 261, seq, sequence_num, buff[4], buff[5], buff[6], buff[7]); } while(0);
   goto EXCEPTION_OCCUR;
  } else {
   do { bl_printk("\x1b[32m[%10u][%s] " "skip cmd package, cmd=%d\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", buff[2]); } while(0);
  }
 } else {

 }

 char exception_resp[] = {0xf2, 0xf2, 0x20, 0x00, 0x20, 0x7e, 0x0};
 int data_len = buff[3];

 if (data_len > 240) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "error OTA pkg size > 240, reboot\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 274); } while(0);
  goto EXCEPTION_OCCUR;
 }
 ...
 if (checksum(buff, len)) {
  if (buff[2] == 0x03) {
   ota_end();
   do { bl_printk("\x1b[32m[%10u][%s] " "OTA complete\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);

  } else if (buff[2] == 0x01) {
   ota_start();
   char resp[8] = {0xf2, 0xf2, 0x07, 0x01, 0x01, 0x07 + 2, 0x7e, 0x0};
   lwip_write(socket,resp,strlen(resp));

  } else if (buff[2] == 0x05) {

   uint8_t slot = 1;
   uint8_t chksum = 0x06 + 0x01 + slot;
   char resp[8] = {0xf2, 0xf2, 0x06, 0x01, slot, chksum, 0x7e, 0x0};
   lwip_write(socket,resp,strlen(resp));
   do { bl_printk("\x1b[32m[%10u][%s] " "send slot info, len=%d\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", strlen(resp)); } while(0);

  } else if (buff[2] == 0x02 || buff[2] == 0x09) {

   if(0 == ota_header_found){
    if((ota_header_offset+align_data_len) > (512)){
     memcpy(ota_header_buffer+ota_header_offset, buff + 8, (512)-ota_header_offset);
     ota_header_offset += align_data_len;
    }else{
     memcpy(ota_header_buffer+ota_header_offset, buff + 8, align_data_len);
     ota_header_offset += align_data_len;
    }
    do { bl_printk("\x1b[32m[%10u][%s] " "header size = %d, ret = %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", (512), ota_header_offset); } while(0);

    if(ota_header_offset >= (512)){
     do { bl_printk("\x1b[32m[%10u][%s] " "start check header" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);
     ota_header = (ota_header_t*)ota_header_buffer;
     if (_check_ota_header(ota_header, &ota_bin_size, &use_xz)) {
      do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "can not found header" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 318); } while(0);
      goto EXCEPTION_OCCUR;
     }
     ota_header_found = 1;
     do { bl_printk("\x1b[32m[%10u][%s] " "check_ota_header ok bin_size: %lu, file status %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", ota_bin_size, use_xz ? "XZ" : "RAW"); } while(0);
     if(ota_header_offset > (512)){
      int bin_offset = ota_header_offset-(512);
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "bin ota_header_offset = %d, ret = %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", ota_bin_size, flash_offset); } while(0);
   }

   sequence_num++;


   char resp[8] = {0xf2, 0xf2, 0x08, 0x01, 0x01, 0x08 + 2, 0x7e, 0x0};
   if (buff[2] == 0x09) {
    resp[2] = 0x0a;
    resp[5] = resp[2] + 2;
    lwip_write(socket,resp,strlen(resp));
   ...
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "unknown message! unknown package type!\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 351); } while(0);
  }
 } else {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "~~> checksum failed!!\r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 354); } while(0);
  goto EXCEPTION_OCCUR;
 }
 return;

EXCEPTION_OCCUR:
 lwip_write(socket,exception_resp,strlen(exception_resp));
 system_delay_reset();
}


TaskHandle_t ota_task_handle = 
# 365 "/b-l/dolphin/components/ota/doit_ota.c" 3 4
                              ((void *)0)
# 365 "/b-l/dolphin/components/ota/doit_ota.c"
                                  ;
...
static void ota_server_task(void *pvParameters)
{
 ...
 uint8_t *databuff = 
# 374 "/b-l/dolphin/components/ota/doit_ota.c" 3 4
                    ((void *)0)
# 374 "/b-l/dolphin/components/ota/doit_ota.c"
                        ;
 do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "ota server socket....,port=%d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 375, 6093); } while(0);
 server_socket_fd = lwip_socket(2,1,0);

 if (server_socket_fd < 0) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "create_server error: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 379, server_socket_fd); } while(0);
 }

 server_addr.sin_family = 2;
 server_addr.sin_port = lwip_htons(6093);
 server_addr.sin_addr.s_addr = lwip_htonl(((u32_t)0x00000000UL));

 if (lwip_bind(server_socket_fd,(struct sockaddr *)&server_addr,sizeof(server_addr)) < 0) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "bind_server error: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 387, server_socket_fd); } while(0);
  lwip_close(server_socket_fd);
 }

 if (lwip_listen(server_socket_fd,5) < 0) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "listen_server error: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 392, server_socket_fd); } while(0);
  lwip_close(server_socket_fd);
 }
 ...
 for (;;) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "start accept\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 399); } while(0);
  client_socket_fd = lwip_accept(server_socket_fd,(struct sockaddr *)&client_addr,&socklen);
  if (client_socket_fd <= 0) {
   break;
  }
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "new client connected %d\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 404, client_socket_fd); } while(0);

  while (1) {
   memset(databuff, 0x00, 256);
   int len = lwip_recv(client_socket_fd,databuff,256,0);

   if (len > 0) {
    do { bl_printk("\x1b[32m[%10u][%s] " "~~~>   recv_data: %s\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", databuff); } while(0);
    ota_pkg_parser(client_socket_fd, databuff, len);
   } else {
    do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "recv_data" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 414, client_socket_fd); } while(0);
    do { bl_printk("\x1b[32m[%10u][%s] " "client disconnected\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);
    int res = lwip_close(client_socket_fd);
    do { bl_printk("\x1b[32m[%10u][%s] " "close res: %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", res); } while(0);
    break;
   }
  }
 }
 ...
 lwip_close(server_socket_fd);
 vTaskDelete(
# 425 "/b-l/dolphin/components/ota/doit_ota.c" 3 4
            ((void *)0)
# 425 "/b-l/dolphin/components/ota/doit_ota.c"
                );
 ota_task_handle = 
# 426 "/b-l/dolphin/components/ota/doit_ota.c" 3 4
                  ((void *)0)
# 426 "/b-l/dolphin/components/ota/doit_ota.c"
                      ;
}
...
void doit_ota_server_init(void)
{
 do { bl_printk("\x1b[32m[%10u][%s] " "doit_ota_server_init." "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota"); } while(0);
 if(!ota_task_handle){
  if (xTaskCreate(ota_server_task, "ota_server_task", 1024, 
# 434 "/b-l/dolphin/components/ota/doit_ota.c" 3 4
                                                                    ((void *)0)
# 434 "/b-l/dolphin/components/ota/doit_ota.c"
                                                                        , 10, &ota_task_handle) != ( ( ( BaseType_t ) 1 ) )) {
   do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "create ota_server_task fail" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ota", "doit_ota.c", 435); } while(0);
  }
 }
}
