# 1 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c"
# 1 "/b-l/dolphin/build_out/blmtd//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c"
# 30 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c"
...
# 31 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 32 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 33 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 35 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 36 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 37 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 38 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
# 39 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 2
...
int bl_mtd_open(const char *name, bl_mtd_handle_t *handle, unsigned int flags)
{
    ...
    if (
# 98 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 3 4
       ((void *)0) 
# 98 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c"
            == handle_prv) {
        return -1;
    }
...
int bl_mtd_size(bl_mtd_handle_t handle, unsigned int *size)
{
    bl_mtd_handle_priv_t handle_prv = (bl_mtd_handle_priv_t)handle;
    if (
# 226 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c" 3 4
       ((void *)0) 
# 226 "/b-l/bl_iot_sdk_new/components/sys/blmtd/bl_mtd.c"
            == handle) {
        return -1;
    }
