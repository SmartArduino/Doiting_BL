# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
...
# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h" 1
# 12 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
...
# 13 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h" 2
# 41 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
...
# 66 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
int vfs_spi_open(inode_t *inode, file_t *fp);
# 75 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
int vfs_spi_close(file_t *fp);
# 87 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
ssize_t vfs_spi_read(file_t *fp, void *buf, size_t nbytes);
# 99 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/device/vfs_spi.h"
ssize_t vfs_spi_write(file_t *fp, const void *buf, size_t nbytes);

int vfs_spi_ioctl(file_t *fp, int cmd, unsigned long arg);
# 6 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 2
...
# 7 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 2
...
# 8 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 2
...
# 38 "/b-l/bl_iot_sdk_new/components/utils/include/utils_log.h" 2
...
# 10 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 2

int vfs_spi_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 14 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 14 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 17 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 17 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 17 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 17 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
...
int vfs_spi_close(file_t *fp)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 40 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 40 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 43 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 43 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 43 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 43 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
        ...
        if (fp->node->refs == 1) {
            ...
            if (spi_dev != 
# 51 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                          ((void *)0)
# 51 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                              ) {
...
ssize_t vfs_spi_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 71 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 71 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 74 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 74 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 74 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 74 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
        ...
        if (spi_dev != 
# 79 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                      ((void *)0)
# 79 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                          ) {
...
ssize_t vfs_spi_write(file_t *fp, const void *buf, size_t nbytes)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 102 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 102 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 105 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 105 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 105 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 105 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
        ...
        if (spi_dev != 
# 110 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                      ((void *)0)
# 110 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                          ) {
...
int vfs_spi_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 133 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 133 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                            ;
    spi_ioc_transfer_t *xfer = (spi_ioc_transfer_t *)arg;


    if ((fp == 
# 137 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 137 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                  ) || (fp->node == 
# 137 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 137 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
    ...
    if (spi_dev == 
# 144 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c" 3 4
                  ((void *)0)
# 144 "/b-l/bl_iot_sdk_new/components/fs/vfs/device/vfs_spi.c"
                      ) {
        return -22;
    }
