# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
...
# 6 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 2
...
# 7 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 2
...
# 8 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 2
...
# 9 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 2


# 10 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
...
file_t *new_file(inode_t *node)
{
    ...
    for (idx = 0; idx < (30 * 2); idx++) {
        ...
        if (f->node == 
# 20 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
                      ((void *)0)
# 20 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                          ) {
            goto got_file;
        }
    }
    ...
    return 
# 25 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
          ((void *)0)
# 25 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
              ;

got_file:
    f->node = node;
    f->f_arg = 
# 29 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 29 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                  ;
    f->offset = 0;
    inode_ref(node);
    return f;
...
void del_file(file_t *file)
{
    ...
    file->node = 
# 38 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
                ((void *)0)
# 38 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                    ;
}
...
file_t *get_file(int fd)
{
    ...
    if (fd < 0) {
        return 
# 53 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 53 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                  ;
    }

    if (fd >= (30 * 2)) {
        return 
# 57 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 57 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                  ;
    }

    f = &files[fd];
    return f->node ? f : 
# 61 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c" 3 4
                        ((void *)0)
# 61 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_file.c"
                            ;
}
