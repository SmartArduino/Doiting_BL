# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
...
# 6 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
...
# 7 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
...
# 8 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
...
# 10 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
...
# 11 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 2
...
int inode_del(inode_t *node)
{
    ...
    if (node->refs == 0) {
        if (node->i_name != 
# 42 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 42 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                               ) {
            vPortFree(node->i_name);
        }

        node->i_name = 
# 46 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                      ((void *)0)
# 46 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                          ;
        node->i_arg = 
# 47 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                     ((void *)0)
# 47 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                         ;
        node->i_flags = 0;
...
inode_t *inode_open(const char *path)
{
    ...
    for (e = 0; e < 30; e++) {
        ...
        if (node->i_name == 
# 63 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 63 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        }
    ...
    return 
# 77 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
          ((void *)0)
# 77 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
              ;
}
...
int inode_forearch_name(int (*cb)(void *arg, inode_t *node), void *arg)
{
    ...
    for (e = 0; e < 30; e++) {
        node = &g_vfs_dev_nodes[e];
        if (node->i_name == 
# 87 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 87 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        } else {
            count++;
...
int inode_reserve(const char *path, inode_t **inode)
{
    int ret;
    inode_t *node = 
# 163 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
                   ((void *)0)
# 163 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                       ;

    do { if (!(path != 
# 165 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 165 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
   && inode != 
# 165 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 165 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
    ...
    *inode = 
# 166 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
            ((void *)0)
# 166 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                ;
...
int inode_release(const char *path)
{
    ...
    do { if (!(path != 
# 198 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 198 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
   )) return -22; } while(0);

    node = inode_open(path);
    if (node == 
# 201 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c" 3 4
               ((void *)0)
# 201 "/b-l/bl_iot_sdk_new/components/fs/vfs/src/vfs_inode.c"
                   ) {
        return -19;
    }
