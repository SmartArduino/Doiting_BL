# 1 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
...
# 6 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 7 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 512 "/b-l/bl_iot_sdk_new/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 9 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 10 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 11 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
# 1 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/vfs_conf.h" 1
# 12 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 13 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 9 "/b-l/bl_iot_sdk_new/components/fs/vfs/include/vfs_register.h" 2
...
# 14 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 15 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 2
...
# 69 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                                                   _Bool 
# 69 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                                                                        urgent)
{
    ...
    if (evt == 
# 85 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
              ((void *)0)
# 85 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                  ) {
        ret = -1;
        goto out;
    }
    ...
    if (pdev->poll_cb != 
# 100 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                        ((void *)0)
# 100 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                            ) {
        pdev->fd->revents |= 0x1;
...
# 111 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                    0
# 111 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                                         );
}
...
static int event_ioctl(file_t *f, int cmd, unsigned long arg)
{
    ...
    switch (cmd) {
        case 0x1:
            return _event_write(f, buf, len, 
# 121 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                            0
# 121 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                                                 );
        case 0x2:
            return _event_write(f, buf, len, 
# 123 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                            1
# 123 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                                                );
    }
...
# 159 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                _Bool 
# 159 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                      ...
                      struct pollfd *fd, void *opa)
{
    ...
    if (!setup) {
        pdev->poll_cb = 
# 166 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                       ((void *)0)
# 166 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                           ;
        pdev->poll_data = 
# 167 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                         ((void *)0)
# 167 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                             ;
        goto out;
    }
...
# 201 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c" 3 4
                                                        ((void *)0)
# 201 "/b-l/bl_iot_sdk_new/components/stage/yloop/src/device.c"
                                                            );
