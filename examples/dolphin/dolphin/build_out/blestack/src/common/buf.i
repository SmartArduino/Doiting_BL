# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
# 1 "/b-l/dolphin/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
# 15 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/log.h" 1
# 14 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/log.h"
...
# 15 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/log.h" 2
...
# 16 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 2
...
# 20 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 2
# 1 "/b-l/bl_iot_sdk_new/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stddef.h" 1 3 4
# 21 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 2
...
# 23 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 2
# 62 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
...
{
# 87 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
...
# 176 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
...
# 236 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
...

{
 ...
 irq_unlock(key);
# 338 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
 buf = k_queue_get((struct k_queue *) &pool->free, timeout);

 if (!buf) {
  ;
  return 
# 342 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 342 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
            ;
 }
...
success:
 ...
 if (size) {
  ...
  if (!buf->__buf) {
   ...
   net_buf_destroy(buf);
   return 
# 360 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
         ((void *)0)
# 360 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
             ;
  }
 } else {
  buf->__buf = 
# 363 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 363 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                  ;
 }
 ...
 buf->flags = 0U;
 buf->frags = 
# 368 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
             ((void *)0)
# 368 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                 ;
 buf->size = size;
 net_buf_reset(buf);
...
# 391 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
struct net_buf *net_buf_alloc_fixed(struct net_buf_pool *pool, s32_t timeout)
{
 const struct net_buf_pool_fixed *fixed = pool->alloc->alloc_data;
...
# 405 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
struct net_buf *net_buf_alloc_with_data(struct net_buf_pool *pool,
     void *data, size_t size,
     s32_t timeout)

{
 ...
 if (!buf) {
  return 
# 418 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 418 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
            ;
 }
...

{
 ...
 if (!buf) {
  return 
# 443 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 443 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 frag->frags = 
# 458 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 458 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                  ;
...
struct net_buf *net_buf_slist_get(sys_slist_t *list)
{
 ...
 if (!buf) {
  return 
# 510 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 510 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 frag->frags = 
# 526 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 526 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                  ;
...
# 569 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
  ...
  if (buf->__buf) {
   ...
   buf->__buf = 
# 581 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
               ((void *)0)
# 581 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                   ;
  }

  buf->data = 
# 584 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
             ((void *)0)
# 584 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                 ;
  buf->frags = 
# 585 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 585 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                  ;
...
struct net_buf *net_buf_clone(struct net_buf *buf, s32_t timeout)
{
 ...
 if (!clone) {
  return 
# 636 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 636 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 if (pool->alloc->cb->ref && !(buf->flags & (1UL << (1)))) {
  ...
  if (!clone->__buf || size < buf->size) {
   ...
   return 
# 659 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
         ((void *)0)
# 659 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
             ;
  }
...

{
 ...
 frag->frags = 
# 726 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 726 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
                  ;
...
# 823 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/buf.c"
void net_buf_simple_clone(const struct net_buf_simple *original,
     struct net_buf_simple *clone)
{
