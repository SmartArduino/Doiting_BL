# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
# 1 "/b-l/dolphin/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
# 15 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
...
# 16 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 2
...
# 17 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 2
...
# 18 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 2
...
static void work_timeout(void *timer)
{
    ...
    if( ( rec != 
# 82 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
   ((void *)0) 
# 82 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
    ...
    w->work_q = 
# 89 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
               ((void *)0)
# 89 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                   ;
    rec->timer.hdl = 
# 90 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                    ((void *)0)
# 90 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                        ;
}
...
void k_delayed_work_init(struct k_delayed_work *work, k_work_handler_t handler)
{
    ...
    work->work_q = 
# 98 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                  ((void *)0)
# 98 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                      ;
}
        ...
        uint32_t delay)
{
    ...
    if (!delay) {
        ...
        work->work_q = 
# 128 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                      ((void *)0)
# 128 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                          ;
    } else {
...
int k_delayed_work_cancel(struct k_delayed_work *work)
{
    ...
    work->work_q = 
# 172 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                  ((void *)0)
# 172 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                      ;
...
s32_t k_delayed_work_remaining_get(struct k_delayed_work *work)
{
    ...
    if (work == 
# 186 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
               ((void *)0)
# 186 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                   ) {
        return 0;
    }
...
{
    if(
# 200 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
      ((void *)0) 
# 200 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
           == work || 
# 200 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                      ((void *)0) 
# 200 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
    ...
    work->timer.timer.hdl = 
# 204 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                           ((void *)0)
# 204 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                               ;
}
...
# 219 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                                    ((void *)0)
# 219 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                                        ;
        timer_records[i].delay_work = 
# 220 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                                     ((void *)0)
# 220 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                                         ;
    }
}
...
# 228 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                                        ((void *)0)
# 228 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                                            )
        {
...
int remv_timer_record(struct k_delayed_work *delay_work)
{
    for(int i = 0; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(timer_records), __typeof__(&(timer_records)[0])))]) - 1) + (sizeof(timer_records) / sizeof((timer_records)[0])))); i++)
    {
        ...
        {
            timer_records[i].timer.hdl = 
# 255 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
                                        ((void *)0)
# 255 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
                                            ;
            break;
        }
    }
...
timer_rec_d *get_timer_record(void *hdl)
{
    ...
    return 
# 270 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c" 3 4
          ((void *)0)
# 270 "/b-l/bl_iot_sdk_new/components/network/ble/blestack/src/common/work_q.c"
              ;
}
