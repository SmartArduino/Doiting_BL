# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/customer_app/bl602_demo_wifi/build_out/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
# 29 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
# 30 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2
...
# 37 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2
...
# 39 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c" 2
# 58 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = (unsigned char*)v; while( n-- ) *p++ = 0;
}
# 360 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
# 387 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
...
{
    if( ctx == 
# 474 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c" 3 4
              ((void *)0) 
# 474 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
                   )
        return;
...
# 515 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    ctx->rk = RK = ctx->buf;
...
# 616 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    ctx->rk = RK = ctx->buf;
    ...
    ctx->nr = cty.nr;
# 633 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    SK = cty.rk + cty.nr * 4;
...
# 713 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
void mbedtls_aes_encrypt( mbedtls_aes_context *ctx,
                          const unsigned char input[16],
                          unsigned char output[16] )
{
...
int mbedtls_aes_crypt_ecb( mbedtls_aes_context *ctx,
                    ...
                    unsigned char output[16] )
{
# 849 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    if( mode == 1 )
                    ...
                    unsigned char *output )
{
    ...
    if( length % 16 )
        return( -0x0022 );
# 887 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/security/mbedtls/src/aes.c"
    if( mode == 0 )
    {
        while( length > 0 )
        {
