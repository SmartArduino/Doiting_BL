# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/customer_app/sdk_app_helloworld/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
# 30 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
...
# 31 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 2
...
# 32 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 2
# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/include/utils_memp.h" 1
# 34 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/include/utils_memp.h"
...
# 33 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 2
...
int utils_memp_init(utils_memp_pool_t **pool, uint16_t node_size, uint16_t pool_cap, uint8_t align_req)
{
    ...
    npool->mem = 
# 67 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 3 4
                ((void *)0)
# 67 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
                    ;
    pool_mem = npool->mem;
...
void *utils_memp_malloc(utils_memp_pool_t *pool)
{
    ...
    if (!pool) {
        return 
# 97 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 3 4
              ((void *)0)
# 97 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
                  ;
    }
    if (pool->pool_size == pool->pool_cap) {
        return 
# 100 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 3 4
              ((void *)0)
# 100 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
                  ;
    }
    node = pool->mem;
    if (node != 
# 103 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 3 4
               ((void *)0)
# 103 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
                   ) {
        pool->mem = node->next;
        pool->pool_size++;
        ...
        *pat = 0XA5;
        ...
        return 
# 110 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c" 3 4
              ((void *)0)
# 110 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/utils/src/utils_memp.c"
                  ;
    }
}
