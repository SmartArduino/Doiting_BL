# 1 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
...
# 6 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 2
...
# 7 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 2
...
# 8 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 2
...
# 9 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 2


# 10 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
...
file_t *new_file(inode_t *node)
{
    ...
    for (idx = 0; idx < (30 * 2); idx++) {
        ...
        if (f->node == 
# 20 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
                      ((void *)0)
# 20 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                          ) {
            goto got_file;
        }
    }
    ...
    return 
# 25 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
          ((void *)0)
# 25 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
              ;

got_file:
    f->node = node;
    f->f_arg = 
# 29 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 29 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                  ;
    f->offset = 0;
    inode_ref(node);
    return f;
...
void del_file(file_t *file)
{
    ...
    file->node = 
# 38 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
                ((void *)0)
# 38 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                    ;
}
...
file_t *get_file(int fd)
{
    ...
    if (fd < 0) {
        return 
# 53 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 53 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                  ;
    }

    if (fd >= (30 * 2)) {
        return 
# 57 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
              ((void *)0)
# 57 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                  ;
    }

    f = &files[fd];
    return f->node ? f : 
# 61 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c" 3 4
                        ((void *)0)
# 61 "/home/hogc/build-tools/sdk/bl/bl_iot_sdk/components/fs/vfs/src/vfs_file.c"
                            ;
}
