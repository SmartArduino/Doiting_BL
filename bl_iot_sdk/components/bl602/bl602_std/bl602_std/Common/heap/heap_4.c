...
static const unsigned short  heapSTRUCT_SIZE	= ( sizeof( BlockLink_t )) + portBYTE_ALIGNMENT -
	( sizeof( BlockLink_t ) % portBYTE_ALIGNMENT );
#define BLOCK_SIZE(_x_) (_x_->xBlockSize & ~xBlockAllocatedBit)
...
#ifdef FREERTOS_ENABLE_MALLOC_STATS
	memset((unsigned char *)&hI, 0x00, sizeof(heapAllocatorInfo_t));
